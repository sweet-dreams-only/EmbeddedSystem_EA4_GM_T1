...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_GM4C1HS_APPL_CODE)  ***********/

#ifdef RTE_STOP_SEC_GM4C1HS_APPL_CODE
# undef RTE_STOP_SEC_GM4C1HS_APPL_CODE /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define STOP_SEC_CODE
#endif
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_GM4C1HS_APPL_CODE)  **********/

#ifdef RTE_START_SEC_GM4C1HS_APPL_CODE
# undef RTE_START_SEC_GM4C1HS_APPL_CODE /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define START_SEC_CODE
#endif
...
#   error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Working/MM022A_GmMsg4D1BusHiSpd_Impl/tools/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
