...
#ifndef _RTE_ASSISUMLIM_TYPE_H
# define _RTE_ASSISUMLIM_TYPE_H
...
# define Tq8_LowerLimit (-3.0)
# define Tq8_UpperLimit (3.0)

# define Tq9_LowerLimit (-8.0)
# define Tq9_UpperLimit (8.0)
...
#    error "The magic number of the generated file <C:/Component/SF004B_AssiSumLim_Impl/tools/contract/Rte_AssiSumLim_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
