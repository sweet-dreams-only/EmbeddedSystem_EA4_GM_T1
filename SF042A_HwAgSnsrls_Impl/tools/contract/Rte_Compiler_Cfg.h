...
#    error "The magic number of the generated file <C:/Component/SF042A_HwAgSnsrls_Impl_1.3.0/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
