 ...
 * --------     ---------------------     ----------------------------------------------------------------------------
 * Ck           Christian Kaiser          Vctr Informatik GmbH
 * Du           Manfred Duschinger        Vctr Informatik GmbH
 * Jwa          Johannes Wagner           Vctr Informatik GmbH
 *--------------------------------------------------------------------------------------------------------------------
...
# define IF_ASRIFFEE_RELEASE_VERSION                                  0x02u
