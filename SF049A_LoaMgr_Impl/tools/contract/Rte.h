...
#    error "The magic number of the generated file <C:/Component/SF049A_LoaMgr_Impl_2.1.0/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
