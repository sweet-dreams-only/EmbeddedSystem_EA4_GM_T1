...
:CopyVariantA
xcopy ..\autosar\R403_WDG_P1M_04_05_10_to_15_18_to_23.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Wdg_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
:end
