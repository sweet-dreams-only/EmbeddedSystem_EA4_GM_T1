 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dem_Cfg.h
 *   Generation Time: 2017-02-08 13:41:26
...
/* Generator Internal Version                                         8.01.00 (Cfg5.11.x compatible, Release AR4-15.1), Revision: 81361, Variant: Gm (Vector) */
...
#define DEM_CFG_SAFE_BSW_MODE                                         STD_ON       /* Autodetected - STD_ON: /Dem/DemGeneral/DemSafeBswModeEnabled == TRUE && /EcuC/EcucGeneral/EcuCSafeBswChecks == TRUE (or undefined), STD_OFF: DemSafeBswModeEnabled == FALSE (or unset) || EcuCSafeBswChecks == FALSE */ 
...
#define DEM_CFG_SUPPORT_CYCLE_OTHER                                   STD_ON       /* Autodetected - STD_ON: cycle type is referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not referenced. The '*CycleRef' params are (here 96 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemEventFailureCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
