...
const VAR(TunSelnIdxTblRec1, AUTOMATIC) ININCALCFGTBL_REC[MAXINITIDXCNT_CNT_U08] = {
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn02Inin00GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn02Inin00GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x00U }  /*IninIdx00 */
};
...
const VAR(TunSelnIdxTblRec1, AUTOMATIC) RTCALCFGTBL_REC[MAXRTIDXCNT_CNT_U08] = {
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn03Rt00_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03Rt00_DEFAULT_RTE_CALPRM_GROUP, 0x00U }, /*RtIdx00 */
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn02Rt01GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn02Rt01GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x01U }, /*RtIdx01 */
    {(uint16)Rte_CalprmElementGroup_CalRegn03Rt01_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03Rt01_DEFAULT_RTE_CALPRM_GROUP, 0x01U }, /*RtIdx01 */
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn02Rt02GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn02Rt02GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x02U }, /*RtIdx02 */
    {(uint16)Rte_CalprmElementGroup_CalRegn03Rt02_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03Rt02_DEFAULT_RTE_CALPRM_GROUP, 0x02U }, /*RtIdx02 */
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn02Rt03GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn02Rt03GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x03U }, /*RtIdx03 */
    {(uint16)Rte_CalprmElementGroup_CalRegn03Rt03_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03Rt03_DEFAULT_RTE_CALPRM_GROUP, 0x03U }, /*RtIdx03 */
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn02Rt04GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn02Rt04GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x04U }, /*RtIdx04 */
    {(uint16)Rte_CalprmElementGroup_CalRegn03Rt04_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03Rt04_DEFAULT_RTE_CALPRM_GROUP, 0x04U }, /*RtIdx04 */
...
const VAR(TunSelnOnlineCalIdxTblRec1, AUTOMATIC) ONLINECALCFGTBL_REC[MAXONLINECALCFGCNT_CNT_U08] = {
    ...
    {(uint8 *)(&OnlineRamCalTbl_C.GroupC.CalRegn03CmnGroupC), sizeof(OnlineRamCalTbl_C.GroupC.CalRegn03CmnGroupC), (uint16)Rte_CalprmElementGroup_CalRegn03CmnGroupC_DEFAULT_RTE_CALPRM_GROUP, 0x02U}, /*GroupC */
    ...
    {(uint8 *)(&OnlineRamCalTbl_C.GroupC.CalRegn02Inin00GroupC), sizeof(OnlineRamCalTbl_C.GroupC.CalRegn02Inin00GroupC), (uint16)Rte_CalprmElementGroup_CalRegn02Inin00GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x02U}, /*GroupC */
...
FUNC(boolean, TunSelnMngt_CODE) TunSelnMngt_ChkXcpWrAcs(uint32 ReqAdr_Cnt_T_u32)
{
    ...
    if( ( (ReqAdr_Cnt_T_u32 >= (uint32)&(OnlineRamCalTbl_C.byte[0])) && (ReqAdr_Cnt_T_u32 <= (uint32)&(OnlineRamCalTbl_C.byte[(ONLINECALRAMTBL_CNT_U16-1U)]))) ||
        ( (ReqAdr_Cnt_T_u32 >= (uint32)(osGlobalShared_StartAddr)) && (ReqAdr_Cnt_T_u32 <= (uint32)(osGlobalShared_EndAddr + 4))) )
#else
