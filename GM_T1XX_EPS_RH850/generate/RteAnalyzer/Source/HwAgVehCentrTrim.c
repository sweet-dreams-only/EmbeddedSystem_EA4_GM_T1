...
#include "Rte_HwAgVehCentrTrim.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void HwAgVehCentrTrim_TestDefines(void);
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwAgTrimData_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 * Symbol: ClrHwAgTrimVal_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  HwAgSnsrTrimRec1 HwAgTrimData;

  HwAgSnsrTrimRec1 HwAgTrimDataDft_data;

  float32 HwAgVehCentrTrimHwAgLim_Val_data;
  float32 HwAgVehCentrTrimVehSpdMaxThd_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  HwAgTrimData = *TSC_HwAgVehCentrTrim_Rte_Pim_HwAgTrimData();
  *TSC_HwAgVehCentrTrim_Rte_Pim_HwAgTrimData() = HwAgTrimData;

  HwAgTrimDataDft_data = *TSC_HwAgVehCentrTrim_Rte_CData_HwAgTrimDataDft();

  HwAgVehCentrTrimHwAgLim_Val_data = TSC_HwAgVehCentrTrim_Rte_Prm_HwAgVehCentrTrimHwAgLim_Val();
  HwAgVehCentrTrimVehSpdMaxThd_Val_data = TSC_HwAgVehCentrTrim_Rte_Prm_HwAgVehCentrTrimVehSpdMaxThd_Val();

  fct_status = TSC_HwAgVehCentrTrim_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Call_HwAgTrimData_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetHwAgTrimVal_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwAgVehCentrTrimInit1_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwAgVehCentrTrimPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwAgVehCentrTrim_Rte_Pim_HwAgTrimData() = HwAgTrimData;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_HwAg_Val(&Read_HwAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Write_HwAgTrimPrfmd_Logl(Rte_InitValue_HwAgTrimPrfmd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Write_HwAgVehTrimOffs_Val(Rte_InitValue_HwAgVehTrimOffs_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SetHwAgTrimVal_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: UpdHwAgTrimVal_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwAgVehCentrTrim_Rte_Pim_HwAgTrimData() = HwAgTrimData;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_EngRunActv_Logl(&Read_EngRunActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_HwAgCcwDetd_Logl(&Read_HwAgCcwDetd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_HwAgCwDetd_Logl(&Read_HwAgCwDetd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_HwAgEotCcw_Val(&Read_HwAgEotCcw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_HwAgEotCw_Val(&Read_HwAgEotCw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgVehCentrTrim_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
