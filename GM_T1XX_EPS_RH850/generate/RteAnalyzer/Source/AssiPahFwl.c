...
#include "Rte_AssiPahFwl.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void AssiPahFwl_TestDefines(void);
 ...
 *     Returnvalue: u8p8* is of type Ary1D_u8p8_20
 *   s4p11 *Rte_Prm_AssiPahFwlDftAssiY_Ary1D(void)
 *     Returnvalue: s4p11* is of type Ary1D_s4p11_20
 *   s4p11 *Rte_Prm_AssiPahFwlHiFrqUpprLimY_Ary2D(void)
 *     Returnvalue: s4p11* is of type Ary2D_s4p11_12_11
 ...
 *********************************************************************************************************************/
  ...
  float32 CombdAssiPrev;
  float32 dAssiPahFwlActvRaw;
  float32 dAssiPahFwlBasAssiLimd;
  float32 dAssiPahFwlBasAssiLowrLim;
  float32 dAssiPahFwlBasAssiUpprLim;
  float32 dAssiPahFwlHiFrqAssiLowrLimFild;
  float32 dAssiPahFwlHiFrqAssiUpprLimFild;
  float32 dAssiPahFwlHiFrqCmdHpPah;
  float32 dAssiPahFwlHiFrqCmdLpPah;
  float32 dAssiPahFwlHiFrqLpLimd;
  float32 dAssiPahFwlSumInp;
  boolean AssiPrfmncPrev;
  boolean dAssiPahFwlBasAssiCmdOverLim;
  boolean dAssiPahFwlHiFrqCmdOverLim;
  FilLpRec1 FwlActvLpFilStVari;
  FilLpRec1 HiFrqCmdLpFilStVari;
  FilLpRec1 LowrLimLpFilStVari;
  FilLpRec1 UpprLimLpFilStVari;

  float32 AssiPahFwlCmdSplitLpFilFrq_Val_data;
  float32 AssiPahFwlFwlActvLpFilFrq_Val_data;
  float32 AssiPahFwlHysCmpLim_Val_data;
  float32 AssiPahFwlRestoreThd_Val_data;
  uint16 BasAssiPahFwlOverLimDiagcFailStep_Val_data;
  uint16 BasAssiPahFwlOverLimDiagcPassStep_Val_data;
  uint16 HiFrqAssiPahFwlOverLimDiagcFailStep_Val_data;
  uint16 HiFrqAssiPahFwlOverLimDiagcPassStep_Val_data;
  boolean AssiPahFwlDiRcvr_Logl_data;
  Ary1D_u8p8_20 AssiPahFwlDftAssiX_Ary1D_data;
  Ary1D_s4p11_20 AssiPahFwlDftAssiY_Ary1D_data;
  Ary2D_s4p11_12_11 AssiPahFwlHiFrqUpprLimY_Ary2D_data;
  Ary2D_s4p11_12_11 AssiPahFwlUpprLimX_Ary2D_data;
  Ary2D_s4p11_12_11 AssiPahFwlUpprLimY_Ary2D_data;
  Ary1D_u9p7_12 AssiPahFwlVehSpd_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  CombdAssiPrev = *TSC_AssiPahFwl_Rte_Pim_CombdAssiPrev();
  *TSC_AssiPahFwl_Rte_Pim_CombdAssiPrev() = CombdAssiPrev;
  dAssiPahFwlActvRaw = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlActvRaw();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlActvRaw() = dAssiPahFwlActvRaw;
  dAssiPahFwlBasAssiLimd = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiLimd();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiLimd() = dAssiPahFwlBasAssiLimd;
  dAssiPahFwlBasAssiLowrLim = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiLowrLim();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiLowrLim() = dAssiPahFwlBasAssiLowrLim;
  dAssiPahFwlBasAssiUpprLim = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiUpprLim();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiUpprLim() = dAssiPahFwlBasAssiUpprLim;
  dAssiPahFwlHiFrqAssiLowrLimFild = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqAssiLowrLimFild();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqAssiLowrLimFild() = dAssiPahFwlHiFrqAssiLowrLimFild;
  dAssiPahFwlHiFrqAssiUpprLimFild = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqAssiUpprLimFild();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqAssiUpprLimFild() = dAssiPahFwlHiFrqAssiUpprLimFild;
  dAssiPahFwlHiFrqCmdHpPah = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqCmdHpPah();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqCmdHpPah() = dAssiPahFwlHiFrqCmdHpPah;
  dAssiPahFwlHiFrqCmdLpPah = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqCmdLpPah();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqCmdLpPah() = dAssiPahFwlHiFrqCmdLpPah;
  dAssiPahFwlHiFrqLpLimd = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqLpLimd();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqLpLimd() = dAssiPahFwlHiFrqLpLimd;
  dAssiPahFwlSumInp = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlSumInp();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlSumInp() = dAssiPahFwlSumInp;
  AssiPrfmncPrev = *TSC_AssiPahFwl_Rte_Pim_AssiPrfmncPrev();
  *TSC_AssiPahFwl_Rte_Pim_AssiPrfmncPrev() = AssiPrfmncPrev;
  dAssiPahFwlBasAssiCmdOverLim = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiCmdOverLim();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlBasAssiCmdOverLim() = dAssiPahFwlBasAssiCmdOverLim;
  dAssiPahFwlHiFrqCmdOverLim = *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqCmdOverLim();
  *TSC_AssiPahFwl_Rte_Pim_dAssiPahFwlHiFrqCmdOverLim() = dAssiPahFwlHiFrqCmdOverLim;
  FwlActvLpFilStVari = *TSC_AssiPahFwl_Rte_Pim_FwlActvLpFilStVari();
  *TSC_AssiPahFwl_Rte_Pim_FwlActvLpFilStVari() = FwlActvLpFilStVari;
  HiFrqCmdLpFilStVari = *TSC_AssiPahFwl_Rte_Pim_HiFrqCmdLpFilStVari();
  *TSC_AssiPahFwl_Rte_Pim_HiFrqCmdLpFilStVari() = HiFrqCmdLpFilStVari;
  LowrLimLpFilStVari = *TSC_AssiPahFwl_Rte_Pim_LowrLimLpFilStVari();
  *TSC_AssiPahFwl_Rte_Pim_LowrLimLpFilStVari() = LowrLimLpFilStVari;
  UpprLimLpFilStVari = *TSC_AssiPahFwl_Rte_Pim_UpprLimLpFilStVari();
  *TSC_AssiPahFwl_Rte_Pim_UpprLimLpFilStVari() = UpprLimLpFilStVari;

  AssiPahFwlCmdSplitLpFilFrq_Val_data = TSC_AssiPahFwl_Rte_Prm_AssiPahFwlCmdSplitLpFilFrq_Val();
  AssiPahFwlFwlActvLpFilFrq_Val_data = TSC_AssiPahFwl_Rte_Prm_AssiPahFwlFwlActvLpFilFrq_Val();
  AssiPahFwlHysCmpLim_Val_data = TSC_AssiPahFwl_Rte_Prm_AssiPahFwlHysCmpLim_Val();
  AssiPahFwlRestoreThd_Val_data = TSC_AssiPahFwl_Rte_Prm_AssiPahFwlRestoreThd_Val();
  BasAssiPahFwlOverLimDiagcFailStep_Val_data = TSC_AssiPahFwl_Rte_Prm_BasAssiPahFwlOverLimDiagcFailStep_Val();
  BasAssiPahFwlOverLimDiagcPassStep_Val_data = TSC_AssiPahFwl_Rte_Prm_BasAssiPahFwlOverLimDiagcPassStep_Val();
  HiFrqAssiPahFwlOverLimDiagcFailStep_Val_data = TSC_AssiPahFwl_Rte_Prm_HiFrqAssiPahFwlOverLimDiagcFailStep_Val();
  HiFrqAssiPahFwlOverLimDiagcPassStep_Val_data = TSC_AssiPahFwl_Rte_Prm_HiFrqAssiPahFwlOverLimDiagcPassStep_Val();
  AssiPahFwlDiRcvr_Logl_data = TSC_AssiPahFwl_Rte_Prm_AssiPahFwlDiRcvr_Logl();
  (void)memcpy(AssiPahFwlDftAssiX_Ary1D_data, TSC_AssiPahFwl_Rte_Prm_AssiPahFwlDftAssiX_Ary1D(), sizeof(Ary1D_u8p8_20));
  (void)memcpy(AssiPahFwlDftAssiY_Ary1D_data, TSC_AssiPahFwl_Rte_Prm_AssiPahFwlDftAssiY_Ary1D(), sizeof(Ary1D_s4p11_20));
  (void)memcpy(AssiPahFwlHiFrqUpprLimY_Ary2D_data, TSC_AssiPahFwl_Rte_Prm_AssiPahFwlHiFrqUpprLimY_Ary2D(), sizeof(Ary2D_s4p11_12_11));
  (void)memcpy(AssiPahFwlUpprLimX_Ary2D_data, TSC_AssiPahFwl_Rte_Prm_AssiPahFwlUpprLimX_Ary2D(), sizeof(Ary2D_s4p11_12_11));
  (void)memcpy(AssiPahFwlUpprLimY_Ary2D_data, TSC_AssiPahFwl_Rte_Prm_AssiPahFwlUpprLimY_Ary2D(), sizeof(Ary2D_s4p11_12_11));
  (void)memcpy(AssiPahFwlVehSpd_Ary1D_data, TSC_AssiPahFwl_Rte_Prm_AssiPahFwlVehSpd_Ary1D(), sizeof(Ary1D_u9p7_12));

  fct_status = TSC_AssiPahFwl_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_AssiPahFwl_Rte_Pim_UpprLimLpFilStVari() = UpprLimLpFilStVari;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_AssiCmdBas_Val(&Read_AssiCmdBas_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_AssiHiFrqCmd_Val(&Read_AssiHiFrqCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_AssiLnrGainEna_Logl(&Read_AssiLnrGainEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_HwTq_Val(&Read_HwTq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_HwTqOvrl_Val(&Read_HwTqOvrl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_HysCmpCmd_Val(&Read_HysCmpCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_MfgEnaSt_Val(&Read_MfgEnaSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Write_AssiCmdSum_Val(Rte_InitValue_AssiCmdSum_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Write_AssiPahLimrActv_Val(Rte_InitValue_AssiPahLimrActv_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiPahFwl_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
