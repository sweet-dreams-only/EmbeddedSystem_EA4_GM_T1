...
#include "Rte_EotLrng.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void EotLrng_TestDefines(void);
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_EotNvmData_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_EotNvmData_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_MaxHwAgCwAndCcw_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_MaxHwAgCwAndCcw_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint32 CcwEotRefTmr;
  uint32 CwEotRefTmr;
  boolean HwAgOverTrvlCntrDi;
  boolean RstLimReq;
  EotNvmDataRec1 EotNvmData;
  MaxHwAgCwAndCcwRec2 MaxHwAgCwAndCcw;

  EotNvmDataRec1 EotNvmDataDft_data;

  float32 EotLrngAuthyStrtLrn_Val_data;
  float32 EotLrngHwAgOverTrvlEntr_Val_data;
  float32 EotLrngHwAgOverTrvlExit_Val_data;
  float32 EotLrngHwTqEotLrn_Val_data;
  float32 EotLrngMotVelEotLrn_Val_data;
  float32 EotLrngRackTrvlMax_Val_data;
  float32 EotLrngRackTrvlMin_Val_data;
  float32 EotLrngRstAuthyMin_Val_data;
  uint16 EotLrngEotLrnTmr_Val_data;
  uint8 EotLrngHwAgOverTrvlCnt_Val_data;
  boolean EotProtnRackTrvlLimrEna_Logl_data;

  uint32 Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg = 0U;

  NvM_RequestResultType Call_EotNvmData_GetErrorStatus_ErrorStatus_Arg = 0U;
  NvM_RequestResultType Call_MaxHwAgCwAndCcw_GetErrorStatus_ErrorStatus_Arg = 0U;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PrevCcwEot = *TSC_EotLrng_Rte_Pim_PrevCcwEot();
  *TSC_EotLrng_Rte_Pim_PrevCcwEot() = PrevCcwEot;
  PrevCwEot = *TSC_EotLrng_Rte_Pim_PrevCwEot();
  *TSC_EotLrng_Rte_Pim_PrevCwEot() = PrevCwEot;
  CcwEotRefTmr = *TSC_EotLrng_Rte_Pim_CcwEotRefTmr();
  *TSC_EotLrng_Rte_Pim_CcwEotRefTmr() = CcwEotRefTmr;
  CwEotRefTmr = *TSC_EotLrng_Rte_Pim_CwEotRefTmr();
  *TSC_EotLrng_Rte_Pim_CwEotRefTmr() = CwEotRefTmr;
  HwAgOverTrvlCntrDi = *TSC_EotLrng_Rte_Pim_HwAgOverTrvlCntrDi();
  *TSC_EotLrng_Rte_Pim_HwAgOverTrvlCntrDi() = HwAgOverTrvlCntrDi;
  RstLimReq = *TSC_EotLrng_Rte_Pim_RstLimReq();
  *TSC_EotLrng_Rte_Pim_RstLimReq() = RstLimReq;
  EotNvmData = *TSC_EotLrng_Rte_Pim_EotNvmData();
  *TSC_EotLrng_Rte_Pim_EotNvmData() = EotNvmData;
  MaxHwAgCwAndCcw = *TSC_EotLrng_Rte_Pim_MaxHwAgCwAndCcw();
  *TSC_EotLrng_Rte_Pim_MaxHwAgCwAndCcw() = MaxHwAgCwAndCcw;

  EotNvmDataDft_data = *TSC_EotLrng_Rte_CData_EotNvmDataDft();

  EotLrngAuthyStrtLrn_Val_data = TSC_EotLrng_Rte_Prm_EotLrngAuthyStrtLrn_Val();
  EotLrngHwAgOverTrvlEntr_Val_data = TSC_EotLrng_Rte_Prm_EotLrngHwAgOverTrvlEntr_Val();
  EotLrngHwAgOverTrvlExit_Val_data = TSC_EotLrng_Rte_Prm_EotLrngHwAgOverTrvlExit_Val();
  EotLrngHwTqEotLrn_Val_data = TSC_EotLrng_Rte_Prm_EotLrngHwTqEotLrn_Val();
  EotLrngMotVelEotLrn_Val_data = TSC_EotLrng_Rte_Prm_EotLrngMotVelEotLrn_Val();
  EotLrngRackTrvlMax_Val_data = TSC_EotLrng_Rte_Prm_EotLrngRackTrvlMax_Val();
  EotLrngRackTrvlMin_Val_data = TSC_EotLrng_Rte_Prm_EotLrngRackTrvlMin_Val();
  EotLrngRstAuthyMin_Val_data = TSC_EotLrng_Rte_Prm_EotLrngRstAuthyMin_Val();
  EotLrngEotLrnTmr_Val_data = TSC_EotLrng_Rte_Prm_EotLrngEotLrnTmr_Val();
  EotLrngHwAgOverTrvlCnt_Val_data = TSC_EotLrng_Rte_Prm_EotLrngHwAgOverTrvlCnt_Val();
  EotProtnRackTrvlLimrEna_Logl_data = TSC_EotLrng_Rte_Prm_EotProtnRackTrvlLimrEna_Logl();

  fct_status = TSC_EotLrng_Rte_Write_HwAgCcwDetd_Logl(Rte_InitValue_HwAgCcwDetd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Write_HwAgCwDetd_Logl(Rte_InitValue_HwAgCwDetd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Write_HwAgEotCcw_Val(Rte_InitValue_HwAgEotCcw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Write_HwAgEotCw_Val(Rte_InitValue_HwAgEotCw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_EotNvmData_GetErrorStatus(&Call_EotNvmData_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_EotNvmData_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_MaxHwAgCwAndCcw_GetErrorStatus(&Call_MaxHwAgCwAndCcw_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_MaxHwAgCwAndCcw_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean Read_HwAgDiDiagSts_Logl;
  boolean Read_HwAgEotSig0Avl_Logl;
  float32 Read_HwAgEotSig0Ccw_Val;
  float32 Read_HwAgEotSig0Cw_Val;
  boolean Read_HwAgEotSig1Avl_Logl;
  float32 Read_HwAgEotSig1Ccw_Val;
  float32 Read_HwAgEotSig1Cw_Val;
  ...
  *TSC_EotLrng_Rte_Pim_MaxHwAgCwAndCcw() = MaxHwAgCwAndCcw;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAg_Val(&Read_HwAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgAuthy_Val(&Read_HwAgAuthy_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgDiDiagSts_Logl(&Read_HwAgDiDiagSts_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgEotSig0Avl_Logl(&Read_HwAgEotSig0Avl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgEotSig0Ccw_Val(&Read_HwAgEotSig0Ccw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgEotSig0Cw_Val(&Read_HwAgEotSig0Cw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgEotSig1Avl_Logl(&Read_HwAgEotSig1Avl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgEotSig1Ccw_Val(&Read_HwAgEotSig1Ccw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwAgEotSig1Cw_Val(&Read_HwAgEotSig1Cw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_HwTq_Val(&Read_HwTq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Read_MotVelCrf_Val(&Read_MotVelCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotLrng_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetHwAgOverTrvlCnt_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RstHwAgOverTrvlCnt_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RstMaxHwAgCwAndCcw_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RtnMaxHwAgCwAndCcw_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SetHwAgOverTrvlCnt_Oper_doc
 *********************************************************************************************************************/
