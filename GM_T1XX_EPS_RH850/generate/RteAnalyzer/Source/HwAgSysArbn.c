...
#include "Rte_HwAgSysArbn.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void HwAgSysArbn_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 HwAgPrev;
  float32 PrevHwAgNotCorrd;
  float32 PrevPinionAgConf;
  float32 PrevSeldHwAg;
  float32 SeldHwAgConf;
  float32 TqSnsrAgPrev;
  uint32 HwAgToMotAgCorrlnDurnRefTmr;
  uint32 SlewElpdRefTmr;
  sint8 PrevSrcSeln;
  boolean HwAgCorrdLtch;
  boolean HwAgKineFlt;
  boolean HwAgToMotAgCorrln;
  boolean SlewSts;
  FilLpRec1 TqSnsrVelFil;

  float32 HwAgSysArbnHwAgConf1Snsr_Val_data;
  float32 HwAgSysArbnHwAgConf2Snsr_Val_data;
  float32 HwAgSysArbnHwAgConfNoSnsr_Val_data;
  float32 HwAgSysArbnHwAgCorrdCorrlnThd_Val_data;
  float32 HwAgSysArbnHwAgCorrlnRng_Val_data;
  float32 HwAgSysArbnHwAgSlewRate_Val_data;
  float32 HwAgSysArbnHwAgSnsrlsCorrlnThd_Val_data;
  float32 HwAgSysArbnHwAgSnsrlsKineThd_Val_data;
  float32 HwAgSysArbnSerlComHwAgCorrdConf_Val_data;
  float32 HwAgSysArbnSerlComHwAgSnsrlsConf_Val_data;
  float32 HwAgSysArbnSlewRateTmr_Val_data;
  float32 HwAgSysArbnTqSnsrVelFilFrq_Val_data;
  float32 SysGlbPrmSysKineRat_Val_data;
  float32 SysGlbPrmTorsBarStfn_Val_data;
  uint32 HwAgSysArbnHwAgToMotAgCorrlnElpdTiLim_Val_data;
  uint16 HwAgSysArbnHwAgCorrlnFailDebStep_Val_data;
  uint16 HwAgSysArbnHwAgCorrlnPassDebStep_Val_data;
  ...
  *************************************************/
  ...
  HwAgPrev = *TSC_HwAgSysArbn_Rte_Pim_HwAgPrev();
  *TSC_HwAgSysArbn_Rte_Pim_HwAgPrev() = HwAgPrev;
  PrevHwAgNotCorrd = *TSC_HwAgSysArbn_Rte_Pim_PrevHwAgNotCorrd();
  *TSC_HwAgSysArbn_Rte_Pim_PrevHwAgNotCorrd() = PrevHwAgNotCorrd;
  PrevPinionAgConf = *TSC_HwAgSysArbn_Rte_Pim_PrevPinionAgConf();
  *TSC_HwAgSysArbn_Rte_Pim_PrevPinionAgConf() = PrevPinionAgConf;
  PrevSeldHwAg = *TSC_HwAgSysArbn_Rte_Pim_PrevSeldHwAg();
  *TSC_HwAgSysArbn_Rte_Pim_PrevSeldHwAg() = PrevSeldHwAg;
  SeldHwAgConf = *TSC_HwAgSysArbn_Rte_Pim_SeldHwAgConf();
  *TSC_HwAgSysArbn_Rte_Pim_SeldHwAgConf() = SeldHwAgConf;
  TqSnsrAgPrev = *TSC_HwAgSysArbn_Rte_Pim_TqSnsrAgPrev();
  *TSC_HwAgSysArbn_Rte_Pim_TqSnsrAgPrev() = TqSnsrAgPrev;
  HwAgToMotAgCorrlnDurnRefTmr = *TSC_HwAgSysArbn_Rte_Pim_HwAgToMotAgCorrlnDurnRefTmr();
  *TSC_HwAgSysArbn_Rte_Pim_HwAgToMotAgCorrlnDurnRefTmr() = HwAgToMotAgCorrlnDurnRefTmr;
  SlewElpdRefTmr = *TSC_HwAgSysArbn_Rte_Pim_SlewElpdRefTmr();
  *TSC_HwAgSysArbn_Rte_Pim_SlewElpdRefTmr() = SlewElpdRefTmr;
  PrevSrcSeln = *TSC_HwAgSysArbn_Rte_Pim_PrevSrcSeln();
  *TSC_HwAgSysArbn_Rte_Pim_PrevSrcSeln() = PrevSrcSeln;
  HwAgCorrdLtch = *TSC_HwAgSysArbn_Rte_Pim_HwAgCorrdLtch();
  *TSC_HwAgSysArbn_Rte_Pim_HwAgCorrdLtch() = HwAgCorrdLtch;
  HwAgKineFlt = *TSC_HwAgSysArbn_Rte_Pim_HwAgKineFlt();
  *TSC_HwAgSysArbn_Rte_Pim_HwAgKineFlt() = HwAgKineFlt;
  HwAgToMotAgCorrln = *TSC_HwAgSysArbn_Rte_Pim_HwAgToMotAgCorrln();
  *TSC_HwAgSysArbn_Rte_Pim_HwAgToMotAgCorrln() = HwAgToMotAgCorrln;
  SlewSts = *TSC_HwAgSysArbn_Rte_Pim_SlewSts();
  *TSC_HwAgSysArbn_Rte_Pim_SlewSts() = SlewSts;
  TqSnsrVelFil = *TSC_HwAgSysArbn_Rte_Pim_TqSnsrVelFil();
  *TSC_HwAgSysArbn_Rte_Pim_TqSnsrVelFil() = TqSnsrVelFil;

  HwAgSysArbnHwAgConf1Snsr_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgConf1Snsr_Val();
  HwAgSysArbnHwAgConf2Snsr_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgConf2Snsr_Val();
  HwAgSysArbnHwAgConfNoSnsr_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgConfNoSnsr_Val();
  HwAgSysArbnHwAgCorrdCorrlnThd_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgCorrdCorrlnThd_Val();
  HwAgSysArbnHwAgCorrlnRng_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgCorrlnRng_Val();
  HwAgSysArbnHwAgSlewRate_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgSlewRate_Val();
  HwAgSysArbnHwAgSnsrlsCorrlnThd_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgSnsrlsCorrlnThd_Val();
  HwAgSysArbnHwAgSnsrlsKineThd_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgSnsrlsKineThd_Val();
  HwAgSysArbnSerlComHwAgCorrdConf_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnSerlComHwAgCorrdConf_Val();
  HwAgSysArbnSerlComHwAgSnsrlsConf_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnSerlComHwAgSnsrlsConf_Val();
  HwAgSysArbnSlewRateTmr_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnSlewRateTmr_Val();
  HwAgSysArbnTqSnsrVelFilFrq_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnTqSnsrVelFilFrq_Val();
  SysGlbPrmSysKineRat_Val_data = TSC_HwAgSysArbn_Rte_Prm_SysGlbPrmSysKineRat_Val();
  SysGlbPrmTorsBarStfn_Val_data = TSC_HwAgSysArbn_Rte_Prm_SysGlbPrmTorsBarStfn_Val();
  HwAgSysArbnHwAgToMotAgCorrlnElpdTiLim_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgToMotAgCorrlnElpdTiLim_Val();
  HwAgSysArbnHwAgCorrlnFailDebStep_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgCorrlnFailDebStep_Val();
  HwAgSysArbnHwAgCorrlnPassDebStep_Val_data = TSC_HwAgSysArbn_Rte_Prm_HwAgSysArbnHwAgCorrlnPassDebStep_Val();

  fct_status = TSC_HwAgSysArbn_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_HwAgCorrd_Val;
  uint8 Read_HwAgIdptSig_Val;
  float32 Read_HwAgSnsrls_Val;
  float32 Read_HwAgSnsrlsConf_Val;
  float32 Read_HwTq_Val;
  float32 Read_MotVelCrf_Val;
  boolean Read_MotVelVld_Logl;
  ...
  *TSC_HwAgSysArbn_Rte_Pim_TqSnsrVelFil() = TqSnsrVelFil;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_CmplncErrMotToPinion_Val(&Read_CmplncErrMotToPinion_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_CmplncErrPinionToHw_Val(&Read_CmplncErrPinionToHw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_HwAg_Val(&Read_HwAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_HwAgCorrd_Val(&Read_HwAgCorrd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_HwAgIdptSig_Val(&Read_HwAgIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_HwAgSnsrls_Val(&Read_HwAgSnsrls_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_HwAgSnsrlsConf_Val(&Read_HwAgSnsrlsConf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_HwTq_Val(&Read_HwTq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_MotVelCrf_Val(&Read_MotVelCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Read_MotVelVld_Logl(&Read_MotVelVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_HwAgFinal_Val(Rte_InitValue_HwAgFinal_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_HwAgNotCorrd_Val(Rte_InitValue_HwAgNotCorrd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_HwAgToSerlCom_Val(Rte_InitValue_HwAgToSerlCom_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_HwAgVldToSerlCom_Logl(Rte_InitValue_HwAgVldToSerlCom_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_HwVel_Val(Rte_InitValue_HwVel_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_HwVelToSerlCom_Val(Rte_InitValue_HwVelToSerlCom_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_PinionAg_Val(Rte_InitValue_PinionAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_PinionAgConf_Val(Rte_InitValue_PinionAgConf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_PinionVel_Val(Rte_InitValue_PinionVel_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Write_PinionVelConf_Val(Rte_InitValue_PinionVelConf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Call_FltInj_f32_Oper(&Call_FltInj_f32_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSysArbn_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
