...
#include "Rte_GmMsg0C9BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg0C9BusHiSpd_TestDefines(void);
 ...
 *   Std_ReturnType Rte_Write_EngSpdStsNorm_Logl(boolean data)
 ...
 * Symbol: GmMsg0C9BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_EngRunActvRaw_Val;
  uint16 Read_EngSpdRaw_Val;
  uint8 Read_EngSpdStsRaw_Val;
  uint32 Read_LstRxnTiMsg0C9_Val;
  uint8 Read_PtCrkActvRaw_Val;
  float32 Read_VehSpd_Val;
  boolean Read_VehSpdVld_Logl;

  float32 GmMsg0C9BusHiSpdPrevEndSpd;
  uint32 GmMsg0C9BusHiSpdInvldMsgTmr;
  boolean GmMsg0C9BusHiSpdPrevEngRunActv;

  float32 GmMsg0C9BusHiSpdVehSpdThd_Val_data;
  uint16 GmMsg0C9BusHiSpdInvldTiOut_Val_data;
  uint16 GmMsg0C9BusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg0C9BusHiSpdPrevEndSpd = *TSC_GmMsg0C9BusHiSpd_Rte_Pim_GmMsg0C9BusHiSpdPrevEndSpd();
  *TSC_GmMsg0C9BusHiSpd_Rte_Pim_GmMsg0C9BusHiSpdPrevEndSpd() = GmMsg0C9BusHiSpdPrevEndSpd;
  GmMsg0C9BusHiSpdInvldMsgTmr = *TSC_GmMsg0C9BusHiSpd_Rte_Pim_GmMsg0C9BusHiSpdInvldMsgTmr();
  *TSC_GmMsg0C9BusHiSpd_Rte_Pim_GmMsg0C9BusHiSpdInvldMsgTmr() = GmMsg0C9BusHiSpdInvldMsgTmr;
  GmMsg0C9BusHiSpdPrevEngRunActv = *TSC_GmMsg0C9BusHiSpd_Rte_Pim_GmMsg0C9BusHiSpdPrevEngRunActv();
  *TSC_GmMsg0C9BusHiSpd_Rte_Pim_GmMsg0C9BusHiSpdPrevEngRunActv() = GmMsg0C9BusHiSpdPrevEngRunActv;

  GmMsg0C9BusHiSpdVehSpdThd_Val_data = TSC_GmMsg0C9BusHiSpd_Rte_Prm_GmMsg0C9BusHiSpdVehSpdThd_Val();
  GmMsg0C9BusHiSpdInvldTiOut_Val_data = TSC_GmMsg0C9BusHiSpd_Rte_Prm_GmMsg0C9BusHiSpdInvldTiOut_Val();
  GmMsg0C9BusHiSpdMissTiOut_Val_data = TSC_GmMsg0C9BusHiSpd_Rte_Prm_GmMsg0C9BusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_EngRunActvRaw_Val(&Read_EngRunActvRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_EngSpdRaw_Val(&Read_EngSpdRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_EngSpdStsRaw_Val(&Read_EngSpdStsRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_LstRxnTiMsg0C9_Val(&Read_LstRxnTiMsg0C9_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_PtCrkActvRaw_Val(&Read_PtCrkActvRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Read_VehSpdVld_Logl(&Read_VehSpdVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Write_EngRunActv_Logl(Rte_InitValue_EngRunActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Write_EngSpd_Val(Rte_InitValue_EngSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Write_EngSpdStsNorm_Logl(Rte_InitValue_EngSpdStsNorm_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Write_InvldMsg0C9_Logl(Rte_InitValue_InvldMsg0C9_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Write_MissMsg0C9_Logl(Rte_InitValue_MissMsg0C9_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Write_PtCrkActv_Logl(Rte_InitValue_PtCrkActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg0C9BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
