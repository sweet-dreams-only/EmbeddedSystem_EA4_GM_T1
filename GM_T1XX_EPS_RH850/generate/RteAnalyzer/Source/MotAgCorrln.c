 ...
 *********************************************************************************************************************/
  ...
  uint8 MotAgCorrlnMotAgARollgCntPrev;
  uint8 MotAgCorrlnMotAgAStallCntPrev;
  uint8 MotAgCorrlnMotAgBRollgCntPrev;
  uint8 MotAgCorrlnMotAgBStallCntPrev;
  uint8 MotAgCorrlnMotAgCRollgCntPrev;
  uint8 MotAgCorrlnMotAgCStallCntPrev;
  boolean dMotAgCorrlnMotAgAOk;
  boolean dMotAgCorrlnMotAgBOk;
  boolean dMotAgCorrlnMotAgCOk;
  ...
  *************************************************/
  ...
  MotAgCorrlnErrThd = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnErrThd();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnErrThd() = MotAgCorrlnErrThd;
  MotAgCorrlnMotAgARollgCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgARollgCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgARollgCntPrev() = MotAgCorrlnMotAgARollgCntPrev;
  MotAgCorrlnMotAgAStallCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgAStallCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgAStallCntPrev() = MotAgCorrlnMotAgAStallCntPrev;
  MotAgCorrlnMotAgBRollgCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBRollgCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBRollgCntPrev() = MotAgCorrlnMotAgBRollgCntPrev;
  MotAgCorrlnMotAgBStallCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBStallCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBStallCntPrev() = MotAgCorrlnMotAgBStallCntPrev;
  MotAgCorrlnMotAgCRollgCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgCRollgCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgCRollgCntPrev() = MotAgCorrlnMotAgCRollgCntPrev;
  MotAgCorrlnMotAgCStallCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgCStallCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgCStallCntPrev() = MotAgCorrlnMotAgCStallCntPrev;
  dMotAgCorrlnMotAgAOk = *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgAOk();
  *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgAOk() = dMotAgCorrlnMotAgAOk;
  dMotAgCorrlnMotAgBOk = *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgBOk();
  *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgBOk() = dMotAgCorrlnMotAgBOk;
  dMotAgCorrlnMotAgCOk = *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgCOk();
  *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgCOk() = dMotAgCorrlnMotAgCOk;
 ...
 *********************************************************************************************************************/
  ...
  u0p16 Read_MotAgCMecl_Val;
  SigQlfr1 Read_MotAgCMeclQlfr_Val;
  uint8 Read_MotAgCMeclRollgCntr_Val;
  ...
  *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgCOk() = dMotAgCorrlnMotAgCOk;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgCMecl_Val(&Read_MotAgCMecl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgCMeclQlfr_Val(&Read_MotAgCMeclQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgCMeclRollgCntr_Val(&Read_MotAgCMeclRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Write_MotAgABErrTerm_Val(Rte_InitValue_MotAgABErrTerm_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Write_MotAgACErrTerm_Val(Rte_InitValue_MotAgACErrTerm_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Write_MotAgBCErrTerm_Val(Rte_InitValue_MotAgBCErrTerm_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void MotAgCorrln_TestDefines(void)
{
  ...
  uint8 Test_uint8_LL_2 = Cnt14_LowerLimit;
  uint8 Test_uint8_UL_2 = Cnt14_UpperLimit;
  uint8 Test_uint8_LL_3 = Cnt22_LowerLimit;
  uint8 Test_uint8_UL_3 = Cnt22_UpperLimit;
  uint8 Test_uint8_LL_4 = Uls24_LowerLimit;
  uint8 Test_uint8_UL_4 = Uls24_UpperLimit;
