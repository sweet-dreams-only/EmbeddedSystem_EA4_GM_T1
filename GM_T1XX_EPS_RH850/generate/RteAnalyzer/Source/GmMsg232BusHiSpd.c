 ...
 *
 *   Description:  C-Code implementation template for SW-C <GmMsg232BusHiSpd>
 *********************************************************************************************************************/
...
#include "Rte_GmMsg232BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg232BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg232BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: GmMsg232BusHiSpdPer1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 Read_LstRxnTiMsg232_Val;
  uint8 Read_SteerSysPrfmncModReqRaw_Val;

  uint8 GmMsg232BusHiSpdPrevDesRtIdx;

  uint16 GmMsg232BusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg232BusHiSpdPrevDesRtIdx = *TSC_GmMsg232BusHiSpd_Rte_Pim_GmMsg232BusHiSpdPrevDesRtIdx();
  *TSC_GmMsg232BusHiSpd_Rte_Pim_GmMsg232BusHiSpdPrevDesRtIdx() = GmMsg232BusHiSpdPrevDesRtIdx;

  GmMsg232BusHiSpdMissTiOut_Val_data = TSC_GmMsg232BusHiSpd_Rte_Prm_GmMsg232BusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg232BusHiSpd_Rte_Read_LstRxnTiMsg232_Val(&Read_LstRxnTiMsg232_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg232BusHiSpd_Rte_Read_SteerSysPrfmncModReqRaw_Val(&Read_SteerSysPrfmncModReqRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg232BusHiSpd_Rte_Write_DesRtIdx_Val(Rte_InitValue_DesRtIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg232BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg232BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
