...
#include "Rte_HwAgCorrln.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void HwAgCorrln_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_HwAgBARollgCntr_Val;
  SigQlfr1 Read_HwAgBQlfr_Val;

  uint8 HwAgARollgCntPrev;
  uint8 HwAgAStallCntPrev;
  uint8 HwAgBRollgCntPrev;
  uint8 HwAgBStallCntPrev;
  boolean dHwAgCorrlnAgAAvl;
  boolean dHwAgCorrlnAgBAvl;

  float32 HwAgCorrlnHwAgAbsltDif_Val_data;
  uint16 HwAgCorrlnNtc0x092FailStep_Val_data;
  uint16 HwAgCorrlnNtc0x092PassStep_Val_data;
  uint8 HwAgCorrlnHwAgMaxStall_Val_data;
  ...
  *************************************************/
  ...
  HwAgARollgCntPrev = *TSC_HwAgCorrln_Rte_Pim_HwAgARollgCntPrev();
  *TSC_HwAgCorrln_Rte_Pim_HwAgARollgCntPrev() = HwAgARollgCntPrev;
  HwAgAStallCntPrev = *TSC_HwAgCorrln_Rte_Pim_HwAgAStallCntPrev();
  *TSC_HwAgCorrln_Rte_Pim_HwAgAStallCntPrev() = HwAgAStallCntPrev;
  HwAgBRollgCntPrev = *TSC_HwAgCorrln_Rte_Pim_HwAgBRollgCntPrev();
  *TSC_HwAgCorrln_Rte_Pim_HwAgBRollgCntPrev() = HwAgBRollgCntPrev;
  HwAgBStallCntPrev = *TSC_HwAgCorrln_Rte_Pim_HwAgBStallCntPrev();
  *TSC_HwAgCorrln_Rte_Pim_HwAgBStallCntPrev() = HwAgBStallCntPrev;
  dHwAgCorrlnAgAAvl = *TSC_HwAgCorrln_Rte_Pim_dHwAgCorrlnAgAAvl();
  *TSC_HwAgCorrln_Rte_Pim_dHwAgCorrlnAgAAvl() = dHwAgCorrlnAgAAvl;
  dHwAgCorrlnAgBAvl = *TSC_HwAgCorrln_Rte_Pim_dHwAgCorrlnAgBAvl();
  *TSC_HwAgCorrln_Rte_Pim_dHwAgCorrlnAgBAvl() = dHwAgCorrlnAgBAvl;

  HwAgCorrlnHwAgAbsltDif_Val_data = TSC_HwAgCorrln_Rte_Prm_HwAgCorrlnHwAgAbsltDif_Val();
  HwAgCorrlnNtc0x092FailStep_Val_data = TSC_HwAgCorrln_Rte_Prm_HwAgCorrlnNtc0x092FailStep_Val();
  HwAgCorrlnNtc0x092PassStep_Val_data = TSC_HwAgCorrln_Rte_Prm_HwAgCorrlnNtc0x092PassStep_Val();
  HwAgCorrlnHwAgMaxStall_Val_data = TSC_HwAgCorrln_Rte_Prm_HwAgCorrlnHwAgMaxStall_Val();

  fct_status = TSC_HwAgCorrln_Rte_Read_HwAgA_Val(&Read_HwAgA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Read_HwAgAQlfr_Val(&Read_HwAgAQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Read_HwAgARollgCntr_Val(&Read_HwAgARollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Read_HwAgB_Val(&Read_HwAgB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Read_HwAgBARollgCntr_Val(&Read_HwAgBARollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Read_HwAgBQlfr_Val(&Read_HwAgBQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Write_HwAgCorrlnSt_Val(Rte_InitValue_HwAgCorrlnSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Write_HwAgIdptSig_Val(Rte_InitValue_HwAgIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Call_FltInj_f32_Oper(&Call_FltInj_f32_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Call_FltInj_u08_Oper(&Call_FltInj_u08_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgCorrln_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
