 ...
 *********************************************************************************************************************/
  ...
  uint8 PrevActvIninIdx;
  uint8 PrevActvRtIdx;
  uint8 PrevRamPageAcs;
  uint8 RamTblSwt;
  OnlineCalStsRec1 OnlineCalSts;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PrevActvIninIdx = *TSC_TunSelnMngt_Rte_Pim_PrevActvIninIdx();
  *TSC_TunSelnMngt_Rte_Pim_PrevActvIninIdx() = PrevActvIninIdx;
  PrevActvRtIdx = *TSC_TunSelnMngt_Rte_Pim_PrevActvRtIdx();
  *TSC_TunSelnMngt_Rte_Pim_PrevActvRtIdx() = PrevActvRtIdx;
  PrevRamPageAcs = *TSC_TunSelnMngt_Rte_Pim_PrevRamPageAcs();
  *TSC_TunSelnMngt_Rte_Pim_PrevRamPageAcs() = PrevRamPageAcs;
  RamTblSwt = *TSC_TunSelnMngt_Rte_Pim_RamTblSwt();
  *TSC_TunSelnMngt_Rte_Pim_RamTblSwt() = RamTblSwt;
  OnlineCalSts = *TSC_TunSelnMngt_Rte_Pim_OnlineCalSts();
  *TSC_TunSelnMngt_Rte_Pim_OnlineCalSts() = OnlineCalSts;
