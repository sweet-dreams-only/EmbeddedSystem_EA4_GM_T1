 ...
 *********************************************************************************************************************/
  ...
  float32 HwTqChACmnModCmpLpFilSt;
  float32 HwTqChBCmnModCmpLpFilSt;
  uint8 HwTqARollgCntrPrev;
  uint8 HwTqAStallCntrPrev;
  uint8 HwTqBRollgCntrPrev;
  uint8 HwTqBStallCntrPrev;
  uint8 HwTqCRollgCntrPrev;
  uint8 HwTqCStallCntrPrev;
  uint8 HwTqDRollgCntrPrev;
  uint8 HwTqDStallCntrPrev;
  boolean HwTqChAImdtCorrlnChk;
  boolean HwTqChBImdtCorrlnChk;
  FilLpRec1 HwTqChACmnModCmpLpFil;
  FilLpRec1 HwTqChAStabStLpFil;
  FilLpRec1 HwTqChATraLpFil;
  FilLpRec1 HwTqChBCmnModCmpLpFil;
  FilLpRec1 HwTqChBStabStLpFil;
  FilLpRec1 HwTqChBTraLpFil;

  float32 HwTqChACmnModCmpLpFilStDft_data;
  float32 HwTqChBCmnModCmpLpFilStDft_data;
  ...
  float32 HwTqCorrlnChBCmnModCmpLpFilActvnThd_Val_data;
  float32 HwTqCorrlnChBCmnModCmpLpFilFrq_Val_data;
  float32 HwTqCorrlnChBCmnModCmpLpFilOutpLim_Val_data;
  float32 HwTqCorrlnChBImdtCorrlnChkFailThd_Val_data;
  float32 HwTqCorrlnChBImdtCorrlnChkPassThd_Val_data;
  float32 HwTqCorrlnChBStabStClrFltThd_Val_data;
  float32 HwTqCorrlnChBStabStLpFilFrq_Val_data;
  float32 HwTqCorrlnChBStabStSetFltThd_Val_data;
  float32 HwTqCorrlnChBTqSumMaxLim_Val_data;
  float32 HwTqCorrlnChBTraSumClrFltThd_Val_data;
  float32 HwTqCorrlnChBTraSumSetFltThd_Val_data;
  uint8 HwTqCorrlnMaxStallTqA_Val_data;
  uint8 HwTqCorrlnMaxStallTqB_Val_data;
  uint8 HwTqCorrlnMaxStallTqC_Val_data;
  uint8 HwTqCorrlnMaxStallTqD_Val_data;
  Ary1D_u5p11_17 HwTqCorrlnChATraLpFilX_Ary1D_data;
  Ary1D_u6p10_17 HwTqCorrlnChATraLpFilY_Ary1D_data;
  Ary1D_u5p11_17 HwTqCorrlnChBTraLpFilX_Ary1D_data;
  Ary1D_u6p10_17 HwTqCorrlnChBTraLpFilY_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  HwTqChACmnModCmpLpFilSt = *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFilSt();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFilSt() = HwTqChACmnModCmpLpFilSt;
  HwTqChBCmnModCmpLpFilSt = *TSC_HwTqCorrln_Rte_Pim_HwTqChBCmnModCmpLpFilSt();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBCmnModCmpLpFilSt() = HwTqChBCmnModCmpLpFilSt;
  HwTqARollgCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqARollgCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqARollgCntrPrev() = HwTqARollgCntrPrev;
  HwTqAStallCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqAStallCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqAStallCntrPrev() = HwTqAStallCntrPrev;
  HwTqBRollgCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqBRollgCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqBRollgCntrPrev() = HwTqBRollgCntrPrev;
  HwTqBStallCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqBStallCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqBStallCntrPrev() = HwTqBStallCntrPrev;
  HwTqCRollgCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqCRollgCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqCRollgCntrPrev() = HwTqCRollgCntrPrev;
  HwTqCStallCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqCStallCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqCStallCntrPrev() = HwTqCStallCntrPrev;
  HwTqDRollgCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqDRollgCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqDRollgCntrPrev() = HwTqDRollgCntrPrev;
  HwTqDStallCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqDStallCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqDStallCntrPrev() = HwTqDStallCntrPrev;
  HwTqChAImdtCorrlnChk = *TSC_HwTqCorrln_Rte_Pim_HwTqChAImdtCorrlnChk();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChAImdtCorrlnChk() = HwTqChAImdtCorrlnChk;
  HwTqChBImdtCorrlnChk = *TSC_HwTqCorrln_Rte_Pim_HwTqChBImdtCorrlnChk();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBImdtCorrlnChk() = HwTqChBImdtCorrlnChk;
  HwTqChACmnModCmpLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFil() = HwTqChACmnModCmpLpFil;
  HwTqChAStabStLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChAStabStLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChAStabStLpFil() = HwTqChAStabStLpFil;
  HwTqChATraLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil() = HwTqChATraLpFil;
  HwTqChBCmnModCmpLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChBCmnModCmpLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBCmnModCmpLpFil() = HwTqChBCmnModCmpLpFil;
  HwTqChBStabStLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChBStabStLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBStabStLpFil() = HwTqChBStabStLpFil;
  HwTqChBTraLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChBTraLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBTraLpFil() = HwTqChBTraLpFil;

  HwTqChACmnModCmpLpFilStDft_data = TSC_HwTqCorrln_Rte_CData_HwTqChACmnModCmpLpFilStDft();
  HwTqChBCmnModCmpLpFilStDft_data = TSC_HwTqCorrln_Rte_CData_HwTqChBCmnModCmpLpFilStDft();
  ...
  HwTqCorrlnChBCmnModCmpLpFilActvnThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBCmnModCmpLpFilActvnThd_Val();
  HwTqCorrlnChBCmnModCmpLpFilFrq_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBCmnModCmpLpFilFrq_Val();
  HwTqCorrlnChBCmnModCmpLpFilOutpLim_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBCmnModCmpLpFilOutpLim_Val();
  HwTqCorrlnChBImdtCorrlnChkFailThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBImdtCorrlnChkFailThd_Val();
  HwTqCorrlnChBImdtCorrlnChkPassThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBImdtCorrlnChkPassThd_Val();
  HwTqCorrlnChBStabStClrFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBStabStClrFltThd_Val();
  HwTqCorrlnChBStabStLpFilFrq_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBStabStLpFilFrq_Val();
  HwTqCorrlnChBStabStSetFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBStabStSetFltThd_Val();
  HwTqCorrlnChBTqSumMaxLim_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBTqSumMaxLim_Val();
  HwTqCorrlnChBTraSumClrFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBTraSumClrFltThd_Val();
  HwTqCorrlnChBTraSumSetFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBTraSumSetFltThd_Val();
  HwTqCorrlnMaxStallTqA_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnMaxStallTqA_Val();
  HwTqCorrlnMaxStallTqB_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnMaxStallTqB_Val();
  HwTqCorrlnMaxStallTqC_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnMaxStallTqC_Val();
  HwTqCorrlnMaxStallTqD_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnMaxStallTqD_Val();
  ...
  (void)memcpy(HwTqCorrlnChBTraLpFilX_Ary1D_data, TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBTraLpFilX_Ary1D(), sizeof(Ary1D_u5p11_17));
  (void)memcpy(HwTqCorrlnChBTraLpFilY_Ary1D_data, TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChBTraLpFilY_Ary1D(), sizeof(Ary1D_u6p10_17));
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBTraLpFil() = HwTqChBTraLpFil;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqC_Val(&Read_HwTqC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqCQlfr_Val(&Read_HwTqCQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqCRollgCntr_Val(&Read_HwTqCRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqD_Val(&Read_HwTqD_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqDQlfr_Val(&Read_HwTqDQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqDRollgCntr_Val(&Read_HwTqDRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_HwTqCorrln_Rte_IrvWrite_HwTqCorrlnPer1_HwTqChBAvl(TRUE);
 ...
 *********************************************************************************************************************/
  ...
  boolean HwTqCorrlnPer2_HwTqChBAvl;
  ...
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBTraLpFil() = HwTqChBTraLpFil;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Write_HwTqChBCorrlnTraErr_Val(Rte_InitValue_HwTqChBCorrlnTraErr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  HwTqCorrlnPer2_HwTqChBAvl = TSC_HwTqCorrln_Rte_IrvRead_HwTqCorrlnPer2_HwTqChBAvl();

  TSC_HwTqCorrln_Rte_IrvWrite_HwTqCorrlnPer2_HwTqChATqSumLim(0.0F);
  TSC_HwTqCorrln_Rte_IrvWrite_HwTqCorrlnPer2_HwTqChBTqSumLim(0.0F);
 ...
 *   Std_ReturnType Rte_Call_HwTqChBCmnModCmpLpFilSt_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_E_NOT_OK
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 HwTqCorrlnPer3_HwTqChBTqSumLim;
  ...
  *TSC_HwTqCorrln_Rte_Pim_HwTqChBTraLpFil() = HwTqChBTraLpFil;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqChB_Val(&Read_HwTqChB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  HwTqCorrlnPer3_HwTqChBTqSumLim = TSC_HwTqCorrln_Rte_IrvRead_HwTqCorrlnPer3_HwTqChBTqSumLim();
  ...
  fct_status = TSC_HwTqCorrln_Rte_Call_HwTqChBCmnModCmpLpFilSt_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
