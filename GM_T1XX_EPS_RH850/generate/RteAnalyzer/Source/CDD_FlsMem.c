 ...
 *********************************************************************************************************************/
  ...
  uint32 CodFlsCrcChkStrtTi;
  uint16 CrcHwIdxKey;
  boolean CodFlsSngBitErr;
  boolean CrcChkCmpl;
  boolean PwrOnRstCrcChkCmpl;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  CodFlsCrcChkStrtTi = *TSC_CDD_FlsMem_Rte_Pim_CodFlsCrcChkStrtTi();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsCrcChkStrtTi() = CodFlsCrcChkStrtTi;
  CrcHwIdxKey = *TSC_CDD_FlsMem_Rte_Pim_CrcHwIdxKey();
  *TSC_CDD_FlsMem_Rte_Pim_CrcHwIdxKey() = CrcHwIdxKey;
  CodFlsSngBitErr = *TSC_CDD_FlsMem_Rte_Pim_CodFlsSngBitErr();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsSngBitErr() = CodFlsSngBitErr;
  CrcChkCmpl = *TSC_CDD_FlsMem_Rte_Pim_CrcChkCmpl();
  *TSC_CDD_FlsMem_Rte_Pim_CrcChkCmpl() = CrcChkCmpl;
  PwrOnRstCrcChkCmpl = *TSC_CDD_FlsMem_Rte_Pim_PwrOnRstCrcChkCmpl();
  *TSC_CDD_FlsMem_Rte_Pim_PwrOnRstCrcChkCmpl() = PwrOnRstCrcChkCmpl;
 ...
 *********************************************************************************************************************/
  ...
  uint16 Call_ResvCrcHwUnit_Oper_ResvKey_Arg = 0U;
  ...
  *TSC_CDD_FlsMem_Rte_Pim_PwrOnRstCrcChkCmpl() = PwrOnRstCrcChkCmpl;
  ...
  switch (fct_status)
  {
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_ResvCrcHwUnit_PortIf1_E_NOT_OK:
      fct_error = 1;
      break;
  }
