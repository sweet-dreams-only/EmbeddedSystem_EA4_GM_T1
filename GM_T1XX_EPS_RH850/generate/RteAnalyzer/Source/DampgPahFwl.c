...
#include "Rte_DampgPahFwl.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void DampgPahFwl_TestDefines(void);
 ...
 *     Returnvalue: s11p4* is of type Ary1D_s11p4_11
 *   s7p8 *Rte_Prm_DampgPahFwlDampgCmdUpprLimY_Ary2D(void)
 *     Returnvalue: s7p8* is of type Ary2D_s7p8_12_11
 *   u11p5 *Rte_Prm_DampgPahFwlDftDampgX_Ary1D(void)
 *     Returnvalue: u11p5* is of type Ary1D_u11p5_11
 ...
 *********************************************************************************************************************/
  ...
  float32 dDampgPahFwlActvRaw;
  float32 dDampgPahFwlAddDampg;
  float32 dDampgPahFwlDampgCmdLimd;
  float32 dDampgPahFwlDampgCmdLowrLimFild;
  float32 dDampgPahFwlDampgCmdUpprLimFild;
  float32 dDampgPahFwlInertiaCmpHpPah;
  float32 dDampgPahFwlInertiaCmpLowrLimFild;
  float32 dDampgPahFwlInertiaCmpLpLimd;
  float32 dDampgPahFwlInertiaCmpLpPah;
  float32 dDampgPahFwlInertiaCmpUpprLimFild;
  boolean DampgDecPrfmncPrev;
  boolean dDampgPahFwlDampgCmdOverLim;
  boolean dDampgPahFwlInertiaCmpOverLim;
  FilLpRec1 DampgCmdLpFilLowrLim;
  FilLpRec1 DampgCmdLpFilUpprLim;
  FilLpRec1 FwlActvLpFil;
  FilLpRec1 InertiaCmpLpFil;
  FilLpRec1 InertiaCmpLpFilLowrLim;
  FilLpRec1 InertiaCmpLpFilUpprLim;

  float32 DampgPahFwlActvFwlLpFilFrq_Val_data;
  float32 DampgPahFwlDampgCmdLpFilFrq_Val_data;
  float32 DampgPahFwlInertiaCmpLpFilFrq_Val_data;
  uint16 DampgPahFwlDampgCmdFwlOverLimDiagcFailStep_Val_data;
  uint16 DampgPahFwlDampgCmdFwlOverLimDiagcPassStep_Val_data;
  uint16 DampgPahFwlInertiaCmpCmdFwlOverLimDiagcFailStep_Val_data;
  uint16 DampgPahFwlInertiaCmpCmdFwlOverLimDiagcPassStep_Val_data;
  Ary1D_u11p5_8 DampgPahFwlAssiAddlDampgX_Ary1D_data;
  Ary1D_u5p11_8 DampgPahFwlAssiAddlDampgY_Ary1D_data;
  Ary1D_u11p5_8 DampgPahFwlDampgCmdAddlDampgX_Ary1D_data;
  Ary1D_u5p11_8 DampgPahFwlDampgCmdAddlDampgY_Ary1D_data;
  Ary1D_s11p4_11 DampgPahFwlDampgCmdUpprLimX_Ary1D_data;
  Ary2D_s7p8_12_11 DampgPahFwlDampgCmdUpprLimY_Ary2D_data;
  Ary1D_u11p5_11 DampgPahFwlDftDampgX_Ary1D_data;
  Ary1D_u5p11_11 DampgPahFwlDftDampgY_Ary1D_data;
  Ary1D_s11p4_11 DampgPahFwlInertiaCmpUpprLimX_Ary1D_data;
  Ary2D_s7p8_12_11 DampgPahFwlInertiaCmpUpprLimY_Ary2D_data;
  Ary1D_u9p7_12 DampgPahFwlVehSpd_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  dDampgPahFwlActvRaw = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlActvRaw();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlActvRaw() = dDampgPahFwlActvRaw;
  dDampgPahFwlAddDampg = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlAddDampg();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlAddDampg() = dDampgPahFwlAddDampg;
  dDampgPahFwlDampgCmdLimd = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdLimd();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdLimd() = dDampgPahFwlDampgCmdLimd;
  dDampgPahFwlDampgCmdLowrLimFild = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdLowrLimFild();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdLowrLimFild() = dDampgPahFwlDampgCmdLowrLimFild;
  dDampgPahFwlDampgCmdUpprLimFild = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdUpprLimFild();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdUpprLimFild() = dDampgPahFwlDampgCmdUpprLimFild;
  dDampgPahFwlInertiaCmpHpPah = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpHpPah();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpHpPah() = dDampgPahFwlInertiaCmpHpPah;
  dDampgPahFwlInertiaCmpLowrLimFild = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpLowrLimFild();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpLowrLimFild() = dDampgPahFwlInertiaCmpLowrLimFild;
  dDampgPahFwlInertiaCmpLpLimd = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpLpLimd();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpLpLimd() = dDampgPahFwlInertiaCmpLpLimd;
  dDampgPahFwlInertiaCmpLpPah = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpLpPah();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpLpPah() = dDampgPahFwlInertiaCmpLpPah;
  dDampgPahFwlInertiaCmpUpprLimFild = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpUpprLimFild();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpUpprLimFild() = dDampgPahFwlInertiaCmpUpprLimFild;
  DampgDecPrfmncPrev = *TSC_DampgPahFwl_Rte_Pim_DampgDecPrfmncPrev();
  *TSC_DampgPahFwl_Rte_Pim_DampgDecPrfmncPrev() = DampgDecPrfmncPrev;
  dDampgPahFwlDampgCmdOverLim = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdOverLim();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlDampgCmdOverLim() = dDampgPahFwlDampgCmdOverLim;
  dDampgPahFwlInertiaCmpOverLim = *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpOverLim();
  *TSC_DampgPahFwl_Rte_Pim_dDampgPahFwlInertiaCmpOverLim() = dDampgPahFwlInertiaCmpOverLim;
  DampgCmdLpFilLowrLim = *TSC_DampgPahFwl_Rte_Pim_DampgCmdLpFilLowrLim();
  *TSC_DampgPahFwl_Rte_Pim_DampgCmdLpFilLowrLim() = DampgCmdLpFilLowrLim;
  DampgCmdLpFilUpprLim = *TSC_DampgPahFwl_Rte_Pim_DampgCmdLpFilUpprLim();
  *TSC_DampgPahFwl_Rte_Pim_DampgCmdLpFilUpprLim() = DampgCmdLpFilUpprLim;
  FwlActvLpFil = *TSC_DampgPahFwl_Rte_Pim_FwlActvLpFil();
  *TSC_DampgPahFwl_Rte_Pim_FwlActvLpFil() = FwlActvLpFil;
  InertiaCmpLpFil = *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFil();
  *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFil() = InertiaCmpLpFil;
  InertiaCmpLpFilLowrLim = *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFilLowrLim();
  *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFilLowrLim() = InertiaCmpLpFilLowrLim;
  InertiaCmpLpFilUpprLim = *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFilUpprLim();
  *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFilUpprLim() = InertiaCmpLpFilUpprLim;

  DampgPahFwlActvFwlLpFilFrq_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlActvFwlLpFilFrq_Val();
  DampgPahFwlDampgCmdLpFilFrq_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdLpFilFrq_Val();
  DampgPahFwlInertiaCmpLpFilFrq_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlInertiaCmpLpFilFrq_Val();
  DampgPahFwlDampgCmdFwlOverLimDiagcFailStep_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdFwlOverLimDiagcFailStep_Val();
  DampgPahFwlDampgCmdFwlOverLimDiagcPassStep_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdFwlOverLimDiagcPassStep_Val();
  DampgPahFwlInertiaCmpCmdFwlOverLimDiagcFailStep_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlInertiaCmpCmdFwlOverLimDiagcFailStep_Val();
  DampgPahFwlInertiaCmpCmdFwlOverLimDiagcPassStep_Val_data = TSC_DampgPahFwl_Rte_Prm_DampgPahFwlInertiaCmpCmdFwlOverLimDiagcPassStep_Val();
  (void)memcpy(DampgPahFwlAssiAddlDampgX_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlAssiAddlDampgX_Ary1D(), sizeof(Ary1D_u11p5_8));
  (void)memcpy(DampgPahFwlAssiAddlDampgY_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlAssiAddlDampgY_Ary1D(), sizeof(Ary1D_u5p11_8));
  (void)memcpy(DampgPahFwlDampgCmdAddlDampgX_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdAddlDampgX_Ary1D(), sizeof(Ary1D_u11p5_8));
  (void)memcpy(DampgPahFwlDampgCmdAddlDampgY_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdAddlDampgY_Ary1D(), sizeof(Ary1D_u5p11_8));
  (void)memcpy(DampgPahFwlDampgCmdUpprLimX_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdUpprLimX_Ary1D(), sizeof(Ary1D_s11p4_11));
  (void)memcpy(DampgPahFwlDampgCmdUpprLimY_Ary2D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDampgCmdUpprLimY_Ary2D(), sizeof(Ary2D_s7p8_12_11));
  (void)memcpy(DampgPahFwlDftDampgX_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDftDampgX_Ary1D(), sizeof(Ary1D_u11p5_11));
  (void)memcpy(DampgPahFwlDftDampgY_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlDftDampgY_Ary1D(), sizeof(Ary1D_u5p11_11));
  (void)memcpy(DampgPahFwlInertiaCmpUpprLimX_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlInertiaCmpUpprLimX_Ary1D(), sizeof(Ary1D_s11p4_11));
  (void)memcpy(DampgPahFwlInertiaCmpUpprLimY_Ary2D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlInertiaCmpUpprLimY_Ary2D(), sizeof(Ary2D_s7p8_12_11));
  (void)memcpy(DampgPahFwlVehSpd_Ary1D_data, TSC_DampgPahFwl_Rte_Prm_DampgPahFwlVehSpd_Ary1D(), sizeof(Ary1D_u9p7_12));

  fct_status = TSC_DampgPahFwl_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_InertiaCmpVelCmd_Val;
  ...
  *TSC_DampgPahFwl_Rte_Pim_InertiaCmpLpFilUpprLim() = InertiaCmpLpFilUpprLim;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_AssiPahLimrActv_Val(&Read_AssiPahLimrActv_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_DampgCmdBas_Val(&Read_DampgCmdBas_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_DampgCmdBasDi_Logl(&Read_DampgCmdBasDi_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_InertiaCmpVelCmd_Val(&Read_InertiaCmpVelCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_MfgEnaSt_Val(&Read_MfgEnaSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_MotVelCrf_Val(&Read_MotVelCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Write_DampgCmd_Val(Rte_InitValue_DampgCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_DampgPahFwl_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
