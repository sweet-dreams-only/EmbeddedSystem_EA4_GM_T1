...
#include "Rte_EotProtnFwl.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void EotProtnFwl_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 dEotProtnFwlEotActvCmdActvLowrBnd;
  float32 dEotProtnFwlEotActvCmdActvUpprBnd;
  float32 dEotProtnFwlEotDampgActvLowrBnd;
  float32 dEotProtnFwlEotDampgActvUpprBnd;
  float32 dEotProtnFwlEotDampgFwX0;
  uint8 dEotProtnFwlEotActvCmdMod;
  uint8 dEotProtnFwlEotDampgMod;
  boolean dEotProtnFwlEotActvCmdOverActvLim;
  boolean dEotProtnFwlEotActvCmdOverInactvLim;
  boolean dEotProtnFwlEotDampgOverActvLim;
  boolean dEotProtnFwlEotDampgOverInactvLim;
  boolean dEotProtnFwlPinionAgConfSts;

  float32 EotProtnFwlInactvLim_Val_data;
  float32 EotProtnHwAgMin_Val_data;
  float32 EotProtnRackTrvlLimrRng_Val_data;
  float32 EotProtnSoftEndStopAuthyThd_Val_data;
  Ary1D_s4p11_5 EotProtnFwlActvCmdLowrBnd_Ary1D_data;
  Ary1D_s4p11_5 EotProtnFwlActvCmdUpprBnd_Ary1D_data;
  Ary1D_s11p4_5 EotProtnFwlEotDampgActvBndX_Ary1D_data;
  Ary2D_s7p8_4_5 EotProtnFwlEotDampgActvBndY_Ary2D_data;
  Ary1D_u9p7_4 EotProtnFwlVehSpd_Ary1D_data;
  ...
  *************************************************/
  ...
  dEotProtnFwlEotActvCmdActvLowrBnd = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdActvLowrBnd();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdActvLowrBnd() = dEotProtnFwlEotActvCmdActvLowrBnd;
  dEotProtnFwlEotActvCmdActvUpprBnd = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdActvUpprBnd();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdActvUpprBnd() = dEotProtnFwlEotActvCmdActvUpprBnd;
  dEotProtnFwlEotDampgActvLowrBnd = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgActvLowrBnd();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgActvLowrBnd() = dEotProtnFwlEotDampgActvLowrBnd;
  dEotProtnFwlEotDampgActvUpprBnd = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgActvUpprBnd();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgActvUpprBnd() = dEotProtnFwlEotDampgActvUpprBnd;
  dEotProtnFwlEotDampgFwX0 = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgFwX0();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgFwX0() = dEotProtnFwlEotDampgFwX0;
  dEotProtnFwlEotActvCmdMod = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdMod();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdMod() = dEotProtnFwlEotActvCmdMod;
  dEotProtnFwlEotDampgMod = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgMod();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgMod() = dEotProtnFwlEotDampgMod;
  dEotProtnFwlEotActvCmdOverActvLim = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdOverActvLim();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdOverActvLim() = dEotProtnFwlEotActvCmdOverActvLim;
  dEotProtnFwlEotActvCmdOverInactvLim = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdOverInactvLim();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotActvCmdOverInactvLim() = dEotProtnFwlEotActvCmdOverInactvLim;
  dEotProtnFwlEotDampgOverActvLim = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgOverActvLim();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgOverActvLim() = dEotProtnFwlEotDampgOverActvLim;
  dEotProtnFwlEotDampgOverInactvLim = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgOverInactvLim();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlEotDampgOverInactvLim() = dEotProtnFwlEotDampgOverInactvLim;
  dEotProtnFwlPinionAgConfSts = *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlPinionAgConfSts();
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlPinionAgConfSts() = dEotProtnFwlPinionAgConfSts;

  EotProtnFwlInactvLim_Val_data = TSC_EotProtnFwl_Rte_Prm_EotProtnFwlInactvLim_Val();
  EotProtnHwAgMin_Val_data = TSC_EotProtnFwl_Rte_Prm_EotProtnHwAgMin_Val();
  EotProtnRackTrvlLimrRng_Val_data = TSC_EotProtnFwl_Rte_Prm_EotProtnRackTrvlLimrRng_Val();
  EotProtnSoftEndStopAuthyThd_Val_data = TSC_EotProtnFwl_Rte_Prm_EotProtnSoftEndStopAuthyThd_Val();
  (void)memcpy(EotProtnFwlActvCmdLowrBnd_Ary1D_data, TSC_EotProtnFwl_Rte_Prm_EotProtnFwlActvCmdLowrBnd_Ary1D(), sizeof(Ary1D_s4p11_5));
  (void)memcpy(EotProtnFwlActvCmdUpprBnd_Ary1D_data, TSC_EotProtnFwl_Rte_Prm_EotProtnFwlActvCmdUpprBnd_Ary1D(), sizeof(Ary1D_s4p11_5));
  (void)memcpy(EotProtnFwlEotDampgActvBndX_Ary1D_data, TSC_EotProtnFwl_Rte_Prm_EotProtnFwlEotDampgActvBndX_Ary1D(), sizeof(Ary1D_s11p4_5));
  (void)memcpy(EotProtnFwlEotDampgActvBndY_Ary2D_data, TSC_EotProtnFwl_Rte_Prm_EotProtnFwlEotDampgActvBndY_Ary2D(), sizeof(Ary2D_s7p8_4_5));
  (void)memcpy(EotProtnFwlVehSpd_Ary1D_data, TSC_EotProtnFwl_Rte_Prm_EotProtnFwlVehSpd_Ary1D(), sizeof(Ary1D_u9p7_4));
  (void)memcpy(EotProtnHwDegDampgX_Ary2D_data, TSC_EotProtnFwl_Rte_Prm_EotProtnHwDegDampgX_Ary2D(), sizeof(Ary2D_u12p4_4_2));

  fct_status = TSC_EotProtnFwl_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_EotActvCmd_Val;
  float32 Read_EotDampgCmd_Val;
  ...
  *TSC_EotProtnFwl_Rte_Pim_dEotProtnFwlPinionAgConfSts() = dEotProtnFwlPinionAgConfSts;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_EotActvCmd_Val(&Read_EotActvCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_EotDampgCmd_Val(&Read_EotDampgCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_EotProtnDi_Logl(&Read_EotProtnDi_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_HwAg_Val(&Read_HwAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_MfgEnaSt_Val(&Read_MfgEnaSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_MotVelCrf_Val(&Read_MotVelCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_PinionAgConf_Val(&Read_PinionAgConf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Write_EotActvCmdLimd_Val(Rte_InitValue_EotActvCmdLimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EotProtnFwl_Rte_Write_EotDampgCmdLimd_Val(Rte_InitValue_EotDampgCmdLimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
