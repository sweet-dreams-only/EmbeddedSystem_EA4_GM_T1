 ...
 *
 *   Description:  C-Code implementation template for SW-C <GmMsg1F5BusHiSpd>
 *********************************************************************************************************************/
...
#include "Rte_GmMsg1F5BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg1F5BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg1F5BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: GmMsg1F5BusHiSpdPer1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 Read_LstRxnTiMsg1F5_Val;
  uint8 Read_ShiftLvrPosnRaw_Val;
  uint8 Read_ShiftLvrPosnVldRaw_Val;

  uint32 GmMsg1F5BusHiSpdInvldTmr;
  boolean GmMsg1F5BusHiSpdPrevShiftLvrInRvs;

  uint16 GmMsg1F5BusHiSpdInvldTiOut_Val_data;
  uint16 GmMsg1F5BusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg1F5BusHiSpdInvldTmr = *TSC_GmMsg1F5BusHiSpd_Rte_Pim_GmMsg1F5BusHiSpdInvldTmr();
  *TSC_GmMsg1F5BusHiSpd_Rte_Pim_GmMsg1F5BusHiSpdInvldTmr() = GmMsg1F5BusHiSpdInvldTmr;
  GmMsg1F5BusHiSpdPrevShiftLvrInRvs = *TSC_GmMsg1F5BusHiSpd_Rte_Pim_GmMsg1F5BusHiSpdPrevShiftLvrInRvs();
  *TSC_GmMsg1F5BusHiSpd_Rte_Pim_GmMsg1F5BusHiSpdPrevShiftLvrInRvs() = GmMsg1F5BusHiSpdPrevShiftLvrInRvs;

  GmMsg1F5BusHiSpdInvldTiOut_Val_data = TSC_GmMsg1F5BusHiSpd_Rte_Prm_GmMsg1F5BusHiSpdInvldTiOut_Val();
  GmMsg1F5BusHiSpdMissTiOut_Val_data = TSC_GmMsg1F5BusHiSpd_Rte_Prm_GmMsg1F5BusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Read_LstRxnTiMsg1F5_Val(&Read_LstRxnTiMsg1F5_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Read_ShiftLvrPosnRaw_Val(&Read_ShiftLvrPosnRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Read_ShiftLvrPosnVldRaw_Val(&Read_ShiftLvrPosnVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Write_InvldMsg1F5_Logl(Rte_InitValue_InvldMsg1F5_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Write_ShiftLvrInRvs_Logl(Rte_InitValue_ShiftLvrInRvs_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F5BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
