...
#include "Rte_GmMsg500BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg500BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg500BusHiSpdInit1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 GmMsg500BusHiSpdPrevWhlRotlStsTiStampResl;
  uint32 GmMsg500BusHiSpdPrevRxnTi;
  uint8 GmMsg500BusHiSpdPrevWhlPlsPerRev;

  float32 GmMsg500BusHiSpdWhlRotlStsTiStampReslDft_Val_data;
  uint16 GmMsg500BusHiSpdMissTiOut_Val_data;
  uint8 GmMsg500BusHiSpdWhlPlsPerRevDft_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  GmMsg500BusHiSpdPrevWhlRotlStsTiStampResl = *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevWhlRotlStsTiStampResl();
  *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevWhlRotlStsTiStampResl() = GmMsg500BusHiSpdPrevWhlRotlStsTiStampResl;
  GmMsg500BusHiSpdPrevRxnTi = *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevRxnTi();
  *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevRxnTi() = GmMsg500BusHiSpdPrevRxnTi;
  GmMsg500BusHiSpdPrevWhlPlsPerRev = *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevWhlPlsPerRev();
  *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevWhlPlsPerRev() = GmMsg500BusHiSpdPrevWhlPlsPerRev;

  GmMsg500BusHiSpdWhlRotlStsTiStampReslDft_Val_data = TSC_GmMsg500BusHiSpd_Rte_Prm_GmMsg500BusHiSpdWhlRotlStsTiStampReslDft_Val();
  GmMsg500BusHiSpdMissTiOut_Val_data = TSC_GmMsg500BusHiSpd_Rte_Prm_GmMsg500BusHiSpdMissTiOut_Val();
  GmMsg500BusHiSpdWhlPlsPerRevDft_Val_data = TSC_GmMsg500BusHiSpd_Rte_Prm_GmMsg500BusHiSpdWhlPlsPerRevDft_Val();

  GmMsg500BusHiSpd_TestDefines();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GmMsg500BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint32 Read_LstRxnTiMsg500BusHiSpd_Val;
  uint8 Read_WhlPlsPerRevRaw_Val;
  uint16 Read_WhlRotlStsTiStampReslRaw_Val;
  ...
  *TSC_GmMsg500BusHiSpd_Rte_Pim_GmMsg500BusHiSpdPrevWhlPlsPerRev() = GmMsg500BusHiSpdPrevWhlPlsPerRev;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Read_LstRxnTiMsg500BusHiSpd_Val(&Read_LstRxnTiMsg500BusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Read_WhlPlsPerRevRaw_Val(&Read_WhlPlsPerRevRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Read_WhlRotlStsTiStampReslRaw_Val(&Read_WhlRotlStsTiStampReslRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Write_WhlPlsPerRev_Val(Rte_InitValue_WhlPlsPerRev_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Write_WhlRotlStsTiStampResl_Val(Rte_InitValue_WhlRotlStsTiStampResl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg500BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
