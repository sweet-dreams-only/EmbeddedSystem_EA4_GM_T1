 ...
 *
 *   Description:  C-Code implementation template for SW-C <GmMsg348BusChassisExp>
 *********************************************************************************************************************/
...
#include "Rte_GmMsg348BusChassisExp.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg348BusChassisExp_TestDefines(void);
 ...
 * Symbol: GmMsg348BusChassisExpPer1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: GmMsg348BusChassisExpPer1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 Read_LstRxnTiMsg348BusChassisExp_Val;
  uint16 Read_WhlGndVelLeDrvnRawBusChassisExp_Val;
  uint8 Read_WhlGndVelLeDrvnVldRawBusChassisExp_Val;
  uint16 Read_WhlGndVelRiDrvnRawBusChassisExp_Val;
  uint8 Read_WhlGndVelRiDrvnVldRawBusChassisExp_Val;

  uint32 GmMsg348BusChassisExpWhlGndVelLeDrvnInvldTi;
  uint32 GmMsg348BusChassisExpWhlGndVelLeDrvnStuckTi;
  uint32 GmMsg348BusChassisExpWhlGndVelRiDrvnInvldTi;
  uint32 GmMsg348BusChassisExpWhlGndVelRiDrvnStuckTi;
  uint16 GmMsg348BusChassisExpPrevWhlGndVelLeDrvn;
  uint16 GmMsg348BusChassisExpPrevWhlGndVelRiDrvn;

  uint16 GmMsg348BusChassisExpInvldTiOut_Val_data;
  uint16 GmMsg348BusChassisExpMissTiOut_Val_data;
  uint16 GmMsg348BusChassisExpStuckTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg348BusChassisExpWhlGndVelLeDrvnInvldTi = *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelLeDrvnInvldTi();
  *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelLeDrvnInvldTi() = GmMsg348BusChassisExpWhlGndVelLeDrvnInvldTi;
  GmMsg348BusChassisExpWhlGndVelLeDrvnStuckTi = *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelLeDrvnStuckTi();
  *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelLeDrvnStuckTi() = GmMsg348BusChassisExpWhlGndVelLeDrvnStuckTi;
  GmMsg348BusChassisExpWhlGndVelRiDrvnInvldTi = *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelRiDrvnInvldTi();
  *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelRiDrvnInvldTi() = GmMsg348BusChassisExpWhlGndVelRiDrvnInvldTi;
  GmMsg348BusChassisExpWhlGndVelRiDrvnStuckTi = *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelRiDrvnStuckTi();
  *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpWhlGndVelRiDrvnStuckTi() = GmMsg348BusChassisExpWhlGndVelRiDrvnStuckTi;
  GmMsg348BusChassisExpPrevWhlGndVelLeDrvn = *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpPrevWhlGndVelLeDrvn();
  *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpPrevWhlGndVelLeDrvn() = GmMsg348BusChassisExpPrevWhlGndVelLeDrvn;
  GmMsg348BusChassisExpPrevWhlGndVelRiDrvn = *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpPrevWhlGndVelRiDrvn();
  *TSC_GmMsg348BusChassisExp_Rte_Pim_GmMsg348BusChassisExpPrevWhlGndVelRiDrvn() = GmMsg348BusChassisExpPrevWhlGndVelRiDrvn;

  GmMsg348BusChassisExpInvldTiOut_Val_data = TSC_GmMsg348BusChassisExp_Rte_Prm_GmMsg348BusChassisExpInvldTiOut_Val();
  GmMsg348BusChassisExpMissTiOut_Val_data = TSC_GmMsg348BusChassisExp_Rte_Prm_GmMsg348BusChassisExpMissTiOut_Val();
  GmMsg348BusChassisExpStuckTiOut_Val_data = TSC_GmMsg348BusChassisExp_Rte_Prm_GmMsg348BusChassisExpStuckTiOut_Val();

  fct_status = TSC_GmMsg348BusChassisExp_Rte_Read_LstRxnTiMsg348BusChassisExp_Val(&Read_LstRxnTiMsg348BusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Read_WhlGndVelLeDrvnRawBusChassisExp_Val(&Read_WhlGndVelLeDrvnRawBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Read_WhlGndVelLeDrvnVldRawBusChassisExp_Val(&Read_WhlGndVelLeDrvnVldRawBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Read_WhlGndVelRiDrvnRawBusChassisExp_Val(&Read_WhlGndVelRiDrvnRawBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Read_WhlGndVelRiDrvnVldRawBusChassisExp_Val(&Read_WhlGndVelRiDrvnVldRawBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Write_WhlGndVelLeDrvnBusChassisExp_Val(Rte_InitValue_WhlGndVelLeDrvnBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Write_WhlGndVelLeDrvnStuckBusChassisExp_Logl(Rte_InitValue_WhlGndVelLeDrvnStuckBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Write_WhlGndVelLeDrvnVldBusChassisExp_Logl(Rte_InitValue_WhlGndVelLeDrvnVldBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Write_WhlGndVelRiDrvnBusChassisExp_Val(Rte_InitValue_WhlGndVelRiDrvnBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Write_WhlGndVelRiDrvnStuckBusChassisExp_Logl(Rte_InitValue_WhlGndVelRiDrvnStuckBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Write_WhlGndVelRiDrvnVldBusChassisExp_Logl(Rte_InitValue_WhlGndVelRiDrvnVldBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusChassisExp_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  GmMsg348BusChassisExp_TestDefines();
