...
#include "Rte_HwAgSnsrls.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void HwAgSnsrls_TestDefines(void);
 ...
 * Symbol: FSnsrlsHwCentr_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 CorrdPinionAgHwAgOffs;
  float32 CorrdPinionAgHwConf;
  float32 FCentrHwAgOffs;
  float32 FCentrHwConf;
  float32 MotAgOffs;
  float32 PrevFildRelHwAg1;
  float32 PrevHwAgOffs;
  float32 PrevMaxHwConf;
  float32 PrevSmotngHwAg;
  float32 VehDynHwAgOffs;
  float32 WhlSpdHwAgOffs;
  float32 WhlSpdHwConf;
  float32 dHwAgSnsrlsStordHwAg;
  float32 dHwAgSnsrlsStordHwConf;
  float32 dHwAgSnsrlsVehDynHwConf;
  float32 dHwAgSnsrlsWhlSpdHwConf;
  uint32 VehDynRefTmr1;
  uint32 VehDynRefTmr2;
  uint32 WhlSpdRefTmr;
  uint8 SelnCaseSt;
  boolean FCentrHwAgEna;
  boolean MotAgOffsEna;
  boolean PrevSmotngSt;
  boolean PrevVehDynFil1Ena;
  boolean PrevVehDynFil2Ena;
  boolean WhlSpdHwAgLrndEna;
  FilLpRec1 PinionTqFil;
  FilLpRec1 RelHwAgFil1;
  FilLpRec1 RelHwAgFil2;
  StordLstPrmRec1 StordLstPrm;
  FilLpRec1 YawRateFil;

  StordLstPrmRec1 StordLstPrmDft_data;

  float32 HwAgSnsrlsCorrdPinionAgHwConf_Val_data;
  float32 HwAgSnsrlsFCentrHwConf_Val_data;
  float32 HwAgSnsrlsPinionTqFilFrq_Val_data;
  float32 HwAgSnsrlsRelHwAgFil1Frq_Val_data;
  float32 HwAgSnsrlsRelHwAgFil2Frq_Val_data;
  float32 HwAgSnsrlsSmotngCoeff_Val_data;
  float32 HwAgSnsrlsSmotngStepThd_Val_data;
  float32 HwAgSnsrlsStordPinionConf_Val_data;
  float32 HwAgSnsrlsStordPinionConfThd_Val_data;
  float32 HwAgSnsrlsVehDynDifThd_Val_data;
  float32 HwAgSnsrlsVehDynHwConf_Val_data;
  float32 HwAgSnsrlsVehDynMotVelThd_Val_data;
  float32 HwAgSnsrlsVehDynPinionTqThd_Val_data;
  float32 HwAgSnsrlsVehDynVehSpdThd_Val_data;
  float32 HwAgSnsrlsVehDynYawRateThd_Val_data;
  float32 HwAgSnsrlsWhlFrqThd_Val_data;
  float32 HwAgSnsrlsWhlSpdHwAgCoeff1_Val_data;
  float32 HwAgSnsrlsWhlSpdHwAgCoeff2_Val_data;
  float32 HwAgSnsrlsWhlSpdHwAgThd_Val_data;
  float32 HwAgSnsrlsWhlSpdHwConf_Val_data;
  float32 HwAgSnsrlsWhlSpdRatThd_Val_data;
  float32 HwAgSnsrlsWhlSpdVehSpdThd_Val_data;
  float32 HwAgSnsrlsYawRateFilFrq_Val_data;
  float32 SysGlbPrmSysKineRat_Val_data;
  float32 SysGlbPrmSysTqRat_Val_data;
  uint32 HwAgSnsrlsVehDynTmr1Thd_Val_data;
  uint32 HwAgSnsrlsVehDynTmr2Thd_Val_data;
  uint32 HwAgSnsrlsWhlSpdTmrThd_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  CorrdPinionAgHwAgOffs = *TSC_HwAgSnsrls_Rte_Pim_CorrdPinionAgHwAgOffs();
  *TSC_HwAgSnsrls_Rte_Pim_CorrdPinionAgHwAgOffs() = CorrdPinionAgHwAgOffs;
  CorrdPinionAgHwConf = *TSC_HwAgSnsrls_Rte_Pim_CorrdPinionAgHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_CorrdPinionAgHwConf() = CorrdPinionAgHwConf;
  FCentrHwAgOffs = *TSC_HwAgSnsrls_Rte_Pim_FCentrHwAgOffs();
  *TSC_HwAgSnsrls_Rte_Pim_FCentrHwAgOffs() = FCentrHwAgOffs;
  FCentrHwConf = *TSC_HwAgSnsrls_Rte_Pim_FCentrHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_FCentrHwConf() = FCentrHwConf;
  MotAgOffs = *TSC_HwAgSnsrls_Rte_Pim_MotAgOffs();
  *TSC_HwAgSnsrls_Rte_Pim_MotAgOffs() = MotAgOffs;
  PrevFildRelHwAg1 = *TSC_HwAgSnsrls_Rte_Pim_PrevFildRelHwAg1();
  *TSC_HwAgSnsrls_Rte_Pim_PrevFildRelHwAg1() = PrevFildRelHwAg1;
  PrevHwAgOffs = *TSC_HwAgSnsrls_Rte_Pim_PrevHwAgOffs();
  *TSC_HwAgSnsrls_Rte_Pim_PrevHwAgOffs() = PrevHwAgOffs;
  PrevMaxHwConf = *TSC_HwAgSnsrls_Rte_Pim_PrevMaxHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_PrevMaxHwConf() = PrevMaxHwConf;
  PrevSmotngHwAg = *TSC_HwAgSnsrls_Rte_Pim_PrevSmotngHwAg();
  *TSC_HwAgSnsrls_Rte_Pim_PrevSmotngHwAg() = PrevSmotngHwAg;
  VehDynHwAgOffs = *TSC_HwAgSnsrls_Rte_Pim_VehDynHwAgOffs();
  *TSC_HwAgSnsrls_Rte_Pim_VehDynHwAgOffs() = VehDynHwAgOffs;
  WhlSpdHwAgOffs = *TSC_HwAgSnsrls_Rte_Pim_WhlSpdHwAgOffs();
  *TSC_HwAgSnsrls_Rte_Pim_WhlSpdHwAgOffs() = WhlSpdHwAgOffs;
  WhlSpdHwConf = *TSC_HwAgSnsrls_Rte_Pim_WhlSpdHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_WhlSpdHwConf() = WhlSpdHwConf;
  dHwAgSnsrlsStordHwAg = *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsStordHwAg();
  *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsStordHwAg() = dHwAgSnsrlsStordHwAg;
  dHwAgSnsrlsStordHwConf = *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsStordHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsStordHwConf() = dHwAgSnsrlsStordHwConf;
  dHwAgSnsrlsVehDynHwConf = *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsVehDynHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsVehDynHwConf() = dHwAgSnsrlsVehDynHwConf;
  dHwAgSnsrlsWhlSpdHwConf = *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsWhlSpdHwConf();
  *TSC_HwAgSnsrls_Rte_Pim_dHwAgSnsrlsWhlSpdHwConf() = dHwAgSnsrlsWhlSpdHwConf;
  VehDynRefTmr1 = *TSC_HwAgSnsrls_Rte_Pim_VehDynRefTmr1();
  *TSC_HwAgSnsrls_Rte_Pim_VehDynRefTmr1() = VehDynRefTmr1;
  VehDynRefTmr2 = *TSC_HwAgSnsrls_Rte_Pim_VehDynRefTmr2();
  *TSC_HwAgSnsrls_Rte_Pim_VehDynRefTmr2() = VehDynRefTmr2;
  WhlSpdRefTmr = *TSC_HwAgSnsrls_Rte_Pim_WhlSpdRefTmr();
  *TSC_HwAgSnsrls_Rte_Pim_WhlSpdRefTmr() = WhlSpdRefTmr;
  SelnCaseSt = *TSC_HwAgSnsrls_Rte_Pim_SelnCaseSt();
  *TSC_HwAgSnsrls_Rte_Pim_SelnCaseSt() = SelnCaseSt;
  FCentrHwAgEna = *TSC_HwAgSnsrls_Rte_Pim_FCentrHwAgEna();
  *TSC_HwAgSnsrls_Rte_Pim_FCentrHwAgEna() = FCentrHwAgEna;
  MotAgOffsEna = *TSC_HwAgSnsrls_Rte_Pim_MotAgOffsEna();
  *TSC_HwAgSnsrls_Rte_Pim_MotAgOffsEna() = MotAgOffsEna;
  PrevSmotngSt = *TSC_HwAgSnsrls_Rte_Pim_PrevSmotngSt();
  *TSC_HwAgSnsrls_Rte_Pim_PrevSmotngSt() = PrevSmotngSt;
  PrevVehDynFil1Ena = *TSC_HwAgSnsrls_Rte_Pim_PrevVehDynFil1Ena();
  *TSC_HwAgSnsrls_Rte_Pim_PrevVehDynFil1Ena() = PrevVehDynFil1Ena;
  PrevVehDynFil2Ena = *TSC_HwAgSnsrls_Rte_Pim_PrevVehDynFil2Ena();
  *TSC_HwAgSnsrls_Rte_Pim_PrevVehDynFil2Ena() = PrevVehDynFil2Ena;
  WhlSpdHwAgLrndEna = *TSC_HwAgSnsrls_Rte_Pim_WhlSpdHwAgLrndEna();
  *TSC_HwAgSnsrls_Rte_Pim_WhlSpdHwAgLrndEna() = WhlSpdHwAgLrndEna;
  PinionTqFil = *TSC_HwAgSnsrls_Rte_Pim_PinionTqFil();
  *TSC_HwAgSnsrls_Rte_Pim_PinionTqFil() = PinionTqFil;
  RelHwAgFil1 = *TSC_HwAgSnsrls_Rte_Pim_RelHwAgFil1();
  *TSC_HwAgSnsrls_Rte_Pim_RelHwAgFil1() = RelHwAgFil1;
  RelHwAgFil2 = *TSC_HwAgSnsrls_Rte_Pim_RelHwAgFil2();
  *TSC_HwAgSnsrls_Rte_Pim_RelHwAgFil2() = RelHwAgFil2;
  StordLstPrm = *TSC_HwAgSnsrls_Rte_Pim_StordLstPrm();
  *TSC_HwAgSnsrls_Rte_Pim_StordLstPrm() = StordLstPrm;
  YawRateFil = *TSC_HwAgSnsrls_Rte_Pim_YawRateFil();
  *TSC_HwAgSnsrls_Rte_Pim_YawRateFil() = YawRateFil;

  StordLstPrmDft_data = *TSC_HwAgSnsrls_Rte_CData_StordLstPrmDft();

  HwAgSnsrlsCorrdPinionAgHwConf_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsCorrdPinionAgHwConf_Val();
  HwAgSnsrlsFCentrHwConf_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsFCentrHwConf_Val();
  HwAgSnsrlsPinionTqFilFrq_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsPinionTqFilFrq_Val();
  HwAgSnsrlsRelHwAgFil1Frq_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsRelHwAgFil1Frq_Val();
  HwAgSnsrlsRelHwAgFil2Frq_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsRelHwAgFil2Frq_Val();
  HwAgSnsrlsSmotngCoeff_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsSmotngCoeff_Val();
  HwAgSnsrlsSmotngStepThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsSmotngStepThd_Val();
  HwAgSnsrlsStordPinionConf_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsStordPinionConf_Val();
  HwAgSnsrlsStordPinionConfThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsStordPinionConfThd_Val();
  HwAgSnsrlsVehDynDifThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynDifThd_Val();
  HwAgSnsrlsVehDynHwConf_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynHwConf_Val();
  HwAgSnsrlsVehDynMotVelThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynMotVelThd_Val();
  HwAgSnsrlsVehDynPinionTqThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynPinionTqThd_Val();
  HwAgSnsrlsVehDynVehSpdThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynVehSpdThd_Val();
  HwAgSnsrlsVehDynYawRateThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynYawRateThd_Val();
  HwAgSnsrlsWhlFrqThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlFrqThd_Val();
  HwAgSnsrlsWhlSpdHwAgCoeff1_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdHwAgCoeff1_Val();
  HwAgSnsrlsWhlSpdHwAgCoeff2_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdHwAgCoeff2_Val();
  HwAgSnsrlsWhlSpdHwAgThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdHwAgThd_Val();
  HwAgSnsrlsWhlSpdHwConf_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdHwConf_Val();
  HwAgSnsrlsWhlSpdRatThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdRatThd_Val();
  HwAgSnsrlsWhlSpdVehSpdThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdVehSpdThd_Val();
  HwAgSnsrlsYawRateFilFrq_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsYawRateFilFrq_Val();
  SysGlbPrmSysKineRat_Val_data = TSC_HwAgSnsrls_Rte_Prm_SysGlbPrmSysKineRat_Val();
  SysGlbPrmSysTqRat_Val_data = TSC_HwAgSnsrls_Rte_Prm_SysGlbPrmSysTqRat_Val();
  HwAgSnsrlsVehDynTmr1Thd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynTmr1Thd_Val();
  HwAgSnsrlsVehDynTmr2Thd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsVehDynTmr2Thd_Val();
  HwAgSnsrlsWhlSpdTmrThd_Val_data = TSC_HwAgSnsrls_Rte_Prm_HwAgSnsrlsWhlSpdTmrThd_Val();

  HwAgSnsrls_TestDefines();
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_NvmStordLstPrm_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwAgSnsrls_Rte_Pim_YawRateFil() = YawRateFil;
  ...
  TSC_HwAgSnsrls_Rte_IrvWrite_HwAgSnsrlsInit1_StordHwAg(0.0F);
  TSC_HwAgSnsrls_Rte_IrvWrite_HwAgSnsrlsInit1_StordHwConf(0.0F);

  fct_status = TSC_HwAgSnsrls_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Call_NvmStordLstPrm_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  s18p13 Read_MotAgCumvAlgndCrf_Val;
  boolean Read_MotAgCumvAlgndVld_Logl;
  ...
  float32 HwAgSnsrlsPer1_StordHwAg;
  float32 HwAgSnsrlsPer1_StordHwConf;
  ...
  *TSC_HwAgSnsrls_Rte_Pim_YawRateFil() = YawRateFil;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_CmplncErrMotToPinion_Val(&Read_CmplncErrMotToPinion_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_HwTq_Val(&Read_HwTq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_MotAgCumvAlgndCrf_Val(&Read_MotAgCumvAlgndCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_MotAgCumvAlgndVld_Logl(&Read_MotAgCumvAlgndVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_MotTqCmdCrf_Val(&Read_MotTqCmdCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_MotVelCrf_Val(&Read_MotVelCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_PinionAg_Val(&Read_PinionAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_PinionAgConf_Val(&Read_PinionAgConf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_VehSpdVld_Logl(&Read_VehSpdVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_VehYawRate_Val(&Read_VehYawRate_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_WhlFrqVld_Logl(&Read_WhlFrqVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_WhlLeFrq_Val(&Read_WhlLeFrq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Read_WhlRiFrq_Val(&Read_WhlRiFrq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Write_HwAgSnsrls_Val(Rte_InitValue_HwAgSnsrls_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Write_HwAgSnsrlsConf_Val(Rte_InitValue_HwAgSnsrlsConf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  HwAgSnsrlsPer1_StordHwAg = TSC_HwAgSnsrls_Rte_IrvRead_HwAgSnsrlsPer1_StordHwAg();
  HwAgSnsrlsPer1_StordHwConf = TSC_HwAgSnsrls_Rte_IrvRead_HwAgSnsrlsPer1_StordHwConf();
  ...
  fct_status = TSC_HwAgSnsrls_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: RstSnsrlsHwCentr_Oper_doc
 *********************************************************************************************************************/
