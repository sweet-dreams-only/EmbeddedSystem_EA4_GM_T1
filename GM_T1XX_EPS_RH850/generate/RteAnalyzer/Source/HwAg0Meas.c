...
#include "Rte_HwAg0Meas.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void HwAg0Meas_TestDefines(void);
 ...
 *     Returnvalue: uint8* is of type Ary1D_u8_22
 *   uint8 *Rte_Prm_HwAg0MeasSnsr1Rev_Ary1D(void)
 *     Returnvalue: uint8* is of type Ary1D_u8_22
 *   sint16 *Rte_Prm_HwAg0MeasStep_Ary1D(void)
 *     Returnvalue: sint16* is of type Ary1D_s16_22
 *
 *********************************************************************************************************************/
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwAg0Offs_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 * Symbol: HwAg0MeasHwAg0AutTrim_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 HwAg0PrevHwAg0;
  float32 PrevHwAg0;
  float32 dHwAg0MeasSnsr0Abs;
  float32 dHwAg0MeasSnsr0Rel;
  float32 dHwAg0MeasSnsr1Abs;
  float32 dHwAg0MeasSnsr1Rel;
  uint32 HwAg0RawDataAvlStrtTi;
  uint32 dHwAg0MeasSnsr0CS;
  uint32 dHwAg0MeasSnsr0FRXD;
  uint32 dHwAg0MeasSnsr1CS;
  uint32 dHwAg0MeasSnsr1FRXD;
  uint16 PrevHwAg0Snsr0Raw;
  uint16 PrevHwAg0Snsr1Raw;
  uint8 HwAg0PrevRollCnt;
  uint8 HwAg0PrevStepSeqNr;
  uint8 HwAg0Snsr0ComStsErrCntr;
  uint8 HwAg0Snsr0IdErrCntr;
  uint8 HwAg0Snsr0IntSnsrErrCntr;
  uint8 HwAg0Snsr0NoMsgErrCntr;
  uint8 HwAg0Snsr1ComStsErrCntr;
  uint8 HwAg0Snsr1IdErrCntr;
  uint8 HwAg0Snsr1IntSnsrErrCntr;
  uint8 HwAg0Snsr1NoMsgErrCntr;
  uint8 HwAg0SnsrTrigNr;
  SigQlfr1 PrevHwAg0Qlfr;
  uint8 PrevHwAg0Snsr0TestOk;
  uint8 PrevHwAg0Snsr1TestOk;
  boolean HwAg0InitStepSeqNrCmpl;
  HwAgOffsRec1 HwAg0Offs;

  HwAgOffsRec1 HwAg0OffsDft_data;

  uint16 HwAg0MeasHwAg0IfFltFailStep_Val_data;
  uint16 HwAg0MeasHwAg0IfFltPassStep_Val_data;
  uint16 HwAg0MeasHwAg0Snsr0PrtclFltFailStep_Val_data;
  uint16 HwAg0MeasHwAg0Snsr0PrtclFltPassStep_Val_data;
  uint16 HwAg0MeasHwAg0Snsr1PrtclFltFailStep_Val_data;
  uint16 HwAg0MeasHwAg0Snsr1PrtclFltPassStep_Val_data;
  uint8 HwAg0MeasVrnrErrThd_Val_data;
  Ary1D_u8_22 HwAg0MeasSnsr0Rev_Ary1D_data;
  Ary1D_u8_22 HwAg0MeasSnsr1Rev_Ary1D_data;
  Ary1D_s16_22 HwAg0MeasStep_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  HwAg0PrevHwAg0 = *TSC_HwAg0Meas_Rte_Pim_HwAg0PrevHwAg0();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0PrevHwAg0() = HwAg0PrevHwAg0;
  PrevHwAg0 = *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0();
  *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0() = PrevHwAg0;
  dHwAg0MeasSnsr0Abs = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0Abs();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0Abs() = dHwAg0MeasSnsr0Abs;
  dHwAg0MeasSnsr0Rel = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0Rel();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0Rel() = dHwAg0MeasSnsr0Rel;
  dHwAg0MeasSnsr1Abs = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1Abs();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1Abs() = dHwAg0MeasSnsr1Abs;
  dHwAg0MeasSnsr1Rel = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1Rel();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1Rel() = dHwAg0MeasSnsr1Rel;
  HwAg0RawDataAvlStrtTi = *TSC_HwAg0Meas_Rte_Pim_HwAg0RawDataAvlStrtTi();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0RawDataAvlStrtTi() = HwAg0RawDataAvlStrtTi;
  dHwAg0MeasSnsr0CS = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0CS();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0CS() = dHwAg0MeasSnsr0CS;
  dHwAg0MeasSnsr0FRXD = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0FRXD();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr0FRXD() = dHwAg0MeasSnsr0FRXD;
  dHwAg0MeasSnsr1CS = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1CS();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1CS() = dHwAg0MeasSnsr1CS;
  dHwAg0MeasSnsr1FRXD = *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1FRXD();
  *TSC_HwAg0Meas_Rte_Pim_dHwAg0MeasSnsr1FRXD() = dHwAg0MeasSnsr1FRXD;
  PrevHwAg0Snsr0Raw = *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr0Raw();
  *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr0Raw() = PrevHwAg0Snsr0Raw;
  PrevHwAg0Snsr1Raw = *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr1Raw();
  *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr1Raw() = PrevHwAg0Snsr1Raw;
  HwAg0PrevRollCnt = *TSC_HwAg0Meas_Rte_Pim_HwAg0PrevRollCnt();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0PrevRollCnt() = HwAg0PrevRollCnt;
  HwAg0PrevStepSeqNr = *TSC_HwAg0Meas_Rte_Pim_HwAg0PrevStepSeqNr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0PrevStepSeqNr() = HwAg0PrevStepSeqNr;
  HwAg0Snsr0ComStsErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0ComStsErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0ComStsErrCntr() = HwAg0Snsr0ComStsErrCntr;
  HwAg0Snsr0IdErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0IdErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0IdErrCntr() = HwAg0Snsr0IdErrCntr;
  HwAg0Snsr0IntSnsrErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0IntSnsrErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0IntSnsrErrCntr() = HwAg0Snsr0IntSnsrErrCntr;
  HwAg0Snsr0NoMsgErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0NoMsgErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr0NoMsgErrCntr() = HwAg0Snsr0NoMsgErrCntr;
  HwAg0Snsr1ComStsErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1ComStsErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1ComStsErrCntr() = HwAg0Snsr1ComStsErrCntr;
  HwAg0Snsr1IdErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1IdErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1IdErrCntr() = HwAg0Snsr1IdErrCntr;
  HwAg0Snsr1IntSnsrErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1IntSnsrErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1IntSnsrErrCntr() = HwAg0Snsr1IntSnsrErrCntr;
  HwAg0Snsr1NoMsgErrCntr = *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1NoMsgErrCntr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Snsr1NoMsgErrCntr() = HwAg0Snsr1NoMsgErrCntr;
  HwAg0SnsrTrigNr = *TSC_HwAg0Meas_Rte_Pim_HwAg0SnsrTrigNr();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0SnsrTrigNr() = HwAg0SnsrTrigNr;
  PrevHwAg0Qlfr = *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Qlfr();
  *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Qlfr() = PrevHwAg0Qlfr;
  PrevHwAg0Snsr0TestOk = *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr0TestOk();
  *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr0TestOk() = PrevHwAg0Snsr0TestOk;
  PrevHwAg0Snsr1TestOk = *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr1TestOk();
  *TSC_HwAg0Meas_Rte_Pim_PrevHwAg0Snsr1TestOk() = PrevHwAg0Snsr1TestOk;
  HwAg0InitStepSeqNrCmpl = *TSC_HwAg0Meas_Rte_Pim_HwAg0InitStepSeqNrCmpl();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0InitStepSeqNrCmpl() = HwAg0InitStepSeqNrCmpl;
  HwAg0Offs = *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs();
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs() = HwAg0Offs;

  HwAg0OffsDft_data = *TSC_HwAg0Meas_Rte_CData_HwAg0OffsDft();

  HwAg0MeasHwAg0IfFltFailStep_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasHwAg0IfFltFailStep_Val();
  HwAg0MeasHwAg0IfFltPassStep_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasHwAg0IfFltPassStep_Val();
  HwAg0MeasHwAg0Snsr0PrtclFltFailStep_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasHwAg0Snsr0PrtclFltFailStep_Val();
  HwAg0MeasHwAg0Snsr0PrtclFltPassStep_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasHwAg0Snsr0PrtclFltPassStep_Val();
  HwAg0MeasHwAg0Snsr1PrtclFltFailStep_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasHwAg0Snsr1PrtclFltFailStep_Val();
  HwAg0MeasHwAg0Snsr1PrtclFltPassStep_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasHwAg0Snsr1PrtclFltPassStep_Val();
  HwAg0MeasVrnrErrThd_Val_data = TSC_HwAg0Meas_Rte_Prm_HwAg0MeasVrnrErrThd_Val();
  (void)memcpy(HwAg0MeasSnsr0Rev_Ary1D_data, TSC_HwAg0Meas_Rte_Prm_HwAg0MeasSnsr0Rev_Ary1D(), sizeof(Ary1D_u8_22));
  (void)memcpy(HwAg0MeasSnsr1Rev_Ary1D_data, TSC_HwAg0Meas_Rte_Prm_HwAg0MeasSnsr1Rev_Ary1D(), sizeof(Ary1D_u8_22));
  (void)memcpy(HwAg0MeasStep_Ary1D_data, TSC_HwAg0Meas_Rte_Prm_HwAg0MeasStep_Ary1D(), sizeof(Ary1D_s16_22));

  fct_status = TSC_HwAg0Meas_Rte_Call_HwAg0Offs_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwAg0MeasHwAg0ClrTrim_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwAg0MeasHwAg0ReadTrim_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwAg0MeasHwAg0TrimPrfmdSts_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwAg0MeasHwAg0WrTrim_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs() = HwAg0Offs;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Call_GetRefTmr1MicroSec32bit_Oper(&Call_GetRefTmr1MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Call_GetTiSpan1MicroSec32bit_Oper(0U, &Call_GetTiSpan1MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Call_IoHwAb_SetFctPrphlHwAg0_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs() = HwAg0Offs;
  ...
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer2_HwAg0Snsr0Raw(0U);
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer2_HwAg0Snsr0TestOk(0U);

  fct_status = TSC_HwAg0Meas_Rte_Call_FltInj_u08_Oper(&Call_FltInj_u08_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_SetNtcSts1_E_NOT_OK:
      fct_error = 1;
      break;
  }
 ...
 *   Explicit Write Access:
 *   ----------------------
 *   void Rte_IrvWrite_HwAg0MeasPer3_HwAg0Snsr0Raw(uint16 data)
 *   void Rte_IrvWrite_HwAg0MeasPer3_HwAg0Snsr0TestOk(uint8 data)
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs() = HwAg0Offs;
  ...
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer3_HwAg0Snsr0Raw(0U);
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer3_HwAg0Snsr0TestOk(0U);
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer3_HwAg0Snsr1Raw(0U);
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer3_HwAg0Snsr1TestOk(0U);
 ...
 *   Explicit Write Access:
 *   ----------------------
 *   void Rte_IrvWrite_HwAg0MeasPer4_HwAg0Snsr1Raw(uint16 data)
 *   void Rte_IrvWrite_HwAg0MeasPer4_HwAg0Snsr1TestOk(uint8 data)
 *
 * Client/Server Interfaces:
 * =========================
 *   Server Invocation:
 ...
 *********************************************************************************************************************/
  ...
  uint16 HwAg0MeasPer4_HwAg0Snsr0Raw;
  uint8 HwAg0MeasPer4_HwAg0Snsr0TestOk;
  uint16 HwAg0MeasPer4_HwAg0Snsr1Raw;
  uint8 HwAg0MeasPer4_HwAg0Snsr1TestOk;

  float32 Call_FltInj_f32_Oper_SigPah_Arg = 0.0F;
  SigQlfr1 Call_GetNtcQlfrSts_Oper_NtcQlfr = 0U;
  uint32 Call_GetRefTmr1MicroSec32bit_Oper_RefTmr = 0U;
  uint32 Call_GetTiSpan1MicroSec32bit_Oper_TiSpan = 0U;
  ...
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs() = HwAg0Offs;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Read_HwAg0Polarity_Val(&Read_HwAg0Polarity_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Write_HwAg0_Val(Rte_InitValue_HwAg0_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Write_HwAg0Qlfr_Val(Rte_InitValue_HwAg0Qlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Write_HwAg0RollgCntr_Val(Rte_InitValue_HwAg0RollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  HwAg0MeasPer4_HwAg0Snsr0Raw = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer4_HwAg0Snsr0Raw();
  HwAg0MeasPer4_HwAg0Snsr0TestOk = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer4_HwAg0Snsr0TestOk();
  HwAg0MeasPer4_HwAg0Snsr1Raw = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer4_HwAg0Snsr1Raw();
  HwAg0MeasPer4_HwAg0Snsr1TestOk = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer4_HwAg0Snsr1TestOk();

  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer4_HwAg0Snsr1Raw(0U);
  TSC_HwAg0Meas_Rte_IrvWrite_HwAg0MeasPer4_HwAg0Snsr1TestOk(0U);

  fct_status = TSC_HwAg0Meas_Rte_Call_FltInj_f32_Oper(&Call_FltInj_f32_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwAg0Meas_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_GetNtcQlfrSts1_E_NOT_OK:
      fct_error = 1;
      break;
  }
 ...
 *   Explicit Read Access:
 *   ---------------------
 *   uint16 Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr0Raw(void)
 *   uint8 Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr0TestOk(void)
 *   uint16 Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr1Raw(void)
 *   uint8 Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr1TestOk(void)
 *
 * Client/Server Interfaces:
 * =========================
 *   Server Invocation:
 ...
 *********************************************************************************************************************/
  ...
  uint16 HwAg0MeasPer5_HwAg0Snsr0Raw;
  uint8 HwAg0MeasPer5_HwAg0Snsr0TestOk;
  uint16 HwAg0MeasPer5_HwAg0Snsr1Raw;
  uint8 HwAg0MeasPer5_HwAg0Snsr1TestOk;
  ...
  *TSC_HwAg0Meas_Rte_Pim_HwAg0Offs() = HwAg0Offs;
  ...
  HwAg0MeasPer5_HwAg0Snsr0Raw = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr0Raw();
  HwAg0MeasPer5_HwAg0Snsr0TestOk = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr0TestOk();
  HwAg0MeasPer5_HwAg0Snsr1Raw = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr1Raw();
  HwAg0MeasPer5_HwAg0Snsr1TestOk = TSC_HwAg0Meas_Rte_IrvRead_HwAg0MeasPer5_HwAg0Snsr1TestOk();
...
static void HwAg0Meas_TestDefines(void)
{
  ...
  float32 Test_float32_LL_2 = Cnt32_LowerLimit;
  float32 Test_float32_UL_2 = Cnt32_UpperLimit;
  float32 Test_float32_LL_3 = Cnt34_LowerLimit;
  float32 Test_float32_UL_3 = Cnt34_UpperLimit;
  float32 Test_float32_LL_4 = Uls5_LowerLimit;
  float32 Test_float32_UL_4 = Uls5_UpperLimit;

  sint16 Test_sint16_LL_1 = Cnt35_LowerLimit;
  sint16 Test_sint16_UL_1 = Cnt35_UpperLimit;
  ...
  uint16 Test_uint16_LL_2 = Cnt31_LowerLimit;
  uint16 Test_uint16_UL_2 = Cnt31_UpperLimit;

  uint8 Test_uint8_LL_1 = Cnt13_LowerLimit;
  uint8 Test_uint8_UL_1 = Cnt13_UpperLimit;
  uint8 Test_uint8_LL_2 = Cnt19_LowerLimit;
  uint8 Test_uint8_UL_2 = Cnt19_UpperLimit;
  uint8 Test_uint8_LL_3 = Cnt30_LowerLimit;
  uint8 Test_uint8_UL_3 = Cnt30_UpperLimit;
  uint8 Test_uint8_LL_4 = Cnt33_LowerLimit;
  uint8 Test_uint8_UL_4 = Cnt33_UpperLimit;
  uint8 Test_uint8_LL_5 = Uls24_LowerLimit;
  uint8 Test_uint8_UL_5 = Uls24_UpperLimit;
