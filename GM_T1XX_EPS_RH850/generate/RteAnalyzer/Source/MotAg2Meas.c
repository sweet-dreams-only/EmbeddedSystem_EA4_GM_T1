...
#include "Rte_MotAg2Meas.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void MotAg2Meas_TestDefines(void);
 ...
 * Symbol: MotAg2MeasEolPrmRead_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 MotAg2MeclPrev;
  uint8 MotAg2MeclRollgCntrPrev;
  MotAgMeasEolPrmRec1 MotAg2EolPrm;

  MotAgMeasEolPrmRec1 MotAg2EolPrmDft_data;

  float32 MotAg2MeasOffs_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  MotAg2MeclPrev = *TSC_MotAg2Meas_Rte_Pim_MotAg2MeclPrev();
  *TSC_MotAg2Meas_Rte_Pim_MotAg2MeclPrev() = MotAg2MeclPrev;
  MotAg2MeclRollgCntrPrev = *TSC_MotAg2Meas_Rte_Pim_MotAg2MeclRollgCntrPrev();
  *TSC_MotAg2Meas_Rte_Pim_MotAg2MeclRollgCntrPrev() = MotAg2MeclRollgCntrPrev;
  MotAg2EolPrm = *TSC_MotAg2Meas_Rte_Pim_MotAg2EolPrm();
  *TSC_MotAg2Meas_Rte_Pim_MotAg2EolPrm() = MotAg2EolPrm;

  MotAg2EolPrmDft_data = *TSC_MotAg2Meas_Rte_CData_MotAg2EolPrmDft();

  MotAg2MeasOffs_Val_data = TSC_MotAg2Meas_Rte_Prm_MotAg2MeasOffs_Val();

  MotAg2Meas_TestDefines();
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_MotAg2EolPrm_SetRamBlockStatus(boolean RamBlockStatus_Arg)
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: MotAg2MeasEolPrmWr_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *TSC_MotAg2Meas_Rte_Pim_MotAg2EolPrm() = MotAg2EolPrm;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Call_MotAg2EolPrm_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_MotAg2EolPrm_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_E_NOT_OK
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  NvM_RequestResultType Call_MotAg2EolPrm_GetErrorStatus_ErrorStatus_Arg = 0U;
  ...
  *TSC_MotAg2Meas_Rte_Pim_MotAg2EolPrm() = MotAg2EolPrm;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Call_MotAg2EolPrm_GetErrorStatus(&Call_MotAg2EolPrm_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_MotAg2Cos_Val;
  boolean Read_MotAg2CosAdcFaild_Logl;
  float32 Read_MotAg2Sin_Val;
  boolean Read_MotAg2SinAdcFaild_Logl;
  sint8 Read_MotAgMecl2Polarity_Val;
  ...
  *TSC_MotAg2Meas_Rte_Pim_MotAg2EolPrm() = MotAg2EolPrm;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Read_MotAg2Cos_Val(&Read_MotAg2Cos_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Read_MotAg2CosAdcFaild_Logl(&Read_MotAg2CosAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Read_MotAg2Sin_Val(&Read_MotAg2Sin_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Read_MotAg2SinAdcFaild_Logl(&Read_MotAg2SinAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Read_MotAgMecl2Polarity_Val(&Read_MotAgMecl2Polarity_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Write_MotAg2Mecl_Val(Rte_InitValue_MotAg2Mecl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Write_MotAg2MeclQlfr_Val(Rte_InitValue_MotAg2MeclQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Write_MotAg2MeclRollgCntr_Val(Rte_InitValue_MotAg2MeclRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Write_MotAg2VltgSqd_Val(Rte_InitValue_MotAg2VltgSqd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Call_FltInj_f32_Oper(&Call_FltInj_f32_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAg2Meas_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
