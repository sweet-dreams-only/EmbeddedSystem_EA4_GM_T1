 ...
 *
 *   Description:  C-Code implementation template for SW-C <GmMsg17DBusHiSpd>
 *********************************************************************************************************************/
...
#include "Rte_GmMsg17DBusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg17DBusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg17DBusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: GmMsg17DBusHiSpdPer1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 Read_LstRxnTiMsg17D_Val;
  uint8 Read_VehStabyEnhmtStsRaw_Val;

  uint32 GmMsg17DBusHiSpdInvldMsgTmr;

  uint16 GmMsg17DBusHiSpdInvldTiOut_Val_data;
  uint16 GmMsg17DBusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg17DBusHiSpdInvldMsgTmr = *TSC_GmMsg17DBusHiSpd_Rte_Pim_GmMsg17DBusHiSpdInvldMsgTmr();
  *TSC_GmMsg17DBusHiSpd_Rte_Pim_GmMsg17DBusHiSpdInvldMsgTmr() = GmMsg17DBusHiSpdInvldMsgTmr;

  GmMsg17DBusHiSpdInvldTiOut_Val_data = TSC_GmMsg17DBusHiSpd_Rte_Prm_GmMsg17DBusHiSpdInvldTiOut_Val();
  GmMsg17DBusHiSpdMissTiOut_Val_data = TSC_GmMsg17DBusHiSpd_Rte_Prm_GmMsg17DBusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Read_LstRxnTiMsg17D_Val(&Read_LstRxnTiMsg17D_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Read_VehStabyEnhmtStsRaw_Val(&Read_VehStabyEnhmtStsRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Write_InvldMsg17D_Logl(Rte_InitValue_InvldMsg17D_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Write_MissMsg17D_Logl(Rte_InitValue_MissMsg17D_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg17DBusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
