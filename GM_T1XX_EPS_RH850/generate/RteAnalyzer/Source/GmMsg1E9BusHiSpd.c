...
#include "Rte_GmMsg1E9BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg1E9BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg1E9BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_AbsActvRaw_Val;
  uint8 Read_AbsFaildRaw_Val;
  uint32 Read_LstRxnTiMsg1E9_Val;
  boolean Read_RdntVehStabyEnhmtActv_Logl;
  uint8 Read_TracCtrlSysActvRaw_Val;
  uint8 Read_TracCtrlSysEnaRaw_Val;
  uint8 Read_VehDynCtrlSysStRaw_Val;
  uint16 Read_VehDynYawRateRaw_Val;
  uint8 Read_VehDynYawRateVldRaw_Val;
  uint8 Read_VehStabyEnhmtActvRaw_Val;
  uint16 Read_VehStabyEnhmtLatARaw_Val;
  uint8 Read_VehStabyEnhmtLatAVldRaw_Val;

  uint32 GmMsg1E9BusHiSpdAbsFaildTmr;
  uint32 GmMsg1E9BusHiSpdLatAInvldTmr;
  uint32 GmMsg1E9BusHiSpdRdntVehStabyEnhmtTmr;
  uint32 GmMsg1E9BusHiSpdTcsEnaTmr;
  uint32 GmMsg1E9BusHiSpdVehDynCtrlSysStTmr;
  uint32 GmMsg1E9BusHiSpdYawRateInvldTmr;

  float32 GmMsg1E9BusHiSpdLatADft_Val_data;
  float32 GmMsg1E9BusHiSpdYawRateDft_Val_data;
  uint16 GmMsg1E9BusHiSpdAbsFaildTiOut_Val_data;
  uint16 GmMsg1E9BusHiSpdLatAInvldTiOut_Val_data;
  uint16 GmMsg1E9BusHiSpdMissTiOut_Val_data;
  uint16 GmMsg1E9BusHiSpdTcsDisadTiOut_Val_data;
  uint16 GmMsg1E9BusHiSpdVehDynCtrlStTiOut_Val_data;
  uint16 GmMsg1E9BusHiSpdVehStabyEnhmtActvVldTiOut_Val_data;
  uint16 GmMsg1E9BusHiSpdYawRateInvldTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg1E9BusHiSpdAbsFaildTmr = *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdAbsFaildTmr();
  *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdAbsFaildTmr() = GmMsg1E9BusHiSpdAbsFaildTmr;
  GmMsg1E9BusHiSpdLatAInvldTmr = *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdLatAInvldTmr();
  *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdLatAInvldTmr() = GmMsg1E9BusHiSpdLatAInvldTmr;
  GmMsg1E9BusHiSpdRdntVehStabyEnhmtTmr = *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdRdntVehStabyEnhmtTmr();
  *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdRdntVehStabyEnhmtTmr() = GmMsg1E9BusHiSpdRdntVehStabyEnhmtTmr;
  GmMsg1E9BusHiSpdTcsEnaTmr = *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdTcsEnaTmr();
  *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdTcsEnaTmr() = GmMsg1E9BusHiSpdTcsEnaTmr;
  GmMsg1E9BusHiSpdVehDynCtrlSysStTmr = *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdVehDynCtrlSysStTmr();
  *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdVehDynCtrlSysStTmr() = GmMsg1E9BusHiSpdVehDynCtrlSysStTmr;
  GmMsg1E9BusHiSpdYawRateInvldTmr = *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdYawRateInvldTmr();
  *TSC_GmMsg1E9BusHiSpd_Rte_Pim_GmMsg1E9BusHiSpdYawRateInvldTmr() = GmMsg1E9BusHiSpdYawRateInvldTmr;

  GmMsg1E9BusHiSpdLatADft_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdLatADft_Val();
  GmMsg1E9BusHiSpdYawRateDft_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdYawRateDft_Val();
  GmMsg1E9BusHiSpdAbsFaildTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdAbsFaildTiOut_Val();
  GmMsg1E9BusHiSpdLatAInvldTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdLatAInvldTiOut_Val();
  GmMsg1E9BusHiSpdMissTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdMissTiOut_Val();
  GmMsg1E9BusHiSpdTcsDisadTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdTcsDisadTiOut_Val();
  GmMsg1E9BusHiSpdVehDynCtrlStTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdVehDynCtrlStTiOut_Val();
  GmMsg1E9BusHiSpdVehStabyEnhmtActvVldTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdVehStabyEnhmtActvVldTiOut_Val();
  GmMsg1E9BusHiSpdYawRateInvldTiOut_Val_data = TSC_GmMsg1E9BusHiSpd_Rte_Prm_GmMsg1E9BusHiSpdYawRateInvldTiOut_Val();

  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_AbsActvRaw_Val(&Read_AbsActvRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_AbsFaildRaw_Val(&Read_AbsFaildRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_LstRxnTiMsg1E9_Val(&Read_LstRxnTiMsg1E9_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_RdntVehStabyEnhmtActv_Logl(&Read_RdntVehStabyEnhmtActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_TracCtrlSysActvRaw_Val(&Read_TracCtrlSysActvRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_TracCtrlSysEnaRaw_Val(&Read_TracCtrlSysEnaRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_VehDynCtrlSysStRaw_Val(&Read_VehDynCtrlSysStRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_VehDynYawRateRaw_Val(&Read_VehDynYawRateRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_VehDynYawRateVldRaw_Val(&Read_VehDynYawRateVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_VehStabyEnhmtActvRaw_Val(&Read_VehStabyEnhmtActvRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_VehStabyEnhmtLatARaw_Val(&Read_VehStabyEnhmtLatARaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Read_VehStabyEnhmtLatAVldRaw_Val(&Read_VehStabyEnhmtLatAVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_InvldMsg1E9_Logl(Rte_InitValue_InvldMsg1E9_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_MissMsg1E9_Logl(Rte_InitValue_MissMsg1E9_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_SerlComAbsActv_Logl(Rte_InitValue_SerlComAbsActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_SerlComLatA_Val(Rte_InitValue_SerlComLatA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_SerlComTcsActv_Logl(Rte_InitValue_SerlComTcsActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_SerlComYawRate_Val(Rte_InitValue_SerlComYawRate_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_SerlComYawRateVld_Logl(Rte_InitValue_SerlComYawRateVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_VehLatAVldSerlCom_Logl(Rte_InitValue_VehLatAVldSerlCom_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Write_VehStabyEnhmtActv_Logl(Rte_InitValue_VehStabyEnhmtActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1E9BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
