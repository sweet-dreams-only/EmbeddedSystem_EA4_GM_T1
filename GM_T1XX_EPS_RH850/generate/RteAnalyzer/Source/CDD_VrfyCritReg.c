 ...
 *********************************************************************************************************************/
  ...
  uint32 dVrfyCritRegCritRegActVal;
  uint32 dVrfyCritRegCritRegAdr;
  uint32 dVrfyCritRegCritRegDesVal;
  uint32 dVrfyCritRegSysCritRegActVal;
  uint32 dVrfyCritRegSysCritRegAdr;
  uint32 dVrfyCritRegSysCritRegDesVal;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  dVrfyCritRegCritRegActVal = *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegCritRegActVal();
  *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegCritRegActVal() = dVrfyCritRegCritRegActVal;
  dVrfyCritRegCritRegAdr = *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegCritRegAdr();
  *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegCritRegAdr() = dVrfyCritRegCritRegAdr;
  dVrfyCritRegCritRegDesVal = *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegCritRegDesVal();
  *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegCritRegDesVal() = dVrfyCritRegCritRegDesVal;
  dVrfyCritRegSysCritRegActVal = *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegSysCritRegActVal();
  *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegSysCritRegActVal() = dVrfyCritRegSysCritRegActVal;
  dVrfyCritRegSysCritRegAdr = *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegSysCritRegAdr();
  *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegSysCritRegAdr() = dVrfyCritRegSysCritRegAdr;
  dVrfyCritRegSysCritRegDesVal = *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegSysCritRegDesVal();
  *TSC_CDD_VrfyCritReg_Rte_Pim_dVrfyCritRegSysCritRegDesVal() = dVrfyCritRegSysCritRegDesVal;
