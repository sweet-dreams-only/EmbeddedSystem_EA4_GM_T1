...
#include "Rte_GmVehSpdArbn.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmVehSpdArbn_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 DiagcRefTi;
  boolean dGmVehSpdArbnLeDrvnVld;
  boolean dGmVehSpdArbnLeNonDrvnVld;
  boolean dGmVehSpdArbnRiDrvnVld;
  boolean dGmVehSpdArbnRiNonDrvnVld;
  ...
  *************************************************/
  ...
  DiagcRefTi = *TSC_GmVehSpdArbn_Rte_Pim_DiagcRefTi();
  *TSC_GmVehSpdArbn_Rte_Pim_DiagcRefTi() = DiagcRefTi;
  dGmVehSpdArbnLeDrvnVld = *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnLeDrvnVld();
  *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnLeDrvnVld() = dGmVehSpdArbnLeDrvnVld;
  dGmVehSpdArbnLeNonDrvnVld = *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnLeNonDrvnVld();
  *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnLeNonDrvnVld() = dGmVehSpdArbnLeNonDrvnVld;
  dGmVehSpdArbnRiDrvnVld = *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnRiDrvnVld();
  *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnRiDrvnVld() = dGmVehSpdArbnRiDrvnVld;
  dGmVehSpdArbnRiNonDrvnVld = *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnRiNonDrvnVld();
  *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnRiNonDrvnVld() = dGmVehSpdArbnRiNonDrvnVld;

  fct_status = TSC_GmVehSpdArbn_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean Read_VehPwrModDftVehSpdEna_Logl;
  float32 Read_WhlGndVelLeDrvnBusChassisExp_Val;
  float32 Read_WhlGndVelLeDrvnBusHiSpd_Val;
  boolean Read_WhlGndVelLeDrvnStuckBusChassisExp_Logl;
  boolean Read_WhlGndVelLeDrvnStuckBusHiSpd_Logl;
  boolean Read_WhlGndVelLeDrvnVldBusChassisExp_Logl;
  boolean Read_WhlGndVelLeDrvnVldBusHiSpd_Logl;
  float32 Read_WhlGndVelLeNonDrvnBusChassisExp_Val;
  float32 Read_WhlGndVelLeNonDrvnBusHiSpd_Val;
  boolean Read_WhlGndVelLeNonDrvnStuckBusChassisExp_Logl;
  boolean Read_WhlGndVelLeNonDrvnStuckBusHiSpd_Logl;
  boolean Read_WhlGndVelLeNonDrvnVldBusChassisExp_Logl;
  boolean Read_WhlGndVelLeNonDrvnVldBusHiSpd_Logl;
  float32 Read_WhlGndVelRiDrvnBusChassisExp_Val;
  float32 Read_WhlGndVelRiDrvnBusHiSpd_Val;
  boolean Read_WhlGndVelRiDrvnStuckBusChassisExp_Logl;
  boolean Read_WhlGndVelRiDrvnStuckBusHiSpd_Logl;
  boolean Read_WhlGndVelRiDrvnVldBusChassisExp_Logl;
  boolean Read_WhlGndVelRiDrvnVldBusHiSpd_Logl;
  float32 Read_WhlGndVelRiNonDrvnBusChassisExp_Val;
  float32 Read_WhlGndVelRiNonDrvnBusHiSpd_Val;
  boolean Read_WhlGndVelRiNonDrvnStuckBusChassisExp_Logl;
  boolean Read_WhlGndVelRiNonDrvnStuckBusHiSpd_Logl;
  boolean Read_WhlGndVelRiNonDrvnVldBusChassisExp_Logl;
  boolean Read_WhlGndVelRiNonDrvnVldBusHiSpd_Logl;
  ...
  *TSC_GmVehSpdArbn_Rte_Pim_dGmVehSpdArbnRiNonDrvnVld() = dGmVehSpdArbnRiNonDrvnVld;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_VehPwrModDftVehSpdEna_Logl(&Read_VehPwrModDftVehSpdEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeDrvnBusChassisExp_Val(&Read_WhlGndVelLeDrvnBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeDrvnBusHiSpd_Val(&Read_WhlGndVelLeDrvnBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeDrvnStuckBusChassisExp_Logl(&Read_WhlGndVelLeDrvnStuckBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeDrvnStuckBusHiSpd_Logl(&Read_WhlGndVelLeDrvnStuckBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeDrvnVldBusChassisExp_Logl(&Read_WhlGndVelLeDrvnVldBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeDrvnVldBusHiSpd_Logl(&Read_WhlGndVelLeDrvnVldBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeNonDrvnBusChassisExp_Val(&Read_WhlGndVelLeNonDrvnBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeNonDrvnBusHiSpd_Val(&Read_WhlGndVelLeNonDrvnBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeNonDrvnStuckBusChassisExp_Logl(&Read_WhlGndVelLeNonDrvnStuckBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeNonDrvnStuckBusHiSpd_Logl(&Read_WhlGndVelLeNonDrvnStuckBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeNonDrvnVldBusChassisExp_Logl(&Read_WhlGndVelLeNonDrvnVldBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelLeNonDrvnVldBusHiSpd_Logl(&Read_WhlGndVelLeNonDrvnVldBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiDrvnBusChassisExp_Val(&Read_WhlGndVelRiDrvnBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiDrvnBusHiSpd_Val(&Read_WhlGndVelRiDrvnBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiDrvnStuckBusChassisExp_Logl(&Read_WhlGndVelRiDrvnStuckBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiDrvnStuckBusHiSpd_Logl(&Read_WhlGndVelRiDrvnStuckBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiDrvnVldBusChassisExp_Logl(&Read_WhlGndVelRiDrvnVldBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiDrvnVldBusHiSpd_Logl(&Read_WhlGndVelRiDrvnVldBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiNonDrvnBusChassisExp_Val(&Read_WhlGndVelRiNonDrvnBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiNonDrvnBusHiSpd_Val(&Read_WhlGndVelRiNonDrvnBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiNonDrvnStuckBusChassisExp_Logl(&Read_WhlGndVelRiNonDrvnStuckBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiNonDrvnStuckBusHiSpd_Logl(&Read_WhlGndVelRiNonDrvnStuckBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiNonDrvnVldBusChassisExp_Logl(&Read_WhlGndVelRiNonDrvnVldBusChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Read_WhlGndVelRiNonDrvnVldBusHiSpd_Logl(&Read_WhlGndVelRiNonDrvnVldBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdArbd_Val(Rte_InitValue_VehSpdArbd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdArbdVld_Logl(Rte_InitValue_VehSpdArbdVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdMaxSecur_Val(Rte_InitValue_VehSpdMaxSecur_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdMaxSecurVld_Logl(Rte_InitValue_VehSpdMaxSecurVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdMinSecur_Val(Rte_InitValue_VehSpdMinSecur_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdMinSecurVld_Logl(Rte_InitValue_VehSpdMinSecurVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Write_VehSpdSnsrVld_Logl(Rte_InitValue_VehSpdSnsrVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmVehSpdArbn_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
