 ...
 *********************************************************************************************************************/
  ...
  float32 EstimdFric;
  float32 FricOffs;
  float32 PrevFricOffs;
  float32 PrevMaxRawAvrgFric;
  float32 SatnEstimdFric;
  uint32 RefTmrLrngConstr;
  uint32 RefTmrNtc;
  SysFricLrngOperMod1 FricLrngOperModPrev;
  boolean FricLrngRunOneTi;
  boolean FricOffsOutpDi;
  Ary1D_f32_12 ColTqAry;
  Ary1D_f32_4 FilAvrgFric;
  Ary1D_f32_12 HwAgBuf;
  Ary1D_f32_12 HwVelBuf;
  Ary1D_f32_4 RawAvrgFric;
  Ary1D_f32_4 SatnAvrgFric;
  Ary1D_f32_4 VehBasLineFric;
  FilLpRec1 AssiMechTLpFil;
  FilLpRec1 AvrgFricLpFil1;
  FilLpRec1 AvrgFricLpFil2;
  FilLpRec1 AvrgFricLpFil3;
  FilLpRec1 AvrgFricLpFil4;
  FilLpRec1 ColTqLpFil;
  FilLpRec1 FricChgLpFil;
  SysFricDataRec1 FricLrngData;
  SysFricNonLrngDataRec1 FricNonLrngData;
  FilLpRec1 HwAgAuthyLpFil;
  FilLpRec1 HwAgLpFil;
  FilLpRec1 HwVelLpFil;
  FilLpRec1 LatALpFil;
  FilLpRec1 VehSpdLpFil;
  ...
  float32 SysFricLrngFricDiagcTiThd_Val_data;
  ...
  *************************************************/
  ...
  EstimdFric = *TSC_SysFricLrng_Rte_Pim_EstimdFric();
  *TSC_SysFricLrng_Rte_Pim_EstimdFric() = EstimdFric;
  FricOffs = *TSC_SysFricLrng_Rte_Pim_FricOffs();
  *TSC_SysFricLrng_Rte_Pim_FricOffs() = FricOffs;
  PrevFricOffs = *TSC_SysFricLrng_Rte_Pim_PrevFricOffs();
  *TSC_SysFricLrng_Rte_Pim_PrevFricOffs() = PrevFricOffs;
  PrevMaxRawAvrgFric = *TSC_SysFricLrng_Rte_Pim_PrevMaxRawAvrgFric();
  *TSC_SysFricLrng_Rte_Pim_PrevMaxRawAvrgFric() = PrevMaxRawAvrgFric;
  SatnEstimdFric = *TSC_SysFricLrng_Rte_Pim_SatnEstimdFric();
  *TSC_SysFricLrng_Rte_Pim_SatnEstimdFric() = SatnEstimdFric;
  RefTmrLrngConstr = *TSC_SysFricLrng_Rte_Pim_RefTmrLrngConstr();
  *TSC_SysFricLrng_Rte_Pim_RefTmrLrngConstr() = RefTmrLrngConstr;
  RefTmrNtc = *TSC_SysFricLrng_Rte_Pim_RefTmrNtc();
  *TSC_SysFricLrng_Rte_Pim_RefTmrNtc() = RefTmrNtc;
  FricLrngOperModPrev = *TSC_SysFricLrng_Rte_Pim_FricLrngOperModPrev();
  *TSC_SysFricLrng_Rte_Pim_FricLrngOperModPrev() = FricLrngOperModPrev;
  FricLrngRunOneTi = *TSC_SysFricLrng_Rte_Pim_FricLrngRunOneTi();
  *TSC_SysFricLrng_Rte_Pim_FricLrngRunOneTi() = FricLrngRunOneTi;
  FricOffsOutpDi = *TSC_SysFricLrng_Rte_Pim_FricOffsOutpDi();
  *TSC_SysFricLrng_Rte_Pim_FricOffsOutpDi() = FricOffsOutpDi;

  (void)memcpy(ColTqAry, TSC_SysFricLrng_Rte_Pim_ColTqAry(), sizeof(Ary1D_f32_12));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_ColTqAry(), ColTqAry, sizeof(Ary1D_f32_12));


  (void)memcpy(FilAvrgFric, TSC_SysFricLrng_Rte_Pim_FilAvrgFric(), sizeof(Ary1D_f32_4));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_FilAvrgFric(), FilAvrgFric, sizeof(Ary1D_f32_4));


  (void)memcpy(HwAgBuf, TSC_SysFricLrng_Rte_Pim_HwAgBuf(), sizeof(Ary1D_f32_12));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_HwAgBuf(), HwAgBuf, sizeof(Ary1D_f32_12));


  (void)memcpy(HwVelBuf, TSC_SysFricLrng_Rte_Pim_HwVelBuf(), sizeof(Ary1D_f32_12));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_HwVelBuf(), HwVelBuf, sizeof(Ary1D_f32_12));


  (void)memcpy(RawAvrgFric, TSC_SysFricLrng_Rte_Pim_RawAvrgFric(), sizeof(Ary1D_f32_4));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_RawAvrgFric(), RawAvrgFric, sizeof(Ary1D_f32_4));


  (void)memcpy(SatnAvrgFric, TSC_SysFricLrng_Rte_Pim_SatnAvrgFric(), sizeof(Ary1D_f32_4));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_SatnAvrgFric(), SatnAvrgFric, sizeof(Ary1D_f32_4));


  (void)memcpy(VehBasLineFric, TSC_SysFricLrng_Rte_Pim_VehBasLineFric(), sizeof(Ary1D_f32_4));
  (void)memcpy(TSC_SysFricLrng_Rte_Pim_VehBasLineFric(), VehBasLineFric, sizeof(Ary1D_f32_4));

  AssiMechTLpFil = *TSC_SysFricLrng_Rte_Pim_AssiMechTLpFil();
  *TSC_SysFricLrng_Rte_Pim_AssiMechTLpFil() = AssiMechTLpFil;
  AvrgFricLpFil1 = *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil1();
  *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil1() = AvrgFricLpFil1;
  AvrgFricLpFil2 = *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil2();
  *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil2() = AvrgFricLpFil2;
  AvrgFricLpFil3 = *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil3();
  *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil3() = AvrgFricLpFil3;
  AvrgFricLpFil4 = *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil4();
  *TSC_SysFricLrng_Rte_Pim_AvrgFricLpFil4() = AvrgFricLpFil4;
  ColTqLpFil = *TSC_SysFricLrng_Rte_Pim_ColTqLpFil();
  *TSC_SysFricLrng_Rte_Pim_ColTqLpFil() = ColTqLpFil;
  FricChgLpFil = *TSC_SysFricLrng_Rte_Pim_FricChgLpFil();
  *TSC_SysFricLrng_Rte_Pim_FricChgLpFil() = FricChgLpFil;
  FricLrngData = *TSC_SysFricLrng_Rte_Pim_FricLrngData();
  *TSC_SysFricLrng_Rte_Pim_FricLrngData() = FricLrngData;
  FricNonLrngData = *TSC_SysFricLrng_Rte_Pim_FricNonLrngData();
  *TSC_SysFricLrng_Rte_Pim_FricNonLrngData() = FricNonLrngData;
  HwAgAuthyLpFil = *TSC_SysFricLrng_Rte_Pim_HwAgAuthyLpFil();
  *TSC_SysFricLrng_Rte_Pim_HwAgAuthyLpFil() = HwAgAuthyLpFil;
  HwAgLpFil = *TSC_SysFricLrng_Rte_Pim_HwAgLpFil();
  *TSC_SysFricLrng_Rte_Pim_HwAgLpFil() = HwAgLpFil;
  HwVelLpFil = *TSC_SysFricLrng_Rte_Pim_HwVelLpFil();
  *TSC_SysFricLrng_Rte_Pim_HwVelLpFil() = HwVelLpFil;
  LatALpFil = *TSC_SysFricLrng_Rte_Pim_LatALpFil();
  *TSC_SysFricLrng_Rte_Pim_LatALpFil() = LatALpFil;
  VehSpdLpFil = *TSC_SysFricLrng_Rte_Pim_VehSpdLpFil();
  *TSC_SysFricLrng_Rte_Pim_VehSpdLpFil() = VehSpdLpFil;
  ...
  SysFricLrngFricDiagcTiThd_Val_data = TSC_SysFricLrng_Rte_Prm_SysFricLrngFricDiagcTiThd_Val();
