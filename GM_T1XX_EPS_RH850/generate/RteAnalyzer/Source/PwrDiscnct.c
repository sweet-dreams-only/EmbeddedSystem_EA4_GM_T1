 ...
 *********************************************************************************************************************/
  ...
  float32 PwrDiscnctDeltaVltg1;
  float32 PwrDiscnctDeltaVltg2;
  boolean PwrDiscnctSeqATestCmplPrev;

  float32 BattVltgSwdMax_Val_data;
  float32 PwrDiscnctOpenThd_Val_data;
  uint16 PwrDiscnctNtc0x042FailStep_Val_data;
  uint16 PwrDiscnctNtc0x042PassStep_Val_data;
  uint16 PwrDiscnctNtc0x04AFailStep_Val_data;
  uint16 PwrDiscnctNtc0x04APassStep_Val_data;
  ...
  *************************************************/
  ...
  PwrDiscnctDeltaVltg1 = *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctDeltaVltg1();
  *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctDeltaVltg1() = PwrDiscnctDeltaVltg1;
  PwrDiscnctDeltaVltg2 = *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctDeltaVltg2();
  *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctDeltaVltg2() = PwrDiscnctDeltaVltg2;
  PwrDiscnctSeqATestCmplPrev = *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctSeqATestCmplPrev();
  *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctSeqATestCmplPrev() = PwrDiscnctSeqATestCmplPrev;

  BattVltgSwdMax_Val_data = TSC_PwrDiscnct_Rte_Prm_BattVltgSwdMax_Val();
  PwrDiscnctOpenThd_Val_data = TSC_PwrDiscnct_Rte_Prm_PwrDiscnctOpenThd_Val();
  PwrDiscnctNtc0x042FailStep_Val_data = TSC_PwrDiscnct_Rte_Prm_PwrDiscnctNtc0x042FailStep_Val();
  PwrDiscnctNtc0x042PassStep_Val_data = TSC_PwrDiscnct_Rte_Prm_PwrDiscnctNtc0x042PassStep_Val();
  PwrDiscnctNtc0x04AFailStep_Val_data = TSC_PwrDiscnct_Rte_Prm_PwrDiscnctNtc0x04AFailStep_Val();
  PwrDiscnctNtc0x04APassStep_Val_data = TSC_PwrDiscnct_Rte_Prm_PwrDiscnctNtc0x04APassStep_Val();
  ...
  fct_status = TSC_PwrDiscnct_Rte_Read_BattVltgSwd2_Val(&Read_BattVltgSwd2_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void PwrDiscnct_TestDefines(void)
{
  ...
  float32 Test_float32_LL_2 = Volt3_LowerLimit;
  float32 Test_float32_UL_2 = Volt3_UpperLimit;
  float32 Test_float32_LL_3 = Volt5_LowerLimit;
  float32 Test_float32_UL_3 = Volt5_UpperLimit;
  float32 Test_float32_LL_4 = Volt6_LowerLimit;
  float32 Test_float32_UL_4 = Volt6_UpperLimit;
