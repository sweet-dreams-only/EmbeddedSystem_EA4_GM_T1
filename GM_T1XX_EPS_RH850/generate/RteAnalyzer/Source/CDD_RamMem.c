 ...
 *********************************************************************************************************************/
  ...
  uint32 LclRamFailrAdr;
  uint32 LclRamWordLineRead;
  uint32 dRamMemCanRamDblBitEccErrAdr;
  uint32 dRamMemCanRamSngBitEccErrAdr;
  uint32 dRamMemDtsRamEccErrAdr;
  uint32 dRamMemFrRamDblBitEccErrAdr;
  uint32 dRamMemFrRamSngBitEccErrAdr;
  uint32 dRamMemFrRamTmpBufADblBitEccErrAdr;
  uint32 dRamMemFrRamTmpBufBDblBitEccErrAdr;
  uint32 dRamMemSpi0RamEccErrAdr;
  uint32 dRamMemSpi1RamEccErrAdr;
  uint32 dRamMemSpi2RamEccErrAdr;
  uint32 dRamMemSpi3RamEccErrAdr;
  uint32 dRamMemSpiRamEccErrAdr;
  uint8 LclRamEccSngBitCntr;
  boolean LclRamEccSngBitSoftFailr;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  LclRamFailrAdr = *TSC_CDD_RamMem_Rte_Pim_LclRamFailrAdr();
  *TSC_CDD_RamMem_Rte_Pim_LclRamFailrAdr() = LclRamFailrAdr;
  LclRamWordLineRead = *TSC_CDD_RamMem_Rte_Pim_LclRamWordLineRead();
  *TSC_CDD_RamMem_Rte_Pim_LclRamWordLineRead() = LclRamWordLineRead;
  dRamMemCanRamDblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamDblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamDblBitEccErrAdr() = dRamMemCanRamDblBitEccErrAdr;
  dRamMemCanRamSngBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamSngBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamSngBitEccErrAdr() = dRamMemCanRamSngBitEccErrAdr;
  dRamMemDtsRamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemDtsRamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemDtsRamEccErrAdr() = dRamMemDtsRamEccErrAdr;
  dRamMemFrRamDblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamDblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamDblBitEccErrAdr() = dRamMemFrRamDblBitEccErrAdr;
  dRamMemFrRamSngBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamSngBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamSngBitEccErrAdr() = dRamMemFrRamSngBitEccErrAdr;
  dRamMemFrRamTmpBufADblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufADblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufADblBitEccErrAdr() = dRamMemFrRamTmpBufADblBitEccErrAdr;
  dRamMemFrRamTmpBufBDblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufBDblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufBDblBitEccErrAdr() = dRamMemFrRamTmpBufBDblBitEccErrAdr;
  dRamMemSpi0RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi0RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi0RamEccErrAdr() = dRamMemSpi0RamEccErrAdr;
  dRamMemSpi1RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi1RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi1RamEccErrAdr() = dRamMemSpi1RamEccErrAdr;
  dRamMemSpi2RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi2RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi2RamEccErrAdr() = dRamMemSpi2RamEccErrAdr;
  dRamMemSpi3RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi3RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi3RamEccErrAdr() = dRamMemSpi3RamEccErrAdr;
  dRamMemSpiRamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpiRamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpiRamEccErrAdr() = dRamMemSpiRamEccErrAdr;
  LclRamEccSngBitCntr = *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitCntr();
  *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitCntr() = LclRamEccSngBitCntr;
  LclRamEccSngBitSoftFailr = *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitSoftFailr();
  *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitSoftFailr() = LclRamEccSngBitSoftFailr;
