 ...
 *
 *   Description:  C-Code implementation template for SW-C <GmMsg348BusHiSpd>
 *********************************************************************************************************************/
...
#include "Rte_GmMsg348BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg348BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg348BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: GmMsg348BusHiSpdPer1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 Read_LstRxnTiMsg348BusHiSpd_Val;
  uint16 Read_WhlGndVelLeDrvnRawBusHiSpd_Val;
  uint8 Read_WhlGndVelLeDrvnVldRawBusHiSpd_Val;
  uint16 Read_WhlGndVelRiDrvnRawBusHiSpd_Val;
  uint8 Read_WhlGndVelRiDrvnVldRawBusHiSpd_Val;

  uint32 GmMsg348BusHiSpdWhlGndVelLeDrvnInvldTi;
  uint32 GmMsg348BusHiSpdWhlGndVelLeDrvnStuckTi;
  uint32 GmMsg348BusHiSpdWhlGndVelRiDrvnInvldTi;
  uint32 GmMsg348BusHiSpdWhlGndVelRiDrvnStuckTi;
  uint16 GmMsg348BusHiSpdPrevWhlGndVelLeDrvn;
  uint16 GmMsg348BusHiSpdPrevWhlGndVelRiDrvn;

  uint16 GmMsg348BusHiSpdInvldTiOut_Val_data;
  uint16 GmMsg348BusHiSpdMissTiOut_Val_data;
  uint16 GmMsg348BusHiSpdStuckTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg348BusHiSpdWhlGndVelLeDrvnInvldTi = *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelLeDrvnInvldTi();
  *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelLeDrvnInvldTi() = GmMsg348BusHiSpdWhlGndVelLeDrvnInvldTi;
  GmMsg348BusHiSpdWhlGndVelLeDrvnStuckTi = *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelLeDrvnStuckTi();
  *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelLeDrvnStuckTi() = GmMsg348BusHiSpdWhlGndVelLeDrvnStuckTi;
  GmMsg348BusHiSpdWhlGndVelRiDrvnInvldTi = *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelRiDrvnInvldTi();
  *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelRiDrvnInvldTi() = GmMsg348BusHiSpdWhlGndVelRiDrvnInvldTi;
  GmMsg348BusHiSpdWhlGndVelRiDrvnStuckTi = *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelRiDrvnStuckTi();
  *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdWhlGndVelRiDrvnStuckTi() = GmMsg348BusHiSpdWhlGndVelRiDrvnStuckTi;
  GmMsg348BusHiSpdPrevWhlGndVelLeDrvn = *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdPrevWhlGndVelLeDrvn();
  *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdPrevWhlGndVelLeDrvn() = GmMsg348BusHiSpdPrevWhlGndVelLeDrvn;
  GmMsg348BusHiSpdPrevWhlGndVelRiDrvn = *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdPrevWhlGndVelRiDrvn();
  *TSC_GmMsg348BusHiSpd_Rte_Pim_GmMsg348BusHiSpdPrevWhlGndVelRiDrvn() = GmMsg348BusHiSpdPrevWhlGndVelRiDrvn;

  GmMsg348BusHiSpdInvldTiOut_Val_data = TSC_GmMsg348BusHiSpd_Rte_Prm_GmMsg348BusHiSpdInvldTiOut_Val();
  GmMsg348BusHiSpdMissTiOut_Val_data = TSC_GmMsg348BusHiSpd_Rte_Prm_GmMsg348BusHiSpdMissTiOut_Val();
  GmMsg348BusHiSpdStuckTiOut_Val_data = TSC_GmMsg348BusHiSpd_Rte_Prm_GmMsg348BusHiSpdStuckTiOut_Val();

  fct_status = TSC_GmMsg348BusHiSpd_Rte_Read_LstRxnTiMsg348BusHiSpd_Val(&Read_LstRxnTiMsg348BusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Read_WhlGndVelLeDrvnRawBusHiSpd_Val(&Read_WhlGndVelLeDrvnRawBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Read_WhlGndVelLeDrvnVldRawBusHiSpd_Val(&Read_WhlGndVelLeDrvnVldRawBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Read_WhlGndVelRiDrvnRawBusHiSpd_Val(&Read_WhlGndVelRiDrvnRawBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Read_WhlGndVelRiDrvnVldRawBusHiSpd_Val(&Read_WhlGndVelRiDrvnVldRawBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Write_WhlGndVelLeDrvnBusHiSpd_Val(Rte_InitValue_WhlGndVelLeDrvnBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Write_WhlGndVelLeDrvnStuckBusHiSpd_Logl(Rte_InitValue_WhlGndVelLeDrvnStuckBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Write_WhlGndVelLeDrvnVldBusHiSpd_Logl(Rte_InitValue_WhlGndVelLeDrvnVldBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Write_WhlGndVelRiDrvnBusHiSpd_Val(Rte_InitValue_WhlGndVelRiDrvnBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Write_WhlGndVelRiDrvnStuckBusHiSpd_Logl(Rte_InitValue_WhlGndVelRiDrvnStuckBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Write_WhlGndVelRiDrvnVldBusHiSpd_Logl(Rte_InitValue_WhlGndVelRiDrvnVldBusHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg348BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
