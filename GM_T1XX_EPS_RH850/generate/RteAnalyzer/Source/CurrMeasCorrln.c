 ...
 *********************************************************************************************************************/
  ...
  float32 Read_MotCurrCorrdD_Val;
  float32 Read_MotCurrCorrdE_Val;
  float32 Read_MotCurrCorrdF_Val;
  ...
  uint8 Read_MotCurrRollgCntr2_Val;
  SysSt1 Read_SysSt_Val;

  uint8 CurrMeasCorrlnSens0RollgCntPrev;
  uint8 CurrMeasCorrlnSens0StallCntPrev;
  uint8 CurrMeasCorrlnSens1RollgCntPrev;
  uint8 CurrMeasCorrlnSens1StallCntPrev;
  ...
  uint16 CurrMeasCorrlnNtc0x04EFailStep_Val_data;
  uint16 CurrMeasCorrlnNtc0x04EPassStep_Val_data;
  ...
  *************************************************/
  ...
  CurrMeasCorrlnSens0RollgCntPrev = *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens0RollgCntPrev();
  *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens0RollgCntPrev() = CurrMeasCorrlnSens0RollgCntPrev;
  CurrMeasCorrlnSens0StallCntPrev = *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens0StallCntPrev();
  *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens0StallCntPrev() = CurrMeasCorrlnSens0StallCntPrev;
  CurrMeasCorrlnSens1RollgCntPrev = *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens1RollgCntPrev();
  *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens1RollgCntPrev() = CurrMeasCorrlnSens1RollgCntPrev;
  CurrMeasCorrlnSens1StallCntPrev = *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens1StallCntPrev();
  *TSC_CurrMeasCorrln_Rte_Pim_CurrMeasCorrlnSens1StallCntPrev() = CurrMeasCorrlnSens1StallCntPrev;
  ...
  CurrMeasCorrlnNtc0x04EFailStep_Val_data = TSC_CurrMeasCorrln_Rte_Prm_CurrMeasCorrlnNtc0x04EFailStep_Val();
  CurrMeasCorrlnNtc0x04EPassStep_Val_data = TSC_CurrMeasCorrln_Rte_Prm_CurrMeasCorrlnNtc0x04EPassStep_Val();
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_DiagcStsIvtr2Inactv_Logl(&Read_DiagcStsIvtr2Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrCorrdD_Val(&Read_MotCurrCorrdD_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrCorrdE_Val(&Read_MotCurrCorrdE_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrCorrdF_Val(&Read_MotCurrCorrdF_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrQlfr1_Val(&Read_MotCurrQlfr1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrQlfr2_Val(&Read_MotCurrQlfr2_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrRollgCntr2_Val(&Read_MotCurrRollgCntr2_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Write_CurrMotSumDEF_Val(Rte_InitValue_CurrMotSumDEF_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
