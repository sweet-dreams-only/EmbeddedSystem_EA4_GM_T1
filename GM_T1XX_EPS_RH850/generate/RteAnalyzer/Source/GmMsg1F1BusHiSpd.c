...
#include "Rte_GmMsg1F1BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg1F1BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg1F1BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint32 Read_LstRxnTiMsg1F1_Val;
  uint8 Read_SysBackUpPwrModEnaRaw_Val;
  uint8 Read_SysBackUpPwrModRaw_Val;
  uint8 Read_SysPwrModRaw_Val;

  boolean GmMsg1F1BusHiSpdPrevPrevSysPwrModRun;

  uint16 GmMsg1F1BusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg1F1BusHiSpdPrevPrevSysPwrModRun = *TSC_GmMsg1F1BusHiSpd_Rte_Pim_GmMsg1F1BusHiSpdPrevPrevSysPwrModRun();
  *TSC_GmMsg1F1BusHiSpd_Rte_Pim_GmMsg1F1BusHiSpdPrevPrevSysPwrModRun() = GmMsg1F1BusHiSpdPrevPrevSysPwrModRun;

  GmMsg1F1BusHiSpdMissTiOut_Val_data = TSC_GmMsg1F1BusHiSpd_Rte_Prm_GmMsg1F1BusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Read_EngRunActv_Logl(&Read_EngRunActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Read_LstRxnTiMsg1F1_Val(&Read_LstRxnTiMsg1F1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Read_SysBackUpPwrModEnaRaw_Val(&Read_SysBackUpPwrModEnaRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Read_SysBackUpPwrModRaw_Val(&Read_SysBackUpPwrModRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Read_SysPwrModRaw_Val(&Read_SysPwrModRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Write_MissMsg1F1_Logl(Rte_InitValue_MissMsg1F1_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Write_SysPwrMod_Val(Rte_InitValue_SysPwrMod_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Write_SysPwrModRun_Logl(Rte_InitValue_SysPwrModRun_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg1F1BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
