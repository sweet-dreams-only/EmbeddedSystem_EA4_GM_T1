...
#include "Rte_AssiSumLim.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void AssiSumLim_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 AssiSumLimPullCmpLim_Val_data;
  uint16 AssiSumLimNtc0x0C4FailStep_Val_data;
  uint16 AssiSumLimNtc0x0C4PassStep_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  AssiSumLimPullCmpLim_Val_data = TSC_AssiSumLim_Rte_Prm_AssiSumLimPullCmpLim_Val();
  AssiSumLimNtc0x0C4FailStep_Val_data = TSC_AssiSumLim_Rte_Prm_AssiSumLimNtc0x0C4FailStep_Val();
  AssiSumLimNtc0x0C4PassStep_Val_data = TSC_AssiSumLim_Rte_Prm_AssiSumLimNtc0x0C4PassStep_Val();

  fct_status = TSC_AssiSumLim_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_TqLoaCmd_Val;
  float32 Read_TqSteerMtgtnCmd_Val;
  ...
  float32 AssiSumLimPer1_ProcdManTqCmd;
  boolean AssiSumLimPer1_ProcdManTqCmdEna;
  ...
  *************************************************/
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_AssiCmd_Val(&Read_AssiCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_DampgCmd_Val(&Read_DampgCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_EotActvCmd_Val(&Read_EotActvCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_EotAssiSca_Val(&Read_EotAssiSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_EotDampgCmd_Val(&Read_EotDampgCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_EotMotTqLim_Val(&Read_EotMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_HwTqLoaMtgtnEna_Logl(&Read_HwTqLoaMtgtnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_MotTqCmdLimDi_Logl(&Read_MotTqCmdLimDi_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_MotTqCmdOvrl_Val(&Read_MotTqCmdOvrl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_PinionCentrLrnCmd_Val(&Read_PinionCentrLrnCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_PinionCentrLrnEna_Logl(&Read_PinionCentrLrnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_PullCmpCmd_Val(&Read_PullCmpCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_PwrLimrRednFac_Val(&Read_PwrLimrRednFac_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_RtnCmd_Val(&Read_RtnCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_StallMotTqLim_Val(&Read_StallMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_SysMotTqCmdSca_Val(&Read_SysMotTqCmdSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_ThermMotTqLim_Val(&Read_ThermMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_ThermRednFac_Val(&Read_ThermRednFac_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_TqLoaCmd_Val(&Read_TqLoaCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_TqSteerMtgtnCmd_Val(&Read_TqSteerMtgtnCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_VehSpdMotTqLim_Val(&Read_VehSpdMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Read_WhlImbRejctnCmd_Val(&Read_WhlImbRejctnCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Write_MotTqCmd_Val(Rte_InitValue_MotTqCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Write_MotTqCmdLimdPreStall_Val(Rte_InitValue_MotTqCmdLimdPreStall_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Write_MotTqCmdLimrMin_Val(Rte_InitValue_MotTqCmdLimrMin_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Write_MotTqCmdPreLim_Val(Rte_InitValue_MotTqCmdPreLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_AssiSumLim_Rte_Write_SysProtnRednFac_Val(Rte_InitValue_SysProtnRednFac_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  AssiSumLimPer1_ProcdManTqCmd = TSC_AssiSumLim_Rte_IrvRead_AssiSumLimPer1_ProcdManTqCmd();
  AssiSumLimPer1_ProcdManTqCmdEna = TSC_AssiSumLim_Rte_IrvRead_AssiSumLimPer1_ProcdManTqCmdEna();

  fct_status = TSC_AssiSumLim_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  TSC_AssiSumLim_Rte_IrvWrite_SetManTqCmd_Oper_ProcdManTqCmd(0.0F);
  TSC_AssiSumLim_Rte_IrvWrite_SetManTqCmd_Oper_ProcdManTqCmdEna(FALSE);
...
static void AssiSumLim_TestDefines(void)
{
  ...
  float32 Test_float32_LL_4 = Tq8_LowerLimit;
  float32 Test_float32_UL_4 = Tq8_UpperLimit;
  float32 Test_float32_LL_5 = Tq9_LowerLimit;
  float32 Test_float32_UL_5 = Tq9_UpperLimit;
