...
#include "Rte_SerlComOutpProxy.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void SerlComOutpProxy_TestDefines(void);
 ...
 * Symbol: SerlComOutpProxyInit1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  BusOffChassisExp = *TSC_SerlComOutpProxy_Rte_Pim_BusOffChassisExp();
  *TSC_SerlComOutpProxy_Rte_Pim_BusOffChassisExp() = BusOffChassisExp;
  BusOffHiSpd = *TSC_SerlComOutpProxy_Rte_Pim_BusOffHiSpd();
  *TSC_SerlComOutpProxy_Rte_Pim_BusOffHiSpd() = BusOffHiSpd;

  GmOvrlStMgrApaMfgEna_Logl_data = TSC_SerlComOutpProxy_Rte_Prm_GmOvrlStMgrApaMfgEna_Logl();
  GmOvrlStMgrEscMfgEna_Logl_data = TSC_SerlComOutpProxy_Rte_Prm_GmOvrlStMgrEscMfgEna_Logl();
  GmOvrlStMgrLkaMfgEna_Logl_data = TSC_SerlComOutpProxy_Rte_Prm_GmOvrlStMgrLkaMfgEna_Logl();

  fct_status = TSC_SerlComOutpProxy_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SerlComOutpProxyPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_CodSupported_Val;
  uint8 Read_CurrSts_Val;
  uint8 Read_DrvrSteerIntvDetd_Val;
  uint8 Read_DrvrSteerIntvDetdProtnVal_Val;
  uint8 Read_DrvrSteerIntvDetdRollgCntr_Val;
  uint8 Read_DrvrSteerIntvDetdVld_Val;
  uint8 Read_DtcFailrTyp_Val;
  uint8 Read_DtcFltTyp_Val;
  uint16 Read_DtcNr_Val;
  uint8 Read_DtcSrc_Val;
  uint8 Read_DtcTrig_Val;
  uint8 Read_ElecPowerSteerAvlSts_Val;
  uint8 Read_ElecPowerSteerAvlStsProtnVal_Val;
  uint8 Read_ElecPowerSteerAvlStsRollgCntr_Val;
  uint16 Read_ElecPwrSteerTotTqDlvd_Val;
  uint8 Read_HandsOffSteerWhlDetnMod_Val;
  uint8 Read_HandsOffSteerWhlDetnSt_Val;
  uint8 Read_HandsOffSteerWhlDetnStVld_Val;
  uint8 Read_HistSts_Val;
  uint16 Read_LkaDrvrAppldTq_Val;
  uint8 Read_LkaDrvrAppldTqVld_Val;
  uint16 Read_LkaElecPwrSteerTotTqDlvd_Val;
  uint16 Read_LkaTqOvrlDeltaTqDlvd_Val;
  uint8 Read_LkaTqOvrlDlvdRollgCntr_Val;
  uint16 Read_LkaTqOvrlStsChks_Val;
  uint8 Read_LkaTqOvrlTqDlvdSts_Val;
  uint8 Read_PwrSteerIndcr_Val;
  uint8 Read_SteerAssiLimd_Val;
  uint8 Read_SteerAssiLimdLvl2_Val;
  uint8 Read_SteerAssiLimdLvl3_Val;
  uint8 Read_SteerWhlAgAlvRollgCntBusChassisExp_Val;
  uint8 Read_SteerWhlAgAlvRollgCntBusHiSpd_Val;
  uint16 Read_SteerWhlAgBusChassisExp_Val;
  uint16 Read_SteerWhlAgBusHiSpd_Val;
  uint16 Read_SteerWhlAgGrdtBusChassisExp_Val;
  uint16 Read_SteerWhlAgGrdtBusHiSpd_Val;
  uint8 Read_SteerWhlAgGrdtMaskBusChassisExp_Val;
  uint8 Read_SteerWhlAgGrdtMaskBusHiSpd_Val;
  uint8 Read_SteerWhlAgGrdtVldBusChassisExp_Val;
  uint8 Read_SteerWhlAgGrdtVldBusHiSpd_Val;
  uint8 Read_SteerWhlAgMaskBusChassisExp_Val;
  uint8 Read_SteerWhlAgMaskBusHiSpd_Val;
  uint8 Read_SteerWhlAgSnsrCalStsBusChassisExp_Val;
  uint8 Read_SteerWhlAgSnsrCalStsBusHiSpd_Val;
  uint16 Read_SteerWhlAgSnsrChksBusChassisExp_Val;
  uint16 Read_SteerWhlAgSnsrChksBusHiSpd_Val;
  uint8 Read_SteerWhlAgSnsrTypBusChassisExp_Val;
  uint8 Read_SteerWhlAgSnsrTypBusHiSpd_Val;
  uint8 Read_SteerWhlAgVldBusChassisExp_Val;
  uint8 Read_SteerWhlAgVldBusHiSpd_Val;
  uint16 Read_TqOvrlDeltaTqDlvd_Val;
  uint16 Read_TqOvrlDlvdChks_Val;
  uint8 Read_TqOvrlDlvdRollgCntr_Val;
  uint8 Read_TqOvrlTqDlvdSts_Val;
  uint8 Read_TstFaildCodClrdSts_Val;
  uint8 Read_TstFaildPwrUpSts_Val;
  uint8 Read_TstNotPassdCodClrdSts_Val;
  uint8 Read_TstNotPassdPwrUpSts_Val;
  uint8 Read_WarnIndcrReqdSts_Val;
  ...
  *TSC_SerlComOutpProxy_Rte_Pim_BusOffHiSpd() = BusOffHiSpd;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_CodSupported_Val(&Read_CodSupported_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_CurrSts_Val(&Read_CurrSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DrvrSteerIntvDetd_Val(&Read_DrvrSteerIntvDetd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DrvrSteerIntvDetdProtnVal_Val(&Read_DrvrSteerIntvDetdProtnVal_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DrvrSteerIntvDetdRollgCntr_Val(&Read_DrvrSteerIntvDetdRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DrvrSteerIntvDetdVld_Val(&Read_DrvrSteerIntvDetdVld_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DtcFailrTyp_Val(&Read_DtcFailrTyp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DtcFltTyp_Val(&Read_DtcFltTyp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DtcNr_Val(&Read_DtcNr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DtcSrc_Val(&Read_DtcSrc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_DtcTrig_Val(&Read_DtcTrig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_ElecPowerSteerAvlSts_Val(&Read_ElecPowerSteerAvlSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_ElecPowerSteerAvlStsProtnVal_Val(&Read_ElecPowerSteerAvlStsProtnVal_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_ElecPowerSteerAvlStsRollgCntr_Val(&Read_ElecPowerSteerAvlStsRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_ElecPwrSteerTotTqDlvd_Val(&Read_ElecPwrSteerTotTqDlvd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_HandsOffSteerWhlDetnMod_Val(&Read_HandsOffSteerWhlDetnMod_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_HandsOffSteerWhlDetnSt_Val(&Read_HandsOffSteerWhlDetnSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_HandsOffSteerWhlDetnStVld_Val(&Read_HandsOffSteerWhlDetnStVld_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_HistSts_Val(&Read_HistSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaDrvrAppldTq_Val(&Read_LkaDrvrAppldTq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaDrvrAppldTqVld_Val(&Read_LkaDrvrAppldTqVld_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaElecPwrSteerTotTqDlvd_Val(&Read_LkaElecPwrSteerTotTqDlvd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaTqOvrlDeltaTqDlvd_Val(&Read_LkaTqOvrlDeltaTqDlvd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaTqOvrlDlvdRollgCntr_Val(&Read_LkaTqOvrlDlvdRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaTqOvrlStsChks_Val(&Read_LkaTqOvrlStsChks_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_LkaTqOvrlTqDlvdSts_Val(&Read_LkaTqOvrlTqDlvdSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_PwrSteerIndcr_Val(&Read_PwrSteerIndcr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerAssiLimd_Val(&Read_SteerAssiLimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerAssiLimdLvl2_Val(&Read_SteerAssiLimdLvl2_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerAssiLimdLvl3_Val(&Read_SteerAssiLimdLvl3_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgAlvRollgCntBusChassisExp_Val(&Read_SteerWhlAgAlvRollgCntBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgAlvRollgCntBusHiSpd_Val(&Read_SteerWhlAgAlvRollgCntBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgBusChassisExp_Val(&Read_SteerWhlAgBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgBusHiSpd_Val(&Read_SteerWhlAgBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgGrdtBusChassisExp_Val(&Read_SteerWhlAgGrdtBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgGrdtBusHiSpd_Val(&Read_SteerWhlAgGrdtBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgGrdtMaskBusChassisExp_Val(&Read_SteerWhlAgGrdtMaskBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgGrdtMaskBusHiSpd_Val(&Read_SteerWhlAgGrdtMaskBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgGrdtVldBusChassisExp_Val(&Read_SteerWhlAgGrdtVldBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgGrdtVldBusHiSpd_Val(&Read_SteerWhlAgGrdtVldBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgMaskBusChassisExp_Val(&Read_SteerWhlAgMaskBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgMaskBusHiSpd_Val(&Read_SteerWhlAgMaskBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgSnsrCalStsBusChassisExp_Val(&Read_SteerWhlAgSnsrCalStsBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgSnsrCalStsBusHiSpd_Val(&Read_SteerWhlAgSnsrCalStsBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgSnsrChksBusChassisExp_Val(&Read_SteerWhlAgSnsrChksBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgSnsrChksBusHiSpd_Val(&Read_SteerWhlAgSnsrChksBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgSnsrTypBusChassisExp_Val(&Read_SteerWhlAgSnsrTypBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgSnsrTypBusHiSpd_Val(&Read_SteerWhlAgSnsrTypBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgVldBusChassisExp_Val(&Read_SteerWhlAgVldBusChassisExp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_SteerWhlAgVldBusHiSpd_Val(&Read_SteerWhlAgVldBusHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TqOvrlDeltaTqDlvd_Val(&Read_TqOvrlDeltaTqDlvd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TqOvrlDlvdChks_Val(&Read_TqOvrlDlvdChks_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TqOvrlDlvdRollgCntr_Val(&Read_TqOvrlDlvdRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TqOvrlTqDlvdSts_Val(&Read_TqOvrlTqDlvdSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TstFaildCodClrdSts_Val(&Read_TstFaildCodClrdSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TstFaildPwrUpSts_Val(&Read_TstFaildPwrUpSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TstNotPassdCodClrdSts_Val(&Read_TstNotPassdCodClrdSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_TstNotPassdPwrUpSts_Val(&Read_TstNotPassdPwrUpSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Read_WarnIndcrReqdSts_Val(&Read_WarnIndcrReqdSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Write_BusOffChassisExp_Logl(Rte_InitValue_BusOffChassisExp_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Write_BusOffHiSpd_Logl(Rte_InitValue_BusOffHiSpd_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Call_Msg184TxCallBack_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Call_Msg1CATxCallBack_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Call_Msg1E5ChassisExpTxCallBack_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Call_Msg1E5HiSpdTxCallBack_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SerlComOutpProxy_Rte_Call_Msg335TxCallBack_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
