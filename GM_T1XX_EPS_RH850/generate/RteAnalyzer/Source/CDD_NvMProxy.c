 ...
 *********************************************************************************************************************/
  ...
  uint32 ShtdwnClsChk;
  boolean NvmStsCollctd;
  Ary1D_BlkFltTblRec1_5 BlkFltTbl;
  Ary1D_CmdRtnBufRec1_NvMProxy1 CmdRtnBuf;
  Ary1D_boolean_NvMProxy1 NvmBlkActv;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  ShtdwnClsChk = *TSC_CDD_NvMProxy_Rte_Pim_ShtdwnClsChk();
  *TSC_CDD_NvMProxy_Rte_Pim_ShtdwnClsChk() = ShtdwnClsChk;
  NvmStsCollctd = *TSC_CDD_NvMProxy_Rte_Pim_NvmStsCollctd();
  *TSC_CDD_NvMProxy_Rte_Pim_NvmStsCollctd() = NvmStsCollctd;

  (void)memcpy(BlkFltTbl, TSC_CDD_NvMProxy_Rte_Pim_BlkFltTbl(), sizeof(Ary1D_BlkFltTblRec1_5));
  (void)memcpy(TSC_CDD_NvMProxy_Rte_Pim_BlkFltTbl(), BlkFltTbl, sizeof(Ary1D_BlkFltTblRec1_5));


  (void)memcpy(CmdRtnBuf, TSC_CDD_NvMProxy_Rte_Pim_CmdRtnBuf(), sizeof(Ary1D_CmdRtnBufRec1_NvMProxy1));
  (void)memcpy(TSC_CDD_NvMProxy_Rte_Pim_CmdRtnBuf(), CmdRtnBuf, sizeof(Ary1D_CmdRtnBufRec1_NvMProxy1));


  (void)memcpy(NvmBlkActv, TSC_CDD_NvMProxy_Rte_Pim_NvmBlkActv(), sizeof(Ary1D_boolean_NvMProxy1));
  (void)memcpy(TSC_CDD_NvMProxy_Rte_Pim_NvmBlkActv(), NvmBlkActv, sizeof(Ary1D_boolean_NvMProxy1));
