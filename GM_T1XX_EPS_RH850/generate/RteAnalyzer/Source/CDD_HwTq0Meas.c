...
#include "Rte_CDD_HwTq0Meas.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void CDD_HwTq0Meas_TestDefines(void);
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq0Offs_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 * Symbol: HwTq0MeasHwTq0AutTrim_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 HwTq0MeasPrevHwTq0;
  float32 RackLimrCcwEot0;
  float32 RackLimrCwEot0;
  uint32 HwTq0MsgMissRxCnt;
  uint8 HwTq0ComStsErrCntr;
  uint8 HwTq0IntSnsrErrCntr;
  uint8 HwTq0MeasPrevRollgCntr;
  uint8 RackLimrEot0Data0;
  uint8 RackLimrEot0Data1;
  uint8 RackLimrEot0Data2;
  boolean RackLimrEot0Avl;
  boolean RackLimrEot0Id2DataReadCmpl;
  boolean RackLimrEot0Id3DataReadCmpl;
  boolean RackLimrEot0Id4DataReadCmpl;
  HwTqOffsRec1 HwTq0Offs;

  HwTqOffsRec1 HwTq0OffsDft_data;

  uint16 HwTq0MeasHwTq0PrtclFltFailStep_Val_data;
  uint16 HwTq0MeasHwTq0PrtclFltPassStep_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  HwTq0MeasPrevHwTq0 = *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0MeasPrevHwTq0();
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0MeasPrevHwTq0() = HwTq0MeasPrevHwTq0;
  RackLimrCcwEot0 = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrCcwEot0();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrCcwEot0() = RackLimrCcwEot0;
  RackLimrCwEot0 = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrCwEot0();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrCwEot0() = RackLimrCwEot0;
  HwTq0MsgMissRxCnt = *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0MsgMissRxCnt();
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0MsgMissRxCnt() = HwTq0MsgMissRxCnt;
  HwTq0ComStsErrCntr = *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0ComStsErrCntr();
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0ComStsErrCntr() = HwTq0ComStsErrCntr;
  HwTq0IntSnsrErrCntr = *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0IntSnsrErrCntr();
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0IntSnsrErrCntr() = HwTq0IntSnsrErrCntr;
  HwTq0MeasPrevRollgCntr = *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0MeasPrevRollgCntr();
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0MeasPrevRollgCntr() = HwTq0MeasPrevRollgCntr;
  RackLimrEot0Data0 = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Data0();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Data0() = RackLimrEot0Data0;
  RackLimrEot0Data1 = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Data1();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Data1() = RackLimrEot0Data1;
  RackLimrEot0Data2 = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Data2();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Data2() = RackLimrEot0Data2;
  RackLimrEot0Avl = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Avl();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Avl() = RackLimrEot0Avl;
  RackLimrEot0Id2DataReadCmpl = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Id2DataReadCmpl();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Id2DataReadCmpl() = RackLimrEot0Id2DataReadCmpl;
  RackLimrEot0Id3DataReadCmpl = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Id3DataReadCmpl();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Id3DataReadCmpl() = RackLimrEot0Id3DataReadCmpl;
  RackLimrEot0Id4DataReadCmpl = *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Id4DataReadCmpl();
  *TSC_CDD_HwTq0Meas_Rte_Pim_RackLimrEot0Id4DataReadCmpl() = RackLimrEot0Id4DataReadCmpl;
  HwTq0Offs = *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0Offs();
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0Offs() = HwTq0Offs;

  HwTq0OffsDft_data = *TSC_CDD_HwTq0Meas_Rte_CData_HwTq0OffsDft();

  HwTq0MeasHwTq0PrtclFltFailStep_Val_data = TSC_CDD_HwTq0Meas_Rte_Prm_HwTq0MeasHwTq0PrtclFltFailStep_Val();
  HwTq0MeasHwTq0PrtclFltPassStep_Val_data = TSC_CDD_HwTq0Meas_Rte_Prm_HwTq0MeasHwTq0PrtclFltPassStep_Val();

  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_HwTq0Offs_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq0MeasHwTq0ClrTrim_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq0MeasHwTq0ReadTrim_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq0MeasHwTq0TrimPrfmdSts_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq0MeasHwTq0WrTrim_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0Offs() = HwTq0Offs;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_GetRefTmr1MicroSec32bit_Oper(&Call_GetRefTmr1MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_GetTiSpan1MicroSec32bit_Oper(0U, &Call_GetTiSpan1MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_IoHwAb_SetFctPrphlHwTq0_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_HwTq0Meas_Rte_Pim_HwTq0Offs() = HwTq0Offs;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Read_HwTq0Polarity_Val(&Read_HwTq0Polarity_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Write_HwTq0_Val(Rte_InitValue_HwTq0_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Write_HwTq0Qlfr_Val(Rte_InitValue_HwTq0Qlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Write_HwTq0RollgCntr_Val(Rte_InitValue_HwTq0RollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Write_RackLimrCcwEotSig0_Val(Rte_InitValue_RackLimrCcwEotSig0_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Write_RackLimrCwEotSig0_Val(Rte_InitValue_RackLimrCwEotSig0_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Write_RackLimrEotSig0Avl_Logl(Rte_InitValue_RackLimrEotSig0Avl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_FltInj_f32_Oper(&Call_FltInj_f32_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_FltInj_u08_Oper(&Call_FltInj_u08_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq0Meas_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq0MeasTrigStrt_Oper_doc
 *********************************************************************************************************************/
