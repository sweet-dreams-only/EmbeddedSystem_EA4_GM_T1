 ...
 *********************************************************************************************************************/
  ...
  uint8 PrevCurrMeasIdptSigResp;
  uint8 PrevCurrMeasIdptSigVal;
  uint8 PrevHwTqIdptSigResp;
  uint8 PrevHwTqIdptSigVal;
  uint8 PrevIvtrIdptSigResp;
  uint8 PrevIvtrIdptSigVal;
  uint8 PrevMotAgMeclIdptSigResp;
  uint8 PrevMotAgMeclIdptSigVal;
  uint8 PrevVltgModSrc;
  boolean PrevCurrMeasLoaStSwMtgtnEna;
  boolean PrevHwTqLoaStSwMtgtnEna;
  boolean PrevIvtrLoaStSwMtgtnEna;
  boolean PrevMotAgLoaMtgtnEna;
  boolean PrevMotAgLoaStSwMtgtnEna;
  ...
  *************************************************/
  ...
  PrevCurrMeasIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigResp() = PrevCurrMeasIdptSigResp;
  PrevCurrMeasIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigVal() = PrevCurrMeasIdptSigVal;
  PrevHwTqIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigResp() = PrevHwTqIdptSigResp;
  PrevHwTqIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigVal() = PrevHwTqIdptSigVal;
  PrevIvtrIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigResp() = PrevIvtrIdptSigResp;
  PrevIvtrIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigVal() = PrevIvtrIdptSigVal;
  PrevMotAgMeclIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigResp() = PrevMotAgMeclIdptSigResp;
  PrevMotAgMeclIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigVal() = PrevMotAgMeclIdptSigVal;
  PrevVltgModSrc = *TSC_LoaMgr_Rte_Pim_PrevVltgModSrc();
  *TSC_LoaMgr_Rte_Pim_PrevVltgModSrc() = PrevVltgModSrc;
  PrevCurrMeasLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevCurrMeasLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevCurrMeasLoaStSwMtgtnEna() = PrevCurrMeasLoaStSwMtgtnEna;
  PrevHwTqLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevHwTqLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevHwTqLoaStSwMtgtnEna() = PrevHwTqLoaStSwMtgtnEna;
  PrevIvtrLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevIvtrLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevIvtrLoaStSwMtgtnEna() = PrevIvtrLoaStSwMtgtnEna;
  PrevMotAgLoaMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaMtgtnEna() = PrevMotAgLoaMtgtnEna;
  PrevMotAgLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaStSwMtgtnEna() = PrevMotAgLoaStSwMtgtnEna;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaStSwMtgtnEna() = PrevMotAgLoaStSwMtgtnEna;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_CurrMeasLoaMtgtnEna_Logl(Rte_InitValue_CurrMeasLoaMtgtnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_IvtrLoaMtgtnEna_Logl(Rte_InitValue_IvtrLoaMtgtnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
