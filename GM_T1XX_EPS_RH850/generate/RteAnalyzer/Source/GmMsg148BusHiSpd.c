...
#include "Rte_GmMsg148BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_GmMsg148BusHiSpd.h"
...
static void GmMsg148BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg148BusHiSpdInit1_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GmMsg148BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_GmMsg148BusHiSpd_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg148BusHiSpd_Rte_Write_PwrSteerIndcr_Val(Rte_InitValue_PwrSteerIndcr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg148BusHiSpd_Rte_Write_SteerAssiLimd_Val(Rte_InitValue_SteerAssiLimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg148BusHiSpd_Rte_Write_SteerAssiLimdLvl2_Val(Rte_InitValue_SteerAssiLimdLvl2_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg148BusHiSpd_Rte_Write_SteerAssiLimdLvl3_Val(Rte_InitValue_SteerAssiLimdLvl3_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
