 ...
 *********************************************************************************************************************/
  ...
  uint8 TmplMonrIninCntr;
  uint8 TmplMonrNtc40PrmByte;
  uint8 TmplMonrWdgRstrtCnt;
  boolean TmplMonrIninTestCmplFlg;
  boolean TmplMonrSpiReadWrOrderFlg1;
  boolean TmplMonrSpiReadWrOrderFlg2;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  TmplMonrIninCntr = *TSC_TmplMonr_Rte_Pim_TmplMonrIninCntr();
  *TSC_TmplMonr_Rte_Pim_TmplMonrIninCntr() = TmplMonrIninCntr;
  TmplMonrNtc40PrmByte = *TSC_TmplMonr_Rte_Pim_TmplMonrNtc40PrmByte();
  *TSC_TmplMonr_Rte_Pim_TmplMonrNtc40PrmByte() = TmplMonrNtc40PrmByte;
  TmplMonrWdgRstrtCnt = *TSC_TmplMonr_Rte_Pim_TmplMonrWdgRstrtCnt();
  *TSC_TmplMonr_Rte_Pim_TmplMonrWdgRstrtCnt() = TmplMonrWdgRstrtCnt;
  TmplMonrIninTestCmplFlg = *TSC_TmplMonr_Rte_Pim_TmplMonrIninTestCmplFlg();
  *TSC_TmplMonr_Rte_Pim_TmplMonrIninTestCmplFlg() = TmplMonrIninTestCmplFlg;
  TmplMonrSpiReadWrOrderFlg1 = *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg1();
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg1() = TmplMonrSpiReadWrOrderFlg1;
  TmplMonrSpiReadWrOrderFlg2 = *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2();
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = TmplMonrSpiReadWrOrderFlg2;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_IoHwAb_SetGpioSysFlt2A_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_IoHwAb_SetGpioSysFlt2B_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean Call_IoHwAb_GetGpioPwrOutpEnaFb_Oper_PinSt = FALSE;
  ...
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = TmplMonrSpiReadWrOrderFlg2;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_IoHwAb_GetGpioPwrOutpEnaFb_Oper(&Call_IoHwAb_GetGpioPwrOutpEnaFb_Oper_PinSt);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = TmplMonrSpiReadWrOrderFlg2;
  ...
  fct_status = TSC_TmplMonr_Rte_Read_DiagcStsIvtr1Inactv_Logl(&Read_DiagcStsIvtr1Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TmplMonr_Rte_Read_DiagcStsIvtr2Inactv_Logl(&Read_DiagcStsIvtr2Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
