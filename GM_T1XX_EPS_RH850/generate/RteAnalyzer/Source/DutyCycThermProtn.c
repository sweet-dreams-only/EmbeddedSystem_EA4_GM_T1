 ...
 *********************************************************************************************************************/
  ...
  float32 AbsltTLimSlewStVari;
  float32 LstTblValRateLimrStVari;
  float32 ReInitCntrVal;
  float32 dDutyCycThermProtnAbsltCtrlrTTqLim;
  float32 dDutyCycThermProtnAbsltCuTTqLim;
  float32 dDutyCycThermProtnAbsltTTqLim;
  float32 dDutyCycThermProtnMplr12T;
  float32 dDutyCycThermProtnMplr36T;
  float32 dDutyCycThermProtnThermLoadLim;
  float32 dDutyCycThermProtnThermLoadLimTblYVal;
  u9p7 dDutyCycThermProtnLstTblVal;
  u9p7 dDutyCycThermProtnLstTblValSlew;
  u3p13 dDutyCycThermProtnMplr1;
  u3p13 dDutyCycThermProtnMplr2;
  u3p13 dDutyCycThermProtnMplr3;
  u3p13 dDutyCycThermProtnMplr4;
  u3p13 dDutyCycThermProtnMplr5;
  u3p13 dDutyCycThermProtnMplr6;
  uint8 Fil3ValPwrUp;
  uint8 Fil4ValPwrUp;
  uint8 Fil5ValPwrUp;
  uint8 Fil6ValPwrUp;
  boolean ReInitCntrFlg;
  FilLpRec1 Fil1ValStVari;
  FilLpRec1 Fil2ValStVari;
  DutyCycThermProtnFilStValRec1 FilStVal;
  FilLpRec1 Fild3Val;
  FilLpRec1 Fild4Val;
  FilLpRec1 Fild5Val;
  FilLpRec1 Fild6Val;
  ...
  Ary1D_u9p7_5 DutyCycThermProtnLstTblValNonStall_Ary1D_data;
  Ary1D_u9p7_5 DutyCycThermProtnLstTblValStall_Ary1D_data;
  ...
  Ary1D_u16p0_8 DutyCycThermProtnThermLoadLimTblX_Ary1D_data;
  Ary1D_u9p7_8 DutyCycThermProtnThermLoadLimTblY_Ary1D_data;
  ...
  *************************************************/
  ...
  AbsltTLimSlewStVari = *TSC_DutyCycThermProtn_Rte_Pim_AbsltTLimSlewStVari();
  *TSC_DutyCycThermProtn_Rte_Pim_AbsltTLimSlewStVari() = AbsltTLimSlewStVari;
  LstTblValRateLimrStVari = *TSC_DutyCycThermProtn_Rte_Pim_LstTblValRateLimrStVari();
  *TSC_DutyCycThermProtn_Rte_Pim_LstTblValRateLimrStVari() = LstTblValRateLimrStVari;
  ReInitCntrVal = *TSC_DutyCycThermProtn_Rte_Pim_ReInitCntrVal();
  *TSC_DutyCycThermProtn_Rte_Pim_ReInitCntrVal() = ReInitCntrVal;
  dDutyCycThermProtnAbsltCtrlrTTqLim = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnAbsltCtrlrTTqLim();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnAbsltCtrlrTTqLim() = dDutyCycThermProtnAbsltCtrlrTTqLim;
  dDutyCycThermProtnAbsltCuTTqLim = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnAbsltCuTTqLim();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnAbsltCuTTqLim() = dDutyCycThermProtnAbsltCuTTqLim;
  dDutyCycThermProtnAbsltTTqLim = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnAbsltTTqLim();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnAbsltTTqLim() = dDutyCycThermProtnAbsltTTqLim;
  dDutyCycThermProtnMplr12T = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr12T();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr12T() = dDutyCycThermProtnMplr12T;
  dDutyCycThermProtnMplr36T = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr36T();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr36T() = dDutyCycThermProtnMplr36T;
  dDutyCycThermProtnThermLoadLim = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnThermLoadLim();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnThermLoadLim() = dDutyCycThermProtnThermLoadLim;
  dDutyCycThermProtnThermLoadLimTblYVal = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnThermLoadLimTblYVal();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnThermLoadLimTblYVal() = dDutyCycThermProtnThermLoadLimTblYVal;
  dDutyCycThermProtnLstTblVal = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnLstTblVal();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnLstTblVal() = dDutyCycThermProtnLstTblVal;
  dDutyCycThermProtnLstTblValSlew = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnLstTblValSlew();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnLstTblValSlew() = dDutyCycThermProtnLstTblValSlew;
  dDutyCycThermProtnMplr1 = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr1();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr1() = dDutyCycThermProtnMplr1;
  dDutyCycThermProtnMplr2 = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr2();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr2() = dDutyCycThermProtnMplr2;
  dDutyCycThermProtnMplr3 = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr3();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr3() = dDutyCycThermProtnMplr3;
  dDutyCycThermProtnMplr4 = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr4();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr4() = dDutyCycThermProtnMplr4;
  dDutyCycThermProtnMplr5 = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr5();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr5() = dDutyCycThermProtnMplr5;
  dDutyCycThermProtnMplr6 = *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr6();
  *TSC_DutyCycThermProtn_Rte_Pim_dDutyCycThermProtnMplr6() = dDutyCycThermProtnMplr6;
  Fil3ValPwrUp = *TSC_DutyCycThermProtn_Rte_Pim_Fil3ValPwrUp();
  *TSC_DutyCycThermProtn_Rte_Pim_Fil3ValPwrUp() = Fil3ValPwrUp;
  Fil4ValPwrUp = *TSC_DutyCycThermProtn_Rte_Pim_Fil4ValPwrUp();
  *TSC_DutyCycThermProtn_Rte_Pim_Fil4ValPwrUp() = Fil4ValPwrUp;
  Fil5ValPwrUp = *TSC_DutyCycThermProtn_Rte_Pim_Fil5ValPwrUp();
  *TSC_DutyCycThermProtn_Rte_Pim_Fil5ValPwrUp() = Fil5ValPwrUp;
  Fil6ValPwrUp = *TSC_DutyCycThermProtn_Rte_Pim_Fil6ValPwrUp();
  *TSC_DutyCycThermProtn_Rte_Pim_Fil6ValPwrUp() = Fil6ValPwrUp;
  ReInitCntrFlg = *TSC_DutyCycThermProtn_Rte_Pim_ReInitCntrFlg();
  *TSC_DutyCycThermProtn_Rte_Pim_ReInitCntrFlg() = ReInitCntrFlg;
  Fil1ValStVari = *TSC_DutyCycThermProtn_Rte_Pim_Fil1ValStVari();
  *TSC_DutyCycThermProtn_Rte_Pim_Fil1ValStVari() = Fil1ValStVari;
  Fil2ValStVari = *TSC_DutyCycThermProtn_Rte_Pim_Fil2ValStVari();
  *TSC_DutyCycThermProtn_Rte_Pim_Fil2ValStVari() = Fil2ValStVari;
  FilStVal = *TSC_DutyCycThermProtn_Rte_Pim_FilStVal();
  *TSC_DutyCycThermProtn_Rte_Pim_FilStVal() = FilStVal;
  Fild3Val = *TSC_DutyCycThermProtn_Rte_Pim_Fild3Val();
  *TSC_DutyCycThermProtn_Rte_Pim_Fild3Val() = Fild3Val;
  Fild4Val = *TSC_DutyCycThermProtn_Rte_Pim_Fild4Val();
  *TSC_DutyCycThermProtn_Rte_Pim_Fild4Val() = Fild4Val;
  Fild5Val = *TSC_DutyCycThermProtn_Rte_Pim_Fild5Val();
  *TSC_DutyCycThermProtn_Rte_Pim_Fild5Val() = Fild5Val;
  Fild6Val = *TSC_DutyCycThermProtn_Rte_Pim_Fild6Val();
  *TSC_DutyCycThermProtn_Rte_Pim_Fild6Val() = Fild6Val;
  ...
  (void)memcpy(DutyCycThermProtnLstTblValNonStall_Ary1D_data, TSC_DutyCycThermProtn_Rte_Prm_DutyCycThermProtnLstTblValNonStall_Ary1D(), sizeof(Ary1D_u9p7_5));
  (void)memcpy(DutyCycThermProtnLstTblValStall_Ary1D_data, TSC_DutyCycThermProtn_Rte_Prm_DutyCycThermProtnLstTblValStall_Ary1D(), sizeof(Ary1D_u9p7_5));
  ...
  (void)memcpy(DutyCycThermProtnThermLoadLimTblX_Ary1D_data, TSC_DutyCycThermProtn_Rte_Prm_DutyCycThermProtnThermLoadLimTblX_Ary1D(), sizeof(Ary1D_u16p0_8));
  (void)memcpy(DutyCycThermProtnThermLoadLimTblY_Ary1D_data, TSC_DutyCycThermProtn_Rte_Prm_DutyCycThermProtnThermLoadLimTblY_Ary1D(), sizeof(Ary1D_u9p7_8));
