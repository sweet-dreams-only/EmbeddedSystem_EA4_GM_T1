...
#include "Rte_GmMsg4D1BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg4D1BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg4D1BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_EngOilTRaw_Val;
  uint8 Read_EngOilVldRaw_Val;
  uint32 Read_LstRxnTiMsg4D1_Val;

  uint32 GmMsg4D1BusHiSpdInvldMsgTmr;

  float32 GmMsg4D1BusHiSpdEngOilTDft_Val_data;
  uint16 GmMsg4D1BusHiSpdInvldTiOut_Val_data;
  uint16 GmMsg4D1BusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg4D1BusHiSpdInvldMsgTmr = *TSC_GmMsg4D1BusHiSpd_Rte_Pim_GmMsg4D1BusHiSpdInvldMsgTmr();
  *TSC_GmMsg4D1BusHiSpd_Rte_Pim_GmMsg4D1BusHiSpdInvldMsgTmr() = GmMsg4D1BusHiSpdInvldMsgTmr;

  GmMsg4D1BusHiSpdEngOilTDft_Val_data = TSC_GmMsg4D1BusHiSpd_Rte_Prm_GmMsg4D1BusHiSpdEngOilTDft_Val();
  GmMsg4D1BusHiSpdInvldTiOut_Val_data = TSC_GmMsg4D1BusHiSpd_Rte_Prm_GmMsg4D1BusHiSpdInvldTiOut_Val();
  GmMsg4D1BusHiSpdMissTiOut_Val_data = TSC_GmMsg4D1BusHiSpd_Rte_Prm_GmMsg4D1BusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Read_EngOilTRaw_Val(&Read_EngOilTRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Read_EngOilVldRaw_Val(&Read_EngOilVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Read_LstRxnTiMsg4D1_Val(&Read_LstRxnTiMsg4D1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Write_EngOilT_Val(Rte_InitValue_EngOilT_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg4D1BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
