...
#include "Rte_GmMsg182BusChassisExp.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg182BusChassisExp_TestDefines(void);
 ...
 * Symbol: GmMsg182BusChassisExpInit1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 GmMsg182BusChassisExpPrevVehLgtA;
  uint32 GmMsg182BusChassisExpInvldTmr;

  uint16 GmMsg182BusChassisExpInvldTiOut_Val_data;
  uint16 GmMsg182BusChassisExpMissTiOut_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  GmMsg182BusChassisExpPrevVehLgtA = *TSC_GmMsg182BusChassisExp_Rte_Pim_GmMsg182BusChassisExpPrevVehLgtA();
  *TSC_GmMsg182BusChassisExp_Rte_Pim_GmMsg182BusChassisExpPrevVehLgtA() = GmMsg182BusChassisExpPrevVehLgtA;
  GmMsg182BusChassisExpInvldTmr = *TSC_GmMsg182BusChassisExp_Rte_Pim_GmMsg182BusChassisExpInvldTmr();
  *TSC_GmMsg182BusChassisExp_Rte_Pim_GmMsg182BusChassisExpInvldTmr() = GmMsg182BusChassisExpInvldTmr;

  GmMsg182BusChassisExpInvldTiOut_Val_data = TSC_GmMsg182BusChassisExp_Rte_Prm_GmMsg182BusChassisExpInvldTiOut_Val();
  GmMsg182BusChassisExpMissTiOut_Val_data = TSC_GmMsg182BusChassisExp_Rte_Prm_GmMsg182BusChassisExpMissTiOut_Val();

  GmMsg182BusChassisExp_TestDefines();
 ...
 *   Std_ReturnType Rte_Read_VehDynOverUnderSteerVldRaw_Val(uint8 *data)
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GmMsg182BusChassisExpPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint32 Read_LstRxnTiMsg182_Val;
  uint8 Read_VehDynOverUnderSteerVldRaw_Val;
  uint16 Read_VehStabyEnhmtLgtALoReslRaw_Val;
  uint8 Read_VehStabyEnhmtLgtALoReslVldRaw_Val;
  ...
  *TSC_GmMsg182BusChassisExp_Rte_Pim_GmMsg182BusChassisExpInvldTmr() = GmMsg182BusChassisExpInvldTmr;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Read_LstRxnTiMsg182_Val(&Read_LstRxnTiMsg182_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Read_VehDynOverUnderSteerVldRaw_Val(&Read_VehDynOverUnderSteerVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Read_VehStabyEnhmtLgtALoReslRaw_Val(&Read_VehStabyEnhmtLgtALoReslRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Read_VehStabyEnhmtLgtALoReslVldRaw_Val(&Read_VehStabyEnhmtLgtALoReslVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Write_SerlComVehLgtA_Val(Rte_InitValue_SerlComVehLgtA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg182BusChassisExp_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
