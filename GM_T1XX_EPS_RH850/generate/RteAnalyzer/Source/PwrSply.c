 ...
 *********************************************************************************************************************/
  ...
  boolean PwrSplyReadWrOrderFlg1;
  boolean PwrSplyReadWrOrderFlg2;
  boolean PwrSplyStrtUpSelfTestCmpl;
  ...
  *************************************************/
  ...
  PwrSplyReadWrOrderFlg1 = *TSC_PwrSply_Rte_Pim_PwrSplyReadWrOrderFlg1();
  *TSC_PwrSply_Rte_Pim_PwrSplyReadWrOrderFlg1() = PwrSplyReadWrOrderFlg1;
  PwrSplyReadWrOrderFlg2 = *TSC_PwrSply_Rte_Pim_PwrSplyReadWrOrderFlg2();
  *TSC_PwrSply_Rte_Pim_PwrSplyReadWrOrderFlg2() = PwrSplyReadWrOrderFlg2;
  PwrSplyStrtUpSelfTestCmpl = *TSC_PwrSply_Rte_Pim_PwrSplyStrtUpSelfTestCmpl();
  *TSC_PwrSply_Rte_Pim_PwrSplyStrtUpSelfTestCmpl() = PwrSplyStrtUpSelfTestCmpl;
