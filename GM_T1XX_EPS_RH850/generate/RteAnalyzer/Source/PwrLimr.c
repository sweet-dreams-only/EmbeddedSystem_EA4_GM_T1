 ...
 *********************************************************************************************************************/
  ...
  float32 BrdgVltgAdjSlewStVari;
  float32 PrevBrdgVltgAltFltAdjLim;
  float32 PrevSpdAdj;
  float32 SpdAdjSlewStVari;
  float32 dPwrLimrFildMotVel;
  float32 dPwrLimrLimDif;
  float32 dPwrLimrMinStdOperLim;
  float32 dPwrLimrMotEnvlpSpd;
  float32 dPwrLimrMotTqCmdIvtrLoaSca;
  float32 dPwrLimrOutpVelOffs;
  float32 dPwrLimrSpdAdj;
  float32 dPwrLimrTLimMaxCurr;
  float32 dPwrLimrTqEnvlpLim1;
  float32 dPwrLimrTqEnvlpLim4;
  float32 dPwrLimrTqLim;
  float32 dPwrLimrTqLim1;
  float32 dPwrLimrTqLim4;
  uint32 FltRefTi;
  boolean PrevThd;
  FilLpRec1 MotVelLpFil;
  FilLpRec1 TqLimAssiRednLpFil;
  ...
  *************************************************/
  ...
  BrdgVltgAdjSlewStVari = *TSC_PwrLimr_Rte_Pim_BrdgVltgAdjSlewStVari();
  *TSC_PwrLimr_Rte_Pim_BrdgVltgAdjSlewStVari() = BrdgVltgAdjSlewStVari;
  PrevBrdgVltgAltFltAdjLim = *TSC_PwrLimr_Rte_Pim_PrevBrdgVltgAltFltAdjLim();
  *TSC_PwrLimr_Rte_Pim_PrevBrdgVltgAltFltAdjLim() = PrevBrdgVltgAltFltAdjLim;
  PrevSpdAdj = *TSC_PwrLimr_Rte_Pim_PrevSpdAdj();
  *TSC_PwrLimr_Rte_Pim_PrevSpdAdj() = PrevSpdAdj;
  SpdAdjSlewStVari = *TSC_PwrLimr_Rte_Pim_SpdAdjSlewStVari();
  *TSC_PwrLimr_Rte_Pim_SpdAdjSlewStVari() = SpdAdjSlewStVari;
  dPwrLimrFildMotVel = *TSC_PwrLimr_Rte_Pim_dPwrLimrFildMotVel();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrFildMotVel() = dPwrLimrFildMotVel;
  dPwrLimrLimDif = *TSC_PwrLimr_Rte_Pim_dPwrLimrLimDif();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrLimDif() = dPwrLimrLimDif;
  dPwrLimrMinStdOperLim = *TSC_PwrLimr_Rte_Pim_dPwrLimrMinStdOperLim();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrMinStdOperLim() = dPwrLimrMinStdOperLim;
  dPwrLimrMotEnvlpSpd = *TSC_PwrLimr_Rte_Pim_dPwrLimrMotEnvlpSpd();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrMotEnvlpSpd() = dPwrLimrMotEnvlpSpd;
  dPwrLimrMotTqCmdIvtrLoaSca = *TSC_PwrLimr_Rte_Pim_dPwrLimrMotTqCmdIvtrLoaSca();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrMotTqCmdIvtrLoaSca() = dPwrLimrMotTqCmdIvtrLoaSca;
  dPwrLimrOutpVelOffs = *TSC_PwrLimr_Rte_Pim_dPwrLimrOutpVelOffs();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrOutpVelOffs() = dPwrLimrOutpVelOffs;
  dPwrLimrSpdAdj = *TSC_PwrLimr_Rte_Pim_dPwrLimrSpdAdj();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrSpdAdj() = dPwrLimrSpdAdj;
  dPwrLimrTLimMaxCurr = *TSC_PwrLimr_Rte_Pim_dPwrLimrTLimMaxCurr();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTLimMaxCurr() = dPwrLimrTLimMaxCurr;
  dPwrLimrTqEnvlpLim1 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim1();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim1() = dPwrLimrTqEnvlpLim1;
  dPwrLimrTqEnvlpLim4 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim4();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim4() = dPwrLimrTqEnvlpLim4;
  dPwrLimrTqLim = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim() = dPwrLimrTqLim;
  dPwrLimrTqLim1 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim1();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim1() = dPwrLimrTqLim1;
  dPwrLimrTqLim4 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim4();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim4() = dPwrLimrTqLim4;
  FltRefTi = *TSC_PwrLimr_Rte_Pim_FltRefTi();
  *TSC_PwrLimr_Rte_Pim_FltRefTi() = FltRefTi;
  PrevThd = *TSC_PwrLimr_Rte_Pim_PrevThd();
  *TSC_PwrLimr_Rte_Pim_PrevThd() = PrevThd;
  MotVelLpFil = *TSC_PwrLimr_Rte_Pim_MotVelLpFil();
  *TSC_PwrLimr_Rte_Pim_MotVelLpFil() = MotVelLpFil;
  TqLimAssiRednLpFil = *TSC_PwrLimr_Rte_Pim_TqLimAssiRednLpFil();
  *TSC_PwrLimr_Rte_Pim_TqLimAssiRednLpFil() = TqLimAssiRednLpFil;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_PwrLimr_Rte_Pim_TqLimAssiRednLpFil() = TqLimAssiRednLpFil;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_IvtrLoaMtgtnEna_Logl(&Read_IvtrLoaMtgtnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
