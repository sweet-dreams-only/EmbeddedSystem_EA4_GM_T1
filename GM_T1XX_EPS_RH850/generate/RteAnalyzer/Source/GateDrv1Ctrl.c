...
#include "Rte_GateDrv1Ctrl.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GateDrv1Ctrl_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint16 GateDrv1Diag0Val;
  uint16 GateDrv1Diag1Val;
  uint16 GateDrv1Diag2Val;
  uint16 GateDrv1StsVal;
  uint16 GateDrv1VrfyRes0Val;
  uint16 GateDrv1VrfyRes1Val;
  uint16 dGateDrv1CtrlGateDrv1Diag0Val;
  uint16 dGateDrv1CtrlGateDrv1Diag1Val;
  uint16 dGateDrv1CtrlGateDrv1Diag2Val;
  uint16 dGateDrv1CtrlGateDrv1StsVal;
  uint16 dGateDrv1CtrlGateDrv1VrfyRes0Val;
  uint16 dGateDrv1CtrlGateDrv1VrfyRes1Val;
  uint8 GateDrv1CfgCnt;
  uint8 GateDrv1OffStChkIdx;
  uint8 GateDrv1OffStCnt;
  uint8 GateDrv1St;
  uint8 Ivtr1BootstrpSplyFltPrmVal;
  uint8 Ivtr1GenericFltPrmVal;
  uint8 dGateDrv1CtrlGateDrv1OffsStVrfyPrmBitIdx;
  boolean GateDrv1CfgSecAtmpt;
  boolean GateDrv1OffStChkSecAtmpt;
  boolean Ivtr1OffStChkCmpl;

  uint16 GateDrv1CtrlNtcNr0x060FailStep_Val_data;
  uint16 GateDrv1CtrlNtcNr0x060PassStep_Val_data;
  uint16 GateDrv1CtrlNtcNr0x061FailStep_Val_data;
  uint16 GateDrv1CtrlNtcNr0x061PassStep_Val_data;
  uint16 GateDrv1CtrlNtcNr0x065FailStep_Val_data;
  uint16 GateDrv1CtrlNtcNr0x065PassStep_Val_data;
  uint16 GateDrv1CtrlUnit1Cfg2WrVal_Val_data;
  uint16 GateDrv1CtrlUnit1Cfg3WrVal_Val_data;
  uint16 GateDrv1CtrlUnit1Cfg4WrVal_Val_data;
  uint16 GateDrv1CtrlUnit1Cfg7WrVal_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  GateDrv1Diag0Val = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1Diag0Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1Diag0Val() = GateDrv1Diag0Val;
  GateDrv1Diag1Val = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1Diag1Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1Diag1Val() = GateDrv1Diag1Val;
  GateDrv1Diag2Val = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1Diag2Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1Diag2Val() = GateDrv1Diag2Val;
  GateDrv1StsVal = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1StsVal();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1StsVal() = GateDrv1StsVal;
  GateDrv1VrfyRes0Val = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1VrfyRes0Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1VrfyRes0Val() = GateDrv1VrfyRes0Val;
  GateDrv1VrfyRes1Val = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1VrfyRes1Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1VrfyRes1Val() = GateDrv1VrfyRes1Val;
  dGateDrv1CtrlGateDrv1Diag0Val = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1Diag0Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1Diag0Val() = dGateDrv1CtrlGateDrv1Diag0Val;
  dGateDrv1CtrlGateDrv1Diag1Val = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1Diag1Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1Diag1Val() = dGateDrv1CtrlGateDrv1Diag1Val;
  dGateDrv1CtrlGateDrv1Diag2Val = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1Diag2Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1Diag2Val() = dGateDrv1CtrlGateDrv1Diag2Val;
  dGateDrv1CtrlGateDrv1StsVal = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1StsVal();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1StsVal() = dGateDrv1CtrlGateDrv1StsVal;
  dGateDrv1CtrlGateDrv1VrfyRes0Val = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1VrfyRes0Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1VrfyRes0Val() = dGateDrv1CtrlGateDrv1VrfyRes0Val;
  dGateDrv1CtrlGateDrv1VrfyRes1Val = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1VrfyRes1Val();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1VrfyRes1Val() = dGateDrv1CtrlGateDrv1VrfyRes1Val;
  GateDrv1CfgCnt = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1CfgCnt();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1CfgCnt() = GateDrv1CfgCnt;
  GateDrv1OffStChkIdx = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1OffStChkIdx();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1OffStChkIdx() = GateDrv1OffStChkIdx;
  GateDrv1OffStCnt = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1OffStCnt();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1OffStCnt() = GateDrv1OffStCnt;
  GateDrv1St = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1St();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1St() = GateDrv1St;
  Ivtr1BootstrpSplyFltPrmVal = *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1BootstrpSplyFltPrmVal();
  *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1BootstrpSplyFltPrmVal() = Ivtr1BootstrpSplyFltPrmVal;
  Ivtr1GenericFltPrmVal = *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1GenericFltPrmVal();
  *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1GenericFltPrmVal() = Ivtr1GenericFltPrmVal;
  dGateDrv1CtrlGateDrv1OffsStVrfyPrmBitIdx = *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1OffsStVrfyPrmBitIdx();
  *TSC_GateDrv1Ctrl_Rte_Pim_dGateDrv1CtrlGateDrv1OffsStVrfyPrmBitIdx() = dGateDrv1CtrlGateDrv1OffsStVrfyPrmBitIdx;
  GateDrv1CfgSecAtmpt = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1CfgSecAtmpt();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1CfgSecAtmpt() = GateDrv1CfgSecAtmpt;
  GateDrv1OffStChkSecAtmpt = *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1OffStChkSecAtmpt();
  *TSC_GateDrv1Ctrl_Rte_Pim_GateDrv1OffStChkSecAtmpt() = GateDrv1OffStChkSecAtmpt;
  Ivtr1OffStChkCmpl = *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1OffStChkCmpl();
  *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1OffStChkCmpl() = Ivtr1OffStChkCmpl;

  GateDrv1CtrlNtcNr0x060FailStep_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlNtcNr0x060FailStep_Val();
  GateDrv1CtrlNtcNr0x060PassStep_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlNtcNr0x060PassStep_Val();
  GateDrv1CtrlNtcNr0x061FailStep_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlNtcNr0x061FailStep_Val();
  GateDrv1CtrlNtcNr0x061PassStep_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlNtcNr0x061PassStep_Val();
  GateDrv1CtrlNtcNr0x065FailStep_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlNtcNr0x065FailStep_Val();
  GateDrv1CtrlNtcNr0x065PassStep_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlNtcNr0x065PassStep_Val();
  GateDrv1CtrlUnit1Cfg2WrVal_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlUnit1Cfg2WrVal_Val();
  GateDrv1CtrlUnit1Cfg3WrVal_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlUnit1Cfg3WrVal_Val();
  GateDrv1CtrlUnit1Cfg4WrVal_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlUnit1Cfg4WrVal_Val();
  GateDrv1CtrlUnit1Cfg7WrVal_Val_data = TSC_GateDrv1Ctrl_Rte_Prm_GateDrv1CtrlUnit1Cfg7WrVal_Val();

  GateDrv1Ctrl_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  boolean Call_IoHwAb_GetGpioMotDrvr1Diag_Oper_PinSt_Arg = FALSE;
  ...
  *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1OffStChkCmpl() = Ivtr1OffStChkCmpl;
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Read_DiagcStsIvtr2Inactv_Logl(&Read_DiagcStsIvtr2Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Read_StrtUpSt_Val(&Read_StrtUpSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_GateDrv1Ctrl_Rte_IrvWrite_GateDrv1CtrlPer1_GateDrv1Ena(FALSE);
  TSC_GateDrv1Ctrl_Rte_IrvWrite_GateDrv1CtrlPer1_Ivtr1PhyFltInpActv(FALSE);

  fct_status = TSC_GateDrv1Ctrl_Rte_Call_IoHwAb_GetGpioMotDrvr1Diag_Oper(&Call_IoHwAb_GetGpioMotDrvr1Diag_Oper_PinSt_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Call_IoHwAb_SetGpioGateDrv1Rst_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean GateDrv1CtrlPer2_GateDrv1Ena;
  boolean GateDrv1CtrlPer2_Ivtr1PhyFltInpActv;
  ...
  *TSC_GateDrv1Ctrl_Rte_Pim_Ivtr1OffStChkCmpl() = Ivtr1OffStChkCmpl;
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Write_MotDrvr1IninTestCmpl_Logl(Rte_InitValue_MotDrvr1IninTestCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  GateDrv1CtrlPer2_GateDrv1Ena = TSC_GateDrv1Ctrl_Rte_IrvRead_GateDrv1CtrlPer2_GateDrv1Ena();
  GateDrv1CtrlPer2_Ivtr1PhyFltInpActv = TSC_GateDrv1Ctrl_Rte_IrvRead_GateDrv1CtrlPer2_Ivtr1PhyFltInpActv();
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Call_IoHwAb_SetGpioSysFlt2B_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv1Ctrl_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
