...
#include "Rte_RtnPahFwl.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void RtnPahFwl_TestDefines(void);
 ...
 *     Returnvalue: s4p11* is of type Ary2D_s4p11_11_8
 ...
 *********************************************************************************************************************/
  ...
  float32 dRtnPahFwlLowrBnd;
  float32 dRtnPahFwlUpprBnd;
  boolean dRtnPahFwlOverBnd;

  Ary1D_s11p4_11 RtnPahFwlUpprBndTblX_Ary1D_data;
  Ary2D_s4p11_11_8 RtnPahFwlUpprBndTblY_Ary2D_data;
  Ary1D_u9p7_8 RtnPahFwlVehSpd_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  dRtnPahFwlLowrBnd = *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlLowrBnd();
  *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlLowrBnd() = dRtnPahFwlLowrBnd;
  dRtnPahFwlUpprBnd = *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlUpprBnd();
  *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlUpprBnd() = dRtnPahFwlUpprBnd;
  dRtnPahFwlOverBnd = *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlOverBnd();
  *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlOverBnd() = dRtnPahFwlOverBnd;

  (void)memcpy(RtnPahFwlUpprBndTblX_Ary1D_data, TSC_RtnPahFwl_Rte_Prm_RtnPahFwlUpprBndTblX_Ary1D(), sizeof(Ary1D_s11p4_11));
  (void)memcpy(RtnPahFwlUpprBndTblY_Ary2D_data, TSC_RtnPahFwl_Rte_Prm_RtnPahFwlUpprBndTblY_Ary2D(), sizeof(Ary2D_s4p11_11_8));
  (void)memcpy(RtnPahFwlVehSpd_Ary1D_data, TSC_RtnPahFwl_Rte_Prm_RtnPahFwlVehSpd_Ary1D(), sizeof(Ary1D_u9p7_8));

  fct_status = TSC_RtnPahFwl_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_RtnPahFwl_Rte_Pim_dRtnPahFwlOverBnd() = dRtnPahFwlOverBnd;
  ...
  fct_status = TSC_RtnPahFwl_Rte_Read_HwAg_Val(&Read_HwAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RtnPahFwl_Rte_Read_MfgEnaSt_Val(&Read_MfgEnaSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RtnPahFwl_Rte_Read_RtnCmd_Val(&Read_RtnCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RtnPahFwl_Rte_Read_RtnCmdDi_Logl(&Read_RtnCmdDi_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RtnPahFwl_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RtnPahFwl_Rte_Write_RtnCmdLimd_Val(Rte_InitValue_RtnCmdLimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
