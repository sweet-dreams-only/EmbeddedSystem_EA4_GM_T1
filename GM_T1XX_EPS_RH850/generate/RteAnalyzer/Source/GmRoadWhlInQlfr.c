...
#include "Rte_GmRoadWhlInQlfr.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmRoadWhlInQlfr_TestDefines(void);
 ...
 * Symbol: GmRoadWhlInQlfrInit1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 PrevLeWhlFrq;
  float32 PrevRawLeWhlFrq;
  float32 PrevRawRiWhlFrq;
  float32 PrevRiWhlFrq;
  float32 dGmRoadWhlInQlfrRawLeWhlFrq;
  float32 dGmRoadWhlInQlfrRawRiWhlFrq;
  uint32 PrevVldTiLeFrqChg;
  uint32 PrevVldTiRiFrqChg;
  uint16 PrevVldLeWhlDstPlsCntr;
  uint16 PrevVldLeWhlDstTiStamp;
  uint16 PrevVldRiWhlDstPlsCntr;
  uint16 PrevVldRiWhlDstTiStamp;
  uint16 dGmRoadWhlInQlfrLeDeltaPls;
  uint16 dGmRoadWhlInQlfrLeDeltaTiStamp;
  uint16 dGmRoadWhlInQlfrRiDeltaPls;
  uint16 dGmRoadWhlInQlfrRiDeltaTiStamp;
  boolean PrevLeWhlFrqVld;
  boolean PrevRiWhlFrqVld;
  boolean dGmRoadWhlInQlfrLeWhlFrqVld;
  boolean dGmRoadWhlInQlfrRiWhlFrqVld;

  float32 GmRoadWhlInQlfrMaxAllwblFrq_Val_data;
  float32 GmRoadWhlInQlfrMaxFrqChg_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PrevLeWhlFrq = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevLeWhlFrq();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevLeWhlFrq() = PrevLeWhlFrq;
  PrevRawLeWhlFrq = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRawLeWhlFrq();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRawLeWhlFrq() = PrevRawLeWhlFrq;
  PrevRawRiWhlFrq = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRawRiWhlFrq();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRawRiWhlFrq() = PrevRawRiWhlFrq;
  PrevRiWhlFrq = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRiWhlFrq();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRiWhlFrq() = PrevRiWhlFrq;
  dGmRoadWhlInQlfrRawLeWhlFrq = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRawLeWhlFrq();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRawLeWhlFrq() = dGmRoadWhlInQlfrRawLeWhlFrq;
  dGmRoadWhlInQlfrRawRiWhlFrq = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRawRiWhlFrq();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRawRiWhlFrq() = dGmRoadWhlInQlfrRawRiWhlFrq;
  PrevVldTiLeFrqChg = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldTiLeFrqChg();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldTiLeFrqChg() = PrevVldTiLeFrqChg;
  PrevVldTiRiFrqChg = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldTiRiFrqChg();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldTiRiFrqChg() = PrevVldTiRiFrqChg;
  PrevVldLeWhlDstPlsCntr = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldLeWhlDstPlsCntr();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldLeWhlDstPlsCntr() = PrevVldLeWhlDstPlsCntr;
  PrevVldLeWhlDstTiStamp = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldLeWhlDstTiStamp();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldLeWhlDstTiStamp() = PrevVldLeWhlDstTiStamp;
  PrevVldRiWhlDstPlsCntr = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldRiWhlDstPlsCntr();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldRiWhlDstPlsCntr() = PrevVldRiWhlDstPlsCntr;
  PrevVldRiWhlDstTiStamp = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldRiWhlDstTiStamp();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevVldRiWhlDstTiStamp() = PrevVldRiWhlDstTiStamp;
  dGmRoadWhlInQlfrLeDeltaPls = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrLeDeltaPls();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrLeDeltaPls() = dGmRoadWhlInQlfrLeDeltaPls;
  dGmRoadWhlInQlfrLeDeltaTiStamp = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrLeDeltaTiStamp();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrLeDeltaTiStamp() = dGmRoadWhlInQlfrLeDeltaTiStamp;
  dGmRoadWhlInQlfrRiDeltaPls = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiDeltaPls();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiDeltaPls() = dGmRoadWhlInQlfrRiDeltaPls;
  dGmRoadWhlInQlfrRiDeltaTiStamp = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiDeltaTiStamp();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiDeltaTiStamp() = dGmRoadWhlInQlfrRiDeltaTiStamp;
  PrevLeWhlFrqVld = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevLeWhlFrqVld();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevLeWhlFrqVld() = PrevLeWhlFrqVld;
  PrevRiWhlFrqVld = *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRiWhlFrqVld();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_PrevRiWhlFrqVld() = PrevRiWhlFrqVld;
  dGmRoadWhlInQlfrLeWhlFrqVld = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrLeWhlFrqVld();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrLeWhlFrqVld() = dGmRoadWhlInQlfrLeWhlFrqVld;
  dGmRoadWhlInQlfrRiWhlFrqVld = *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiWhlFrqVld();
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiWhlFrqVld() = dGmRoadWhlInQlfrRiWhlFrqVld;

  GmRoadWhlInQlfrMaxAllwblFrq_Val_data = TSC_GmRoadWhlInQlfr_Rte_Prm_GmRoadWhlInQlfrMaxAllwblFrq_Val();
  GmRoadWhlInQlfrMaxFrqChg_Val_data = TSC_GmRoadWhlInQlfr_Rte_Prm_GmRoadWhlInQlfrMaxFrqChg_Val();

  fct_status = TSC_GmRoadWhlInQlfr_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GmRoadWhlInQlfrPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint16 Read_WhlLeDstPlsCntr_Val;
  uint16 Read_WhlLeDstTiStamp_Val;
  boolean Read_WhlLeDstVld_Logl;
  uint8 Read_WhlPlsPerRev_Val;
  uint16 Read_WhlRiDstPlsCntr_Val;
  uint16 Read_WhlRiDstTiStamp_Val;
  boolean Read_WhlRiDstVld_Logl;
  float32 Read_WhlRotlStsTiStampResl_Val;
  ...
  *TSC_GmRoadWhlInQlfr_Rte_Pim_dGmRoadWhlInQlfrRiWhlFrqVld() = dGmRoadWhlInQlfrRiWhlFrqVld;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlLeDstPlsCntr_Val(&Read_WhlLeDstPlsCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlLeDstTiStamp_Val(&Read_WhlLeDstTiStamp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlLeDstVld_Logl(&Read_WhlLeDstVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlPlsPerRev_Val(&Read_WhlPlsPerRev_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlRiDstPlsCntr_Val(&Read_WhlRiDstPlsCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlRiDstTiStamp_Val(&Read_WhlRiDstTiStamp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlRiDstVld_Logl(&Read_WhlRiDstVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Read_WhlRotlStsTiStampResl_Val(&Read_WhlRotlStsTiStampResl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Write_WhlFrqVld_Logl(Rte_InitValue_WhlFrqVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Write_WhlLeFrq_Val(Rte_InitValue_WhlLeFrq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Write_WhlRiFrq_Val(Rte_InitValue_WhlRiFrq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmRoadWhlInQlfr_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
