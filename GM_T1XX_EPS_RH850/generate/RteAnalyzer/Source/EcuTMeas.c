 ...
 *********************************************************************************************************************/
  ...
  FilLpRec1 EcuTMeasFilStVarPrev;

  float32 EcuTMeasDftT_Val_data;
  float32 EcuTMeasFilTau_Val_data;
  float32 EcuTMeasRngDiagcMax_Val_data;
  float32 EcuTMeasRngDiagcMin_Val_data;
  float32 EcuTMeasScag_Val_data;
  float32 EcuTMeasScagOffs_Val_data;
  uint16 EcuTMeasNtc0x045FailStep_Val_data;
  uint16 EcuTMeasNtc0x045PassStep_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  EcuTMeasFilStVarPrev = *TSC_EcuTMeas_Rte_Pim_EcuTMeasFilStVarPrev();
  *TSC_EcuTMeas_Rte_Pim_EcuTMeasFilStVarPrev() = EcuTMeasFilStVarPrev;

  EcuTMeasDftT_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasDftT_Val();
  EcuTMeasFilTau_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasFilTau_Val();
  EcuTMeasRngDiagcMax_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasRngDiagcMax_Val();
  EcuTMeasRngDiagcMin_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasRngDiagcMin_Val();
  EcuTMeasScag_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasScag_Val();
  EcuTMeasScagOffs_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasScagOffs_Val();
  EcuTMeasNtc0x045FailStep_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasNtc0x045FailStep_Val();
  EcuTMeasNtc0x045PassStep_Val_data = TSC_EcuTMeas_Rte_Prm_EcuTMeasNtc0x045PassStep_Val();
  ...
  fct_status = TSC_EcuTMeas_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_EcuTMeas_Rte_Pim_EcuTMeasFilStVarPrev() = EcuTMeasFilStVarPrev;
  ...
  fct_status = TSC_EcuTMeas_Rte_Read_DiagcStsLimdTPrfmnc_Logl(&Read_DiagcStsLimdTPrfmnc_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void EcuTMeas_TestDefines(void)
{
  ...
  float32 Test_float32_LL_1 = Frq1_LowerLimit;
  float32 Test_float32_UL_1 = Frq1_UpperLimit;
  float32 Test_float32_LL_2 = Gain1_LowerLimit;
  float32 Test_float32_UL_2 = Gain1_UpperLimit;
  float32 Test_float32_LL_3 = T1_LowerLimit;
  float32 Test_float32_UL_3 = T1_UpperLimit;
  float32 Test_float32_LL_4 = T2_LowerLimit;
  float32 Test_float32_UL_4 = T2_UpperLimit;
  float32 Test_float32_LL_5 = T4_LowerLimit;
  float32 Test_float32_UL_5 = T4_UpperLimit;
  float32 Test_float32_LL_6 = Volt3_LowerLimit;
  float32 Test_float32_UL_6 = Volt3_UpperLimit;
