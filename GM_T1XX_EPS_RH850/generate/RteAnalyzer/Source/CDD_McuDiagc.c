 ...
 *********************************************************************************************************************/
  ...
  uint16 FastLoopCntrPrev;
  uint16 LoopCntr2MilliSecStore;
  uint16 LoopCntrPrev;
  uint16 dMcuDiagcFastLoopCntrMax;
  uint16 dMcuDiagcFastLoopCntrMin;
  uint16 dMcuDiagcLoopCntr2MilliSecMotCtrlDif;
  uint8 FastLoopCntrDiagcCfgd;
  ...
  *************************************************/
  ...
  FastLoopCntrPrev = *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrPrev();
  *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrPrev() = FastLoopCntrPrev;
  LoopCntr2MilliSecStore = *TSC_CDD_McuDiagc_Rte_Pim_LoopCntr2MilliSecStore();
  *TSC_CDD_McuDiagc_Rte_Pim_LoopCntr2MilliSecStore() = LoopCntr2MilliSecStore;
  LoopCntrPrev = *TSC_CDD_McuDiagc_Rte_Pim_LoopCntrPrev();
  *TSC_CDD_McuDiagc_Rte_Pim_LoopCntrPrev() = LoopCntrPrev;
  dMcuDiagcFastLoopCntrMax = *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMax();
  *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMax() = dMcuDiagcFastLoopCntrMax;
  dMcuDiagcFastLoopCntrMin = *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMin();
  *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMin() = dMcuDiagcFastLoopCntrMin;
  dMcuDiagcLoopCntr2MilliSecMotCtrlDif = *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcLoopCntr2MilliSecMotCtrlDif();
  *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcLoopCntr2MilliSecMotCtrlDif() = dMcuDiagcLoopCntr2MilliSecMotCtrlDif;
  FastLoopCntrDiagcCfgd = *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrDiagcCfgd();
  *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrDiagcCfgd() = FastLoopCntrDiagcCfgd;
