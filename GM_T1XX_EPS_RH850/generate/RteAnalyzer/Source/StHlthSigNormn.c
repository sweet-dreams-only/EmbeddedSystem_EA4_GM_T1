...
#include "Rte_StHlthSigNormn.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void StHlthSigNormn_TestDefines(void);
 ...
 * Symbol: StHlthSigNormnInit1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  u0p16 MotAgCorrlnErrThd;
  uint8 AbsltMotPosABDifStHlthSts;
  uint8 AbsltMotPosACDifStHlthSts;
  uint8 AbsltMotPosBCDifStHlthSts;
  uint8 CurrMotSumABCStHlthSts;
  uint8 CurrMotSumDEFStHlthSts;
  uint8 DigTqIdptSigStHlthSts;
  uint8 DigTqSnsrAStHlthSts;
  uint8 DigTqSnsrBStHlthSts;
  uint8 EcuTRngIgnCyc;
  uint8 EotImpctCntr;
  uint8 MotPosStHlthSts;
  uint8 PhaAStHlthSts;
  uint8 PhaBStHlthSts;
  uint8 PhaCStHlthSts;
  uint8 PhaDStHlthSts;
  ...
  float32 EcuTMeasRngDiagcMax_Val_data;
  float32 EcuTMeasRngDiagcMin_Val_data;
  float32 EotLrngAuthyStrtLrn_Val_data;
  float32 HwTqCorrlnChATraSumSetFltThd_Val_data;
  float32 HwTqCorrlnChBTraSumSetFltThd_Val_data;
  float32 StHlthSigNormnHiCtrlrT_Val_data;
  float32 StHlthSigNormnLoCtrlrT_Val_data;
  float32 StHlthSigNormnMaxFricThd_Val_data;
  float32 StHlthSigNormnMinRackTrvlLim_Val_data;
  float32 StHlthSigNormnMotVelCal_Val_data;
  float32 StHlthSigNormnStHlthCurrMotSum_Val_data;
  float32 StHlthSigNormnStHlthPhaInfo_Val_data;
  float32 StHlthSigNormnValMaxStHlthErr_Val_data;
  float32 StHlthSigNormnValMinStHlthErr_Val_data;
  float32 StHlthSigNormnWhlImbRejctnThd_Val_data;
  uint32 MotDrvDiagcErrThd_Val_data;
  uint16 DutyCycThermProtnDutyCycFildThd_Val_data;
  uint16 StHlthSigNormnDutyCycFltLimThd_Val_data;
  u0p16 StHlthSigNormnStHlthCorrlnErr_Val_data;
  uint8 StHlthSigNormnAbsltMotPosDifStHlthDiagThd_Val_data;
  uint8 StHlthSigNormnCurrMotSumStHlthDiagThd_Val_data;
  uint8 StHlthSigNormnDigTqStHlthDiagThd_Val_data;
  uint8 StHlthSigNormnIdptSigStHlthSca_Val_data;
  uint8 StHlthSigNormnMotPosStHlthDiagThd_Val_data;
  uint8 StHlthSigNormnPhaInfoStHlthDiagThd_Val_data;
  ...
  *************************************************/
  ...
  MotAgCorrlnErrThd = *TSC_StHlthSigNormn_Rte_Pim_MotAgCorrlnErrThd();
  *TSC_StHlthSigNormn_Rte_Pim_MotAgCorrlnErrThd() = MotAgCorrlnErrThd;
  AbsltMotPosABDifStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_AbsltMotPosABDifStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_AbsltMotPosABDifStHlthSts() = AbsltMotPosABDifStHlthSts;
  AbsltMotPosACDifStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_AbsltMotPosACDifStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_AbsltMotPosACDifStHlthSts() = AbsltMotPosACDifStHlthSts;
  AbsltMotPosBCDifStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_AbsltMotPosBCDifStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_AbsltMotPosBCDifStHlthSts() = AbsltMotPosBCDifStHlthSts;
  CurrMotSumABCStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_CurrMotSumABCStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_CurrMotSumABCStHlthSts() = CurrMotSumABCStHlthSts;
  CurrMotSumDEFStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_CurrMotSumDEFStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_CurrMotSumDEFStHlthSts() = CurrMotSumDEFStHlthSts;
  DigTqIdptSigStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_DigTqIdptSigStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_DigTqIdptSigStHlthSts() = DigTqIdptSigStHlthSts;
  DigTqSnsrAStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_DigTqSnsrAStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_DigTqSnsrAStHlthSts() = DigTqSnsrAStHlthSts;
  DigTqSnsrBStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_DigTqSnsrBStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_DigTqSnsrBStHlthSts() = DigTqSnsrBStHlthSts;
  EcuTRngIgnCyc = *TSC_StHlthSigNormn_Rte_Pim_EcuTRngIgnCyc();
  *TSC_StHlthSigNormn_Rte_Pim_EcuTRngIgnCyc() = EcuTRngIgnCyc;
  EotImpctCntr = *TSC_StHlthSigNormn_Rte_Pim_EotImpctCntr();
  *TSC_StHlthSigNormn_Rte_Pim_EotImpctCntr() = EotImpctCntr;
  MotPosStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_MotPosStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_MotPosStHlthSts() = MotPosStHlthSts;
  PhaAStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_PhaAStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_PhaAStHlthSts() = PhaAStHlthSts;
  PhaBStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_PhaBStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_PhaBStHlthSts() = PhaBStHlthSts;
  PhaCStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_PhaCStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_PhaCStHlthSts() = PhaCStHlthSts;
  PhaDStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_PhaDStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_PhaDStHlthSts() = PhaDStHlthSts;
  PhaEStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_PhaEStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_PhaEStHlthSts() = PhaEStHlthSts;
  PhaFStHlthSts = *TSC_StHlthSigNormn_Rte_Pim_PhaFStHlthSts();
  *TSC_StHlthSigNormn_Rte_Pim_PhaFStHlthSts() = PhaFStHlthSts;
  VltgRngIgnCyc = *TSC_StHlthSigNormn_Rte_Pim_VltgRngIgnCyc();
  *TSC_StHlthSigNormn_Rte_Pim_VltgRngIgnCyc() = VltgRngIgnCyc;
  EntrEot = *TSC_StHlthSigNormn_Rte_Pim_EntrEot();
  *TSC_StHlthSigNormn_Rte_Pim_EntrEot() = EntrEot;

  CurrMeasCorrlnMaxErrCurr_Val_data = TSC_StHlthSigNormn_Rte_Prm_CurrMeasCorrlnMaxErrCurr_Val();
  EcuTMeasRngDiagcMax_Val_data = TSC_StHlthSigNormn_Rte_Prm_EcuTMeasRngDiagcMax_Val();
  EcuTMeasRngDiagcMin_Val_data = TSC_StHlthSigNormn_Rte_Prm_EcuTMeasRngDiagcMin_Val();
  EotLrngAuthyStrtLrn_Val_data = TSC_StHlthSigNormn_Rte_Prm_EotLrngAuthyStrtLrn_Val();
  HwTqCorrlnChATraSumSetFltThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_HwTqCorrlnChATraSumSetFltThd_Val();
  HwTqCorrlnChBTraSumSetFltThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_HwTqCorrlnChBTraSumSetFltThd_Val();
  StHlthSigNormnHiCtrlrT_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnHiCtrlrT_Val();
  StHlthSigNormnLoCtrlrT_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnLoCtrlrT_Val();
  StHlthSigNormnMaxFricThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnMaxFricThd_Val();
  StHlthSigNormnMinRackTrvlLim_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnMinRackTrvlLim_Val();
  StHlthSigNormnMotVelCal_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnMotVelCal_Val();
  StHlthSigNormnStHlthCurrMotSum_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnStHlthCurrMotSum_Val();
  StHlthSigNormnStHlthPhaInfo_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnStHlthPhaInfo_Val();
  StHlthSigNormnValMaxStHlthErr_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnValMaxStHlthErr_Val();
  StHlthSigNormnValMinStHlthErr_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnValMinStHlthErr_Val();
  StHlthSigNormnWhlImbRejctnThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnWhlImbRejctnThd_Val();
  MotDrvDiagcErrThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_MotDrvDiagcErrThd_Val();
  DutyCycThermProtnDutyCycFildThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_DutyCycThermProtnDutyCycFildThd_Val();
  StHlthSigNormnDutyCycFltLimThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnDutyCycFltLimThd_Val();
  StHlthSigNormnStHlthCorrlnErr_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnStHlthCorrlnErr_Val();
  StHlthSigNormnAbsltMotPosDifStHlthDiagThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnAbsltMotPosDifStHlthDiagThd_Val();
  StHlthSigNormnCurrMotSumStHlthDiagThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnCurrMotSumStHlthDiagThd_Val();
  StHlthSigNormnDigTqStHlthDiagThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnDigTqStHlthDiagThd_Val();
  StHlthSigNormnIdptSigStHlthSca_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnIdptSigStHlthSca_Val();
  StHlthSigNormnMotPosStHlthDiagThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnMotPosStHlthDiagThd_Val();
  StHlthSigNormnPhaInfoStHlthDiagThd_Val_data = TSC_StHlthSigNormn_Rte_Prm_StHlthSigNormnPhaInfoStHlthDiagThd_Val();
  SysGlbPrmMotPoleCnt_Val_data = TSC_StHlthSigNormn_Rte_Prm_SysGlbPrmMotPoleCnt_Val();

  fct_status = TSC_StHlthSigNormn_Rte_Write_AbsltMotPosABDifStHlth_Val(Rte_InitValue_AbsltMotPosABDifStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_AbsltMotPosACDifStHlth_Val(Rte_InitValue_AbsltMotPosACDifStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_AbsltMotPosBCDifStHlth_Val(Rte_InitValue_AbsltMotPosBCDifStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_CtrlrTRng_Val(Rte_InitValue_CtrlrTRng_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_CtrlrTStHlth_Val(Rte_InitValue_CtrlrTStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_CurrMotSumABCStHlth_Val(Rte_InitValue_CurrMotSumABCStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_CurrMotSumDEFStHlth_Val(Rte_InitValue_CurrMotSumDEFStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_DigTqIdptSigStHlth_Val(Rte_InitValue_DigTqIdptSigStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_DigTqSnsrAStHlth_Val(Rte_InitValue_DigTqSnsrAStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_DigTqSnsrBStHlth_Val(Rte_InitValue_DigTqSnsrBStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_DutyCycStHlth_Val(Rte_InitValue_DutyCycStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_EotImpctStHlth_Val(Rte_InitValue_EotImpctStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_MotPosStHlth_Val(Rte_InitValue_MotPosStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_OutpAssiStHlth_Val(Rte_InitValue_OutpAssiStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_PhaAStHlth_Val(Rte_InitValue_PhaAStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_PhaBStHlth_Val(Rte_InitValue_PhaBStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_PhaCStHlth_Val(Rte_InitValue_PhaCStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_PhaDStHlth_Val(Rte_InitValue_PhaDStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_PhaEStHlth_Val(Rte_InitValue_PhaEStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_PhaFStHlth_Val(Rte_InitValue_PhaFStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_RamEccSngBitCorrnStHlth_Val(Rte_InitValue_RamEccSngBitCorrnStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_VltgRng_Val(Rte_InitValue_VltgRng_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_StHlthSigNormn_Rte_IrvWrite_StHlthSigNormnInit1_EolFric(0.0F);

  fct_status = TSC_StHlthSigNormn_Rte_Call_GetFricLrngData_Oper(&Call_GetFricLrngData_Oper_FricLrngEna_Arg, &Call_GetFricLrngData_Oper_FricLrngOffsOutpEna_Arg, &Call_GetFricLrngData_Oper_FricLrngOperMod_Arg, &Call_GetFricLrngData_Oper_EolFric_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_CurrMotSumABC_Val;
  float32 Read_CurrMotSumDEF_Val;
  uint16 Read_DutyCycThermProtnMaxOutp_Val;
  float32 Read_EcuTFild_Val;
  float32 Read_HwAg_Val;
  float32 Read_HwAgEotCcw_Val;
  float32 Read_HwAgEotCw_Val;
  float32 Read_HwAuthy_Val;
  float32 Read_HwTqChACorrlnTraErr_Val;
  float32 Read_HwTqChBCorrlnTraErr_Val;
  uint8 Read_HwTqIdptSig_Val;
  uint8 Read_LclRamEccSngBitCntrOutp_Val;
  float32 Read_MaxLrndFric_Val;
  float32 Read_MotAg2VltgSqd_Val;
  u0p16 Read_MotAgABErrTerm_Val;
  u0p16 Read_MotAgACErrTerm_Val;
  u0p16 Read_MotAgBCErrTerm_Val;
  float32 Read_MotDrvErrA_Val;
  float32 Read_MotDrvErrB_Val;
  float32 Read_MotDrvErrC_Val;
  float32 Read_MotDrvErrD_Val;
  float32 Read_MotDrvErrE_Val;
  float32 Read_MotDrvErrF_Val;
  float32 Read_MotVelCrf_Val;
  boolean Read_RackLimrEotSig0Avl_Logl;
  boolean Read_RackLimrEotSig1Avl_Logl;
  float32 Read_WhlImbRejctnCmd_Val;
  ...
  float32 UpdRawSig_Oper_EolFric;
  ...
  *TSC_StHlthSigNormn_Rte_Pim_EntrEot() = EntrEot;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_CurrMotSumABC_Val(&Read_CurrMotSumABC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_CurrMotSumDEF_Val(&Read_CurrMotSumDEF_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_DutyCycThermProtnMaxOutp_Val(&Read_DutyCycThermProtnMaxOutp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_EcuTFild_Val(&Read_EcuTFild_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwAg_Val(&Read_HwAg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwAgEotCcw_Val(&Read_HwAgEotCcw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwAgEotCw_Val(&Read_HwAgEotCw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwAuthy_Val(&Read_HwAuthy_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwTqChACorrlnTraErr_Val(&Read_HwTqChACorrlnTraErr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwTqChBCorrlnTraErr_Val(&Read_HwTqChBCorrlnTraErr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_HwTqIdptSig_Val(&Read_HwTqIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_LclRamEccSngBitCntrOutp_Val(&Read_LclRamEccSngBitCntrOutp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MaxLrndFric_Val(&Read_MaxLrndFric_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotAg2VltgSqd_Val(&Read_MotAg2VltgSqd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotAgABErrTerm_Val(&Read_MotAgABErrTerm_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotAgACErrTerm_Val(&Read_MotAgACErrTerm_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotAgBCErrTerm_Val(&Read_MotAgBCErrTerm_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotDrvErrA_Val(&Read_MotDrvErrA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotDrvErrB_Val(&Read_MotDrvErrB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotDrvErrC_Val(&Read_MotDrvErrC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotDrvErrD_Val(&Read_MotDrvErrD_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotDrvErrE_Val(&Read_MotDrvErrE_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotDrvErrF_Val(&Read_MotDrvErrF_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_MotVelCrf_Val(&Read_MotVelCrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_RackLimrEotSig0Avl_Logl(&Read_RackLimrEotSig0Avl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_RackLimrEotSig1Avl_Logl(&Read_RackLimrEotSig1Avl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Read_WhlImbRejctnCmd_Val(&Read_WhlImbRejctnCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_FricEstimnStHlth_Val(Rte_InitValue_FricEstimnStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Write_WhlImbMaxCmpStHlth_Val(Rte_InitValue_WhlImbMaxCmpStHlth_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  UpdRawSig_Oper_EolFric = TSC_StHlthSigNormn_Rte_IrvRead_UpdRawSig_Oper_EolFric();

  fct_status = TSC_StHlthSigNormn_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_StHlthSigNormn_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
