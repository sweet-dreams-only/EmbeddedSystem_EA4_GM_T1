...
#include "Rte_GmMsg3F1BusHiSpd.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void GmMsg3F1BusHiSpd_TestDefines(void);
 ...
 * Symbol: GmMsg3F1BusHiSpdPer1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  uint32 Read_LstRxnTiMsg3F1_Val;
  uint8 Read_OutdAirTCorrdValMaskRaw_Val;
  uint8 Read_OutdAirTCorrdValRaw_Val;
  uint8 Read_OutdAirTCorrdValVldRaw_Val;

  uint32 GmMsg3F1BusHiSpdInvldMsgTmr;

  float32 GmMsg3F1BusHiSpdAmbTDft_Val_data;
  uint16 GmMsg3F1BusHiSpdInvldTiOut_Val_data;
  uint16 GmMsg3F1BusHiSpdMissTiOut_Val_data;
  ...
  *************************************************/
  ...
  GmMsg3F1BusHiSpdInvldMsgTmr = *TSC_GmMsg3F1BusHiSpd_Rte_Pim_GmMsg3F1BusHiSpdInvldMsgTmr();
  *TSC_GmMsg3F1BusHiSpd_Rte_Pim_GmMsg3F1BusHiSpdInvldMsgTmr() = GmMsg3F1BusHiSpdInvldMsgTmr;

  GmMsg3F1BusHiSpdAmbTDft_Val_data = TSC_GmMsg3F1BusHiSpd_Rte_Prm_GmMsg3F1BusHiSpdAmbTDft_Val();
  GmMsg3F1BusHiSpdInvldTiOut_Val_data = TSC_GmMsg3F1BusHiSpd_Rte_Prm_GmMsg3F1BusHiSpdInvldTiOut_Val();
  GmMsg3F1BusHiSpdMissTiOut_Val_data = TSC_GmMsg3F1BusHiSpd_Rte_Prm_GmMsg3F1BusHiSpdMissTiOut_Val();

  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Read_LstRxnTiMsg3F1_Val(&Read_LstRxnTiMsg3F1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Read_OutdAirTCorrdValMaskRaw_Val(&Read_OutdAirTCorrdValMaskRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Read_OutdAirTCorrdValRaw_Val(&Read_OutdAirTCorrdValRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Read_OutdAirTCorrdValVldRaw_Val(&Read_OutdAirTCorrdValVldRaw_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Write_AmbT_Val(Rte_InitValue_AmbT_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GmMsg3F1BusHiSpd_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
