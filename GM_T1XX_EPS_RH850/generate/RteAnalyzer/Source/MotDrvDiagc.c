...
#include "Rte_MotDrvDiagc.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void MotDrvDiagc_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 MotDrvDiagcPhaOnTiSumAPrev;
  uint32 MotDrvDiagcPhaOnTiSumBPrev;
  uint32 MotDrvDiagcPhaOnTiSumCPrev;
  boolean UnitDly;
  FilLpRec1 MotDrvDiagcPhaAFilLp;
  FilLpRec1 MotDrvDiagcPhaBFilLp;
  FilLpRec1 MotDrvDiagcPhaCFilLp;
  FilLpRec1 MotDrvDiagcPhaDFilLp;
  FilLpRec1 MotDrvDiagcPhaEFilLp;
  FilLpRec1 MotDrvDiagcPhaFFilLp;

  float32 MotDrvDiagcErrFilFrq_Val_data;
  uint32 MotDrvDiagcErrOffs_Val_data;
  ...
  *************************************************/
  ...
  MotDrvDiagcPhaOnTiSumAPrev = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaOnTiSumAPrev();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaOnTiSumAPrev() = MotDrvDiagcPhaOnTiSumAPrev;
  MotDrvDiagcPhaOnTiSumBPrev = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaOnTiSumBPrev();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaOnTiSumBPrev() = MotDrvDiagcPhaOnTiSumBPrev;
  MotDrvDiagcPhaOnTiSumCPrev = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaOnTiSumCPrev();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaOnTiSumCPrev() = MotDrvDiagcPhaOnTiSumCPrev;
  UnitDly = *TSC_MotDrvDiagc_Rte_Pim_UnitDly();
  *TSC_MotDrvDiagc_Rte_Pim_UnitDly() = UnitDly;
  MotDrvDiagcPhaAFilLp = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaAFilLp();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaAFilLp() = MotDrvDiagcPhaAFilLp;
  MotDrvDiagcPhaBFilLp = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaBFilLp();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaBFilLp() = MotDrvDiagcPhaBFilLp;
  MotDrvDiagcPhaCFilLp = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaCFilLp();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaCFilLp() = MotDrvDiagcPhaCFilLp;
  MotDrvDiagcPhaDFilLp = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaDFilLp();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaDFilLp() = MotDrvDiagcPhaDFilLp;
  MotDrvDiagcPhaEFilLp = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaEFilLp();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaEFilLp() = MotDrvDiagcPhaEFilLp;
  MotDrvDiagcPhaFFilLp = *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaFFilLp();
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaFFilLp() = MotDrvDiagcPhaFFilLp;

  MotDrvDiagcErrFilFrq_Val_data = TSC_MotDrvDiagc_Rte_Prm_MotDrvDiagcErrFilFrq_Val();
  MotDrvDiagcErrOffs_Val_data = TSC_MotDrvDiagc_Rte_Prm_MotDrvDiagcErrOffs_Val();
  MotDrvDiagcErrThd_Val_data = TSC_MotDrvDiagc_Rte_Prm_MotDrvDiagcErrThd_Val();

  MotDrvDiagc_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  uint32 Read_PhaOnTiMeasdD_Val;
  uint32 Read_PhaOnTiMeasdE_Val;
  uint32 Read_PhaOnTiMeasdF_Val;
  ...
  *TSC_MotDrvDiagc_Rte_Pim_MotDrvDiagcPhaFFilLp() = MotDrvDiagcPhaFFilLp;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_DiagcStsIvtr1Inactv_Logl(&Read_DiagcStsIvtr1Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_DiagcStsIvtr2Inactv_Logl(&Read_DiagcStsIvtr2Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiMeasdA_Val(&Read_PhaOnTiMeasdA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiMeasdB_Val(&Read_PhaOnTiMeasdB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiMeasdC_Val(&Read_PhaOnTiMeasdC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiMeasdD_Val(&Read_PhaOnTiMeasdD_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiMeasdE_Val(&Read_PhaOnTiMeasdE_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiMeasdF_Val(&Read_PhaOnTiMeasdF_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiSumA_Val(&Read_PhaOnTiSumA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiSumB_Val(&Read_PhaOnTiSumB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_PhaOnTiSumC_Val(&Read_PhaOnTiSumC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Write_MotDrvErrA_Val(Rte_InitValue_MotDrvErrA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Write_MotDrvErrB_Val(Rte_InitValue_MotDrvErrB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Write_MotDrvErrC_Val(Rte_InitValue_MotDrvErrC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Write_MotDrvErrD_Val(Rte_InitValue_MotDrvErrD_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Write_MotDrvErrE_Val(Rte_InitValue_MotDrvErrE_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Write_MotDrvErrF_Val(Rte_InitValue_MotDrvErrF_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotDrvDiagc_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
