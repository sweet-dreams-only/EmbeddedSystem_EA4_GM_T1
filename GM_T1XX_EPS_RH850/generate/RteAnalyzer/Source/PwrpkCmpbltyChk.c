 ...
 *
 *   Description:  C-Code implementation template for SW-C <PwrpkCmpbltyChk>
 *********************************************************************************************************************/
...
#include "Rte_PwrpkCmpbltyChk.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void PwrpkCmpbltyChk_TestDefines(void);
 ...
 * Symbol: PwrpkCmpbltyChkInit1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: PwrpkCmpbltyChkInit1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 GearIdnRefTmr;

  uint8 PwrpkCmpbltyChkGearId_Val_data;
  ...
  *************************************************/
  ...
  GearIdnRefTmr = *TSC_PwrpkCmpbltyChk_Rte_Pim_GearIdnRefTmr();
  *TSC_PwrpkCmpbltyChk_Rte_Pim_GearIdnRefTmr() = GearIdnRefTmr;

  PwrpkCmpbltyChkGearId_Val_data = TSC_PwrpkCmpbltyChk_Rte_Prm_PwrpkCmpbltyChkGearId_Val();

  fct_status = TSC_PwrpkCmpbltyChk_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: PwrpkCmpbltyChkPer1_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: PwrpkCmpbltyChkPer1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint8 Read_GearIdn1_Val;
  boolean Read_GearIdn1Vld_Logl;
  uint8 Read_GearIdn2_Val;
  boolean Read_GearIdn2Vld_Logl;
  ...
  *TSC_PwrpkCmpbltyChk_Rte_Pim_GearIdnRefTmr() = GearIdnRefTmr;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Read_GearIdn1_Val(&Read_GearIdn1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Read_GearIdn1Vld_Logl(&Read_GearIdn1Vld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Read_GearIdn2_Val(&Read_GearIdn2_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Read_GearIdn2Vld_Logl(&Read_GearIdn2Vld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrpkCmpbltyChk_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
