...
#  define Rte_Pim_MotAgMeclPrev() \
  (&Rte_CDD_MotAgArbn_MotAgMeclPrev) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CDD_MotAgArbn_CODE) CDD_MotAgArbnInit1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
