 ...
 *
 *   Description:  Application types header file for SW-C <AssiSumLim>
 *********************************************************************************************************************/
...
#  define Tq8_LowerLimit (-3.0F)
#  define Tq8_UpperLimit (3.0F)

#  define Tq9_LowerLimit (-8.0F)
#  define Tq9_UpperLimit (8.0F)
