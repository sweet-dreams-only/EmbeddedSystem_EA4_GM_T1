...
#  define Frq1_LowerLimit (0.1F)
#  define Frq1_UpperLimit (10.0F)

#  define Gain1_LowerLimit (0.0F)
#  define Gain1_UpperLimit (200.0F)
...
#  define T4_LowerLimit (-100.0F)
#  define T4_UpperLimit (150.0F)
