 ...
 *
 *   Description:  Application types header file for SW-C <HwAg0Meas>
 *********************************************************************************************************************/
...
#  define Cnt32_LowerLimit (0.0F)
#  define Cnt32_UpperLimit (360.0F)

#  define Cnt34_LowerLimit (-900.0F)
#  define Cnt34_UpperLimit (900.0F)
