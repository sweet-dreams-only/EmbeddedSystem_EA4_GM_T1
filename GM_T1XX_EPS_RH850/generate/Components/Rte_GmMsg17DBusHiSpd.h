 ...
 *
 *   Description:  Application header file for SW-C <GmMsg17DBusHiSpd>
 *********************************************************************************************************************/
...
#  define Rte_Read_GmMsg17DBusHiSpd_LstRxnTiMsg17D_Val(data) (*(data) = Rte_SerlComInpProxy_LstRxnTiMsg17D_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehStabyEnhmtStsRaw_Val Rte_Read_GmMsg17DBusHiSpd_VehStabyEnhmtStsRaw_Val
#  define Rte_Read_GmMsg17DBusHiSpd_VehStabyEnhmtStsRaw_Val(data) (*(data) = Rte_SerlComInpProxy_VehStabyEnhmtStsRaw_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Write_GmMsg17DBusHiSpd_InvldMsg17D_Logl(data) (Rte_GmMsg17DBusHiSpd_InvldMsg17D_Logl = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_MissMsg17D_Logl Rte_Write_GmMsg17DBusHiSpd_MissMsg17D_Logl
#  define Rte_Write_GmMsg17DBusHiSpd_MissMsg17D_Logl(data) (Rte_GmMsg17DBusHiSpd_MissMsg17D_Logl = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_GmMsg17DBusHiSpdInvldTiOut_Val() (((P2CONST(Rte_Calprm_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP])->GmMsg17DBusHiSpdInvldTiOut_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Prm_GmMsg17DBusHiSpdMissTiOut_Val() (((P2CONST(Rte_Calprm_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP])->GmMsg17DBusHiSpdMissTiOut_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Pim_GmMsg17DBusHiSpdInvldMsgTmr() \
  (&Rte_GmMsg17DBusHiSpd_GmMsg17DBusHiSpdInvldMsgTmr) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, GmMsg17DBusHiSpd_CODE) GmMsg17DBusHiSpdPer1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
