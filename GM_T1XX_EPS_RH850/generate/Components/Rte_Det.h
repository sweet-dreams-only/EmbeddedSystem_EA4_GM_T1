...
FUNC(Std_ReturnType, Det_CODE) Det_ReportError(uint16 parg0, uint8 InstanceId, uint8 ApiId, uint8 ErrorId); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
