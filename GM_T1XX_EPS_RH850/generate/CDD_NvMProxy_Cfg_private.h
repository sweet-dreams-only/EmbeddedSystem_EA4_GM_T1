...
#define NROFNVMBLKS_CNT_U08        117U /* Number of NvM Blocks */
#define NROFCRCNVMBLKS_CNT_U08     69U /* Number of NvM Blocks using a CRC */
#define NROFCRCPROXYBLKS_CNT_U08   61U /* Number of NvM CRC checks configured for NvM Proxy Init */
