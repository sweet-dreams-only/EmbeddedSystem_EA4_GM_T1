...
#ifndef _RTE_HWAG0MEAS_TYPE_H
# define _RTE_HWAG0MEAS_TYPE_H
...
# define Cnt32_LowerLimit (0.0)
# define Cnt32_UpperLimit (360.0)

# define Cnt34_LowerLimit (-900.0)
# define Cnt34_UpperLimit (900.0)

# define Uls5_LowerLimit (-1000000000.0)
# define Uls5_UpperLimit (1000000000.0)

# define Cnt35_LowerLimit (-500)
# define Cnt35_UpperLimit (500)
...
# define Cnt31_LowerLimit (0U)
# define Cnt31_UpperLimit (4095U)

# define Cnt13_LowerLimit (0U)
# define Cnt13_UpperLimit (3U)

# define Cnt19_LowerLimit (0U)
# define Cnt19_UpperLimit (255U)

# define Cnt30_LowerLimit (0U)
# define Cnt30_UpperLimit (20U)

# define Cnt33_LowerLimit (0U)
# define Cnt33_UpperLimit (22U)

# define Uls24_LowerLimit (0U)
# define Uls24_UpperLimit (255U)
...
#    error "The magic number of the generated file <C:/Component/CM690A_HwAg0Meas_Impl/tools/contract/Rte_HwAg0Meas_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
