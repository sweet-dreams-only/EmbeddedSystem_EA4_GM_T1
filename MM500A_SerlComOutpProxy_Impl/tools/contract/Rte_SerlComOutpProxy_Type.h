 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_SerlComOutpProxy_Type.h
...
#ifndef _RTE_SERLCOMOUTPPROXY_TYPE_H
# define _RTE_SERLCOMOUTPPROXY_TYPE_H
...
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Sandbox/MM500A_SerlComOutpProxy_Impl/tools/contract/Rte_SerlComOutpProxy_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_SERLCOMOUTPPROXY_TYPE_H */
