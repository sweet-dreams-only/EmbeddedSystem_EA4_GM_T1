 ...
 *    Generator:  -
 *
 *  Description:  Provision of Platform Types for Rh850
 *  
 *  -------------------------------------------------------------------------------------------------------------------
 *  MISRA VIOLATIONS
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *  01.00.01  2013-11-05  vistkr                Update to template version 1.03.01
...
# define COMMONASR_RH850_IMPL_PLATFORMTYPES_VERSION 0x0101
...
# if defined (__NoFloat__)
 /* 
   ...
   extension the following typedefs are omitted if -fnone is given (-D__NoFloat__ is passed in this case).
 */ 
# else
