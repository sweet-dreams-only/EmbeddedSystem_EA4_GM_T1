...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM34AHS_VAR)  ************************/

/* used for all global or static SWC specific variables that are not initialized by the startup code of the compiler */
# define GM34AHS_VAR_NOINIT

/* used for global or static SWC specific variables that are initialized by the startup code of the compiler */
# define GM34AHS_VAR_INIT

/* used for global or static SWC specific variables that are initialized with zero by the startup code of the compiler */
# define GM34AHS_VAR_ZERO_INIT

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM34AHS_CONST)  **********************/

/* used for global or static SWC specific constants */
# define GM34AHS_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM34AHS_CODE)  ***********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_GM34AHS_APPL)  *******************/

/* used for references on application variables */
# define RTE_GM34AHS_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_GM34AHS_APPL_DATA

/* used for references on application functions */
# define RTE_GM34AHS_APPL_CODE

/* used for references on application constants */
# define RTE_GM34AHS_APPL_CONST
...
#    error "The magic number of the generated file <C:/Workspace/_EA4/_Components/MM012A_GmMsg34ABusHiSpd_Impl-kzdyfh/MM012A_GmMsg34ABusHiSpd_Impl/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
