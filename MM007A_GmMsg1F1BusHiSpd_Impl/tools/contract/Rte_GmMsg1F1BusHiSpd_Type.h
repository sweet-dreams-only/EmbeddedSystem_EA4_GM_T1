 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_GmMsg1F1BusHiSpd_Type.h
...
#ifndef _RTE_GMMSG1F1BUSHISPD_TYPE_H
# define _RTE_GMMSG1F1BUSHISPD_TYPE_H
...
# ifndef GMSYSPWRMOD_OFF
#  define GMSYSPWRMOD_OFF (0U)
# endif

# ifndef GMSYSPWRMOD_ACSY
#  define GMSYSPWRMOD_ACSY (1U)
# endif

# ifndef GMSYSPWRMOD_RUN
#  define GMSYSPWRMOD_RUN (2U)
# endif

# ifndef GMSYSPWRMOD_CRK
#  define GMSYSPWRMOD_CRK (3U)
# endif
...
#    error "The magic number of the generated file <C:/component/MM007A_GmMsg1F1BusHiSpd_Impl/tools/contract/Rte_GmMsg1F1BusHiSpd_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_GMMSG1F1BUSHISPD_TYPE_H */
