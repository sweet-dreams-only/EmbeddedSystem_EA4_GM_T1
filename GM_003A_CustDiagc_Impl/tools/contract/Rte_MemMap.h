...
#   error "The magic number of the generated file <C:/Hari/Work/SynergyProjects/EA4/GM_003A_CustDiagc_Impl/tools/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
