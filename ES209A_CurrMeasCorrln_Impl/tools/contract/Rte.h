...
#    error "The magic number of the generated file <C:/Component/ES209A_CurrMeasCorrln_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
