...
:CopyVariantA
xcopy ..\autosar\R403_PORT_P1M_04_05.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Port_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantB
xcopy ..\autosar\R403_PORT_P1M_10_11_14_15.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Port_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantC
xcopy ..\autosar\R403_PORT_P1M_12_13.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Port_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantD
xcopy ..\autosar\R403_PORT_P1M_18_19_22_23.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Port_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantE
xcopy ..\autosar\R403_PORT_P1M_20_21.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Port_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
:end
