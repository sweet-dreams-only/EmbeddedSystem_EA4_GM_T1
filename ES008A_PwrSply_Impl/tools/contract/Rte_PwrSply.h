...
{
  /* PIM Handles section */
  P2VAR(boolean, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PwrSplyReadWrOrderFlg1; /* PRQA S 0850 */ /* MD_MSR_19.8 */
  P2VAR(boolean, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PwrSplyReadWrOrderFlg2; /* PRQA S 0850 */ /* MD_MSR_19.8 */
  P2VAR(boolean, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_PwrSplyStrtUpSelfTestCmpl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Pim_PwrSplyReadWrOrderFlg1() (Rte_Inst_PwrSply->Pim_PwrSplyReadWrOrderFlg1) /* PRQA S 3453 */ /* MD_MSR_19.7 */

# define Rte_Pim_PwrSplyReadWrOrderFlg2() (Rte_Inst_PwrSply->Pim_PwrSplyReadWrOrderFlg2) /* PRQA S 3453 */ /* MD_MSR_19.7 */

# define Rte_Pim_PwrSplyStrtUpSelfTestCmpl() (Rte_Inst_PwrSply->Pim_PwrSplyStrtUpSelfTestCmpl) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#   if RTE_MAGIC_NUMBER != 1459786474
...
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1459786474
