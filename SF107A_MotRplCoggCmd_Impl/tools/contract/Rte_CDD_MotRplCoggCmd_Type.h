 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_MotRplCoggCmd_Type.h
...
#ifndef _RTE_CDD_MOTRPLCOGGCMD_TYPE_H
# define _RTE_CDD_MOTRPLCOGGCMD_TYPE_H
...
#    error "The magic number of the generated file <C:/Component/SF107A_MotRplCoggCmd_Impl/tools/contract/Rte_CDD_MotRplCoggCmd_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_CDD_MOTRPLCOGGCMD_TYPE_H */
