 ...
 *
 *   Description:  C-Code implementation template for SW-C <CDD_HwTq3Meas>
 *********************************************************************************************************************/
...
* Nxtr Confidential
*
* Module File Name  : CDD_HwTq3Meas.c
* Module Description: HandWheel Torque 3 SENT - complex device driver
* Project           : CBD
* Author            : Rijvi Ahmed
***********************************************************************************************************************
* Version Control:
...
* --------  -------  --------  -----------------------------------------------------------------------------  --------
* 08/12/15    1       Rijvi    Initial Version                                                                EA4#1034
* 10/14/15    2       Selva    Updated for  FDD v 1.2.0                                                       EA4#1926
* 12/21/15    3       Selva    CM700A HwTq3Meas Rev1.3.0 - Implementation (A3079)                             EA4#3162
* 01/21/16    4       Selva    CM700A HwTq3Meas Rev1.4.0 - Implementation (A3079)                             EA4#3379
* 03/28/16    5       KK       CM700A HwTq3Meas Rev2.0.0 - Implementation (A3079)(Also fix for EA4#4799)      EA4#4737
* 06/02/16    6       KK       CM700A HwTq3Meas Rev2.0.1     												  EA4#5779
**********************************************************************************************************************/
...
#define  GEARIDN2MIN_CNT_U08			0U
#define  GEARIDN2MAX_CNT_U08			63U

static FUNC(uint32, CDD_HwTq3Meas_CODE)  ReadRegister(volatile VAR(uint32, AUTOMATIC) RegisterDummyRead_Cnt_T_u32);

static FUNC(void, CDD_HwTq3Meas_CODE)  SlowSerlDataRead(VAR(uint32, AUTOMATIC) SlowSerlSND_Cnt_T_u32,
 ...
 * Symbol: HwTq3MeasHwTq3AutTrim_Oper
 *********************************************************************************************************************/
	/* REQ: CM700A #50 I */ /* REQ: CM700A #56 I */
	
	Rte_Pim_HwTq3Offs()->OffsTrim = *Rte_Pim_HwTq3MeasPrevHwTq3();
	Rte_Pim_HwTq3Offs()->OffsTrimPrfmdSts = TRUE;
	
	(void) Rte_Call_HwTq3Offs_SetRamBlockStatus( TRUE );

	/* ENDREQ: CM700A #50 */ /* ENDREQ: CM700A #56 */
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasHwTq3ClrTrim_Oper
 *********************************************************************************************************************/

	/* REQ: CM700A #50 I */ /* REQ: CM700A #54 I */ 
	
	Rte_Pim_HwTq3Offs()->OffsTrim = 0.0F;
	Rte_Pim_HwTq3Offs()->OffsTrimPrfmdSts = FALSE;
	
	(void) Rte_Call_HwTq3Offs_SetRamBlockStatus( TRUE );
	
	/* ENDREQ: CM700A #50 */ /* ENDREQ: CM700A #54 */
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
}
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasHwTq3ReadTrim_Oper
 *********************************************************************************************************************/

	*HwTqReadTrimData_Arg = Rte_Pim_HwTq3Offs()->OffsTrim; /* REQ: CM700A #52 I */ 
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasHwTq3TrimPrfmdSts_Oper
 *********************************************************************************************************************/

	*HwTqOffsTrimPrfmdStsData_Arg = Rte_Pim_HwTq3Offs()->OffsTrimPrfmdSts; /* REQ: CM700A #53 I */ 
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasHwTq3WrTrim_Oper
 *********************************************************************************************************************/

	/* REQ: CM700A #50 I */ /* REQ: CM700A #55 I */ 
	
	Rte_Pim_HwTq3Offs()->OffsTrim = HwTqWrOffsTrimData_Arg;
	Rte_Pim_HwTq3Offs()->OffsTrimPrfmdSts = TRUE;
	
	(void) Rte_Call_HwTq3Offs_SetRamBlockStatus( TRUE );
	
	/* ENDREQ: CM700A #50 */ /* ENDREQ: CM700A #55 */
 ...
 *********************************************************************************************************************/
	...
	} while( (TiSpan_Cnt_T_u32 < REGCFGWAITTI_CNT_U32) && (RSENT5MST != 1ul ) ); /* 1 - Configuration */
	
	
	RSENT5TSPC = ((uint32)(0ul << 16)) |	/* Master Mode */
				 ((uint32)(0ul << 8))  |	/* Tick Multiplier = 1 */
				 79ul;						/* Tick Prescaler value = 80 */
	
	RSENT5CC = ((uint32)(1ul << 12)) |		/* SPC Pulse Active low */
	...
	RSENT5BRP = ((uint32)(2ul << 24)) |		/* Tick Time Decimal Fraction = 0.2 us */
	...
	RSENT5IDE = ((uint32)(0ul << 10)) |		/* Slow Channel Encoding Error Interrupt Enable: Disabled */
	...
	RSENT5SPCT = 16ul;						/* 17 Tick => 1.22*17 = 20.74us */
	
	RSENT5MDC = 5ul;						/* 5 - Operation Active */
	...
	{	/* Wait until the SENT peripheral goes to the Active mode */
		...
		(void) Rte_Call_GetTiSpan1MicroSec32bit_Oper( RefTmr_Cnt_T_u32, &TiSpan_Cnt_T_u32 );
	} while( (TiSpan_Cnt_T_u32 < REGCFGWAITTI_CNT_U32) && (RSENT5MST != 5ul ) ); /* 5 - Operation Active */
	(void) Rte_Call_IoHwAb_SetFctPrphlHwTq3_Oper();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasPer1
 *********************************************************************************************************************/
	
	/* REQ: CM700A #39 I */
	
	/*** Temporary variables ***/
	VAR(sint8,    AUTOMATIC) HwTq3Polarity_Uls_T_s08;
	...
	VAR(float32,  AUTOMATIC) HwTq3_HwNwtMtr_T_f32;
	VAR(SigQlfr1, AUTOMATIC) NtcHwTq3PrtclQlfrSts_Cnt_T_enum;
	VAR(SigQlfr1, AUTOMATIC) NtcHwTq3MfgQlfrSts_Cnt_T_enum;
	VAR(SigQlfr1, AUTOMATIC) HwTq3Qlfr_Cnt_T_enum;
	
	VAR(uint32,   AUTOMATIC) RegInpRSENT5CS_Cnt_T_u32;    	/* Used for RSENT5CS register level access */
	VAR(uint32,   AUTOMATIC) HwTq3FRS_Cnt_T_u32;  			/* Used for RSENT5CS register field level access */
	VAR(uint8,    AUTOMATIC) HwTq3CS_Cnt_T_u08; 			/* Used for RSENT5CS register field level access */
	
	VAR(uint32,   AUTOMATIC) RegInpRSENT5FRXD_Cnt_T_u32; 	/* Used for RSENT5FRXD register level access */
	VAR(uint32,   AUTOMATIC) HwTq3FCCN_Cnt_T_u32; 			/* Used for RSENT5FRXD register field level access */
	VAR(uint32,   AUTOMATIC) HwTq3Data_Cnt_T_u32; 			/* Used for RSENT5FRXD register field level access */
	VAR(uint32,   AUTOMATIC) RegInpRSENT5SRXD_Cnt_T_u32; 
	...
	/*** Read Module input ***/
	(void) Rte_Read_HwTq3Polarity_Val( &HwTq3Polarity_Uls_T_s08 ); 
	/*** Read from registers ***/
	RegInpRSENT5CS_Cnt_T_u32 = RSENT5CS;
	RegInpRSENT5FRXD_Cnt_T_u32 = RSENT5FRXD;
	RegInpRSENT5SRXD_Cnt_T_u32 = RSENT5SRXD;
	
	/* Extract field level data from the register i/p */
	HwTq3FRS_Cnt_T_u32 			 = RegInpRSENT5CS_Cnt_T_u32  & FRSMASK_CNT_U32;
	HwTq3CS_Cnt_T_u08 			 = (uint8)(RegInpRSENT5CS_Cnt_T_u32  & CSMASK_CNT_U32);

	HwTq3FCCN_Cnt_T_u32 		 = RegInpRSENT5FRXD_Cnt_T_u32 & FCCNMASK_CNT_U32;
	HwTq3Data_Cnt_T_u32 		 = RegInpRSENT5FRXD_Cnt_T_u32 & TQDATAMASK_CNT_U32;
	
	SlowSerlSND_Cnt_T_u32 		 = RegInpRSENT5FRXD_Cnt_T_u32 & SLOWNEWMSGDATAMASK_CNT_U32;
	SlowSerlCS_Cnt_T_u32 		 = RegInpRSENT5CS_Cnt_T_u32 & SLOWCSMASK_ULS_U32;
	SlowSerlMsgID_Cnt_T_u08 	 = (uint8)((RegInpRSENT5SRXD_Cnt_T_u32 & SLOWMSGIDMASK_CNT_U32) >> 8U);
	SlowSerlMsgData_Cnt_T_u08	 = (uint8)(RegInpRSENT5SRXD_Cnt_T_u32 & SLOWMSGDATAMASK_CNT_U32);
	...
	/******************************************************************************************/
	/* REQ: CM700A #27 I */
	if( HwTq3FRS_Cnt_T_u32 != 0U ) 
	{	/*** NewMsg ***/
		
		
		if( HwTq3CS_Cnt_T_u08 == 0U )
		{	/*** NoStsFlt ***/
			
			if( HwTq3FCCN_Cnt_T_u32 == 0U )
			{	/*** TestPass ***/
				
				/* REQ: CM700A #49 I */
				RawHwTq_Cnt_T_u32 =HwTq3Data_Cnt_T_u32;
			...
			{	/*** ComFlt ***/
				...
				/* REQ: CM700A #28 I */ /* REQ: CM700A #48 I */ 
				RawHwTq_Cnt_T_u32 = 0UL;
				TestOk_Cnt_T_enum = NTCSTS_PREFAILD; 
				ParamByte_Cnt_T_u08 = ELECGLBPRM_SNSRINTFLT_CNT_U08;
				*Rte_Pim_HwTq3IntSnsrErrCntr() = *Rte_Pim_HwTq3IntSnsrErrCntr() +1U;
				/* ENDREQ: CM700A #28 */ /* ENDREQ: CM700A #48 */ 
			}
		}
		else
		{	/*** STSFLT ***/
			
			/* REQ: CM700A #40 I */  /* REQ: CM700A #41 I */  /* REQ: CM700A #42 I */ /* REQ: CM700A #43 I */  
			/* REQ: CM700A #44 I */  /* REQ: CM700A #45 I */ /* REQ: CM700A #46 I */  
			RawHwTq_Cnt_T_u32 = 0UL;
			TestOk_Cnt_T_enum = NTCSTS_PREFAILD; 
			ParamByte_Cnt_T_u08 = ELECGLBPRM_PRTCLFLT_CNT_U08;
			*Rte_Pim_HwTq3ComStsErrCntr() = *Rte_Pim_HwTq3ComStsErrCntr() +1U;
			/* ENDREQ: CM700A #40 */ /* ENDREQ: CM700A #41 */ /* ENDREQ: CM700A #42 */ /* ENDREQ: CM700A #43 */ 
			/* ENDREQ: CM700A #44 */ /* ENDREQ: CM700A #45 */ /* ENDREQ: CM700A #46 */ 
		}
	...
	{	/*** NoNewMsg ***/
		...
		/* REQ: CM700A #47 I */ 
		*Rte_Pim_HwTq3MsgMissRxCnt() = *Rte_Pim_HwTq3MsgMissRxCnt() +1U;
		RawHwTq_Cnt_T_u32 = 0UL;
		TestOk_Cnt_T_enum = NTCSTS_PREFAILD; 
		ParamByte_Cnt_T_u08 = ELECGLBPRM_PRTCLFLT_CNT_U08;
		/* ENDREQ: CM700A #47 */
	...
	/*** SlowSerlDataRead ***/ /* REQ: CM680A #66 I */
	...
	/*** PolarityEvaluation ***/
	/* REQ: CM700A #29 I */ /* REQ: CM700A #32 I */ 
	if( TestOk_Cnt_T_enum == NTCSTS_PREPASSD )
	{
		HwTq3_HwNwtMtr_T_f32 = HwTqData_HwNwtMtr_T_f32 * ((float32)HwTq3Polarity_Uls_T_s08); 
		*Rte_Pim_HwTq3MeasPrevHwTq3() = HwTq3_HwNwtMtr_T_f32; /* REQ: CM700A #51 I */ 
	}
	else
	{
		HwTq3_HwNwtMtr_T_f32 = *Rte_Pim_HwTq3MeasPrevHwTq3();  
	}
	
	HwTq3_HwNwtMtr_T_f32 = Lim_f32( (HwTq3_HwNwtMtr_T_f32 - Rte_Pim_HwTq3Offs()->OffsTrim), 
									ELECGLBPRM_HWTQSATNLOWRLIM_HWNWTMTR_F32, 
									ELECGLBPRM_HWTQSATNUPPRLIM_HWNWTMTR_F32 );  /* REQ: CM700A #26 I */ 
	/* ENDREQ: CM700A #29 */ /* ENDREQ: CM700A #32 */
	
	
	/*** ------------------ Update Rolling Counter ------------------- ***/
	if( TestOk_Cnt_T_enum == NTCSTS_PREPASSD )
	{
		*Rte_Pim_HwTq3MeasPrevRollgCntr() = *Rte_Pim_HwTq3MeasPrevRollgCntr() + 1U; /* This is an intentional over flow per the design */
	}
	...
	{
		/* REQ: CM700A #38 I */ 
		(void) Rte_Call_SetNtcSts_Oper( HWTQ3MEAS_HWTQ3PRTCLNTCNR_ULS_U16, ParamByte_Cnt_T_u08, TestOk_Cnt_T_enum, Rte_Prm_HwTq3MeasHwTq3PrtclFltPassStep_Val() );
	}
	else
	{
		/* REQ: CM700A #38 I */ 
		(void) Rte_Call_SetNtcSts_Oper( HWTQ3MEAS_HWTQ3PRTCLNTCNR_ULS_U16, ParamByte_Cnt_T_u08, TestOk_Cnt_T_enum, Rte_Prm_HwTq3MeasHwTq3PrtclFltFailStep_Val() );
	}
		
	
	/*** ---------- GetNtcQlfr --------- ***/
	(void) Rte_Call_GetNtcQlfrSts_Oper( HWTQ3MEAS_HWTQ3PRTCLNTCNR_ULS_U16, &NtcHwTq3PrtclQlfrSts_Cnt_T_enum );
	(void) Rte_Call_GetNtcQlfrSts_Oper( HWTQ3MEAS_HWTQ3MFGNTCNR_ULS_U16, &NtcHwTq3MfgQlfrSts_Cnt_T_enum );
	
	if( (NtcHwTq3PrtclQlfrSts_Cnt_T_enum != SIGQLFR_FAILD) && (NtcHwTq3MfgQlfrSts_Cnt_T_enum != SIGQLFR_FAILD) )
	{
		HwTq3Qlfr_Cnt_T_enum = SIGQLFR_PASSD;
	}
	else
	{
		HwTq3Qlfr_Cnt_T_enum = SIGQLFR_FAILD;
	}
	...
	if(RSENT5FRS == 1U)
	{
		...
		(void)ReadRegister((uint32)RSENT5FND);
	}
	/*** Write module outputs ***/
	(void) Rte_Write_HwTq3_Val( HwTq3_HwNwtMtr_T_f32 ); 
	(void) Rte_Write_HwTq3Qlfr_Val( HwTq3Qlfr_Cnt_T_enum ); /* REQ: CM700A #30 I */ 
	(void) Rte_Write_HwTq3RollgCntr_Val( *Rte_Pim_HwTq3MeasPrevRollgCntr() ); /* REQ: CM700A #31 I */ 
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasPer2
 *********************************************************************************************************************/

	
		/* REQ: CM700A #59 I */ /* REQ: CM700A #61 I */ /* REQ: CM700A #63 I */ /* REQ: CM700A #65 I */
	if( Rte_Pim_HwTq3Offs()->OffsTrimPrfmdSts != FALSE )
	{
		(void) Rte_Call_SetNtcSts_Oper( HWTQ3MEAS_HWTQ3MFGNTCNR_ULS_U16, ELECGLBPRM_NOFLT_CNT_U08, NTCSTS_PASSD, 0U );
	}
	else
	{
		(void) Rte_Call_SetNtcSts_Oper( HWTQ3MEAS_HWTQ3MFGNTCNR_ULS_U16, ELECGLBPRM_OFFSTRIMNOTPRFMD_CNT_U08, NTCSTS_FAILD, 0U );
	}
	/* ENDREQ: CM700A #59 */ /* ENDREQ: CM700A #61 */ /* ENDREQ: CM700A #63 */ /* ENDREQ: CM700A #65 */
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
}
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: HwTq3MeasTrigStrt_Oper
 *********************************************************************************************************************/
  VAR(uint32,   AUTOMATIC) RefTmr_Cnt_T_u32; 
  VAR(uint32,   AUTOMATIC) TiSpan_Cnt_T_u32; 
  /* REQ: CM680A #33 I */
  RSENT5CSC = 2046U; 
  RSENT5SPCT = SENTSYNCTRIG_CNT_U32; 
  __SYNCM();
 if(RSENT5NRS == 1U)
 {
	RSENT5NRC = 1U;
...
* Outputs		: Rte_Pim_GearIdn2Data, Rte_Pim_GearIdn2Avl.
* Return		: None
* Usage Notes	: None
**********************************************************************************************************************/ 
/* REQ: CM680A #66 I */
...
{
 /*** SlowSerlDataRead ***/
	if (*Rte_Pim_GearIdn2Avl() == FALSE)
	{
		if((SlowSerlSND_Cnt_T_u32 != 0U)&&(SlowSerlCS_Cnt_T_u32 == 0U))
		{
			if(SlowSerlMsgID_Cnt_T_u08 == 2U)
			{
				*Rte_Pim_GearIdn2Data()	= SlowSerlMsgData_Cnt_T_u08;
				*Rte_Pim_GearIdn2Avl()	= TRUE;
				(void) Rte_Write_GearIdn2Vld_Logl( *Rte_Pim_GearIdn2Avl() );
				(void) Rte_Write_GearIdn2_Val( Lim_u08(*Rte_Pim_GearIdn2Data(), GEARIDN2MIN_CNT_U08, GEARIDN2MAX_CNT_U08) );
			}
		}
	}
}
