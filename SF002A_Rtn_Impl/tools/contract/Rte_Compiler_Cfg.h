...
#    error "The magic number of the generated file <C:/Component/SF002A_Rtn_Impl_1.4.2/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
