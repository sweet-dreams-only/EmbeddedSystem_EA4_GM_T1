 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_GmRoadWhlInQlfr_Type.h
...
#ifndef _RTE_GMROADWHLINQLFR_TYPE_H
# define _RTE_GMROADWHLINQLFR_TYPE_H
...
#    error "The magic number of the generated file <C:/Component/CF018A_GmRoadWhlInQlfr_Impl/tools/contract/Rte_GmRoadWhlInQlfr_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_GMROADWHLINQLFR_TYPE_H */
