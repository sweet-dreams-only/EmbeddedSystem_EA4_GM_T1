...
#    error "The magic number of the generated file <C:/component/SF104A_MotCurrRegCfg_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
