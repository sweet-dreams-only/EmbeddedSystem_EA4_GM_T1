...
#    error "The magic number of the generated file <C:/Component/ES210A_EcuTMeas_Impl/tools/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
