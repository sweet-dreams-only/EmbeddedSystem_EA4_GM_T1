...
# define Frq1_LowerLimit (0.1)
# define Frq1_UpperLimit (10.0)

# define Gain1_LowerLimit (0.0)
# define Gain1_UpperLimit (200.0)
...
# define T4_LowerLimit (-100.0)
# define T4_UpperLimit (150.0)

# define Volt3_LowerLimit (0.0)
# define Volt3_UpperLimit (5.0)
...
#    error "The magic number of the generated file <C:/Component/ES210A_EcuTMeas_Impl/tools/contract/Rte_EcuTMeas_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
