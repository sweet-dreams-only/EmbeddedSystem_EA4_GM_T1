 ...
 *  Generated at:  Fri Dec  2 10:48:34 2016
 *
...
/* MISRA-C:2004 Rule 8.8 [NXTRDEV 8.8.1]: Deviation allowed for functions required to be declared in two headers to be 
                                            ...
                                            Function Names: GetNtcActv7_Oper, GetNtcQlfrSts7_Oper, 
                                            SetNtcSts7_Oper, GetNtcInfoAppl7_Oper */
...
#define PimDiagcMgrNtcInfo7Ary_NtcInfoRec4      (*(Ary1D_NtcInfoRec4_DiagcMgrProxyAppl7 *)(Rte_Pim_DiagcMgrNtcInfo7Ary()))  
 ...
 *********************************************************************************************************************/
     ...
     {
         if ((PrmDiagcMgrFltResp_u32[NtcNrAryAppl7_Cnt_u16[LoopCntr_Cnt_T_u16]] & FLTRESPDTCIDX_CNT_U32) > TOTNROFDTC_CNT_U08)
         {
     ...
     (void) Rte_Call_DiagcMgrIninCore_Oper(DIAGCMGR_APPLIDX7_CNT_U08, 
                                             (uint8)TblSize_m(PimDiagcMgrNtcInfo7Ary_NtcInfoRec4), 
                                             PimDiagcMgrNtcInfo7Ary_NtcInfoRec4, 
                                             Rte_Pim_DiagcData7(), 
 ...
 *********************************************************************************************************************/
    ...
    {
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo7Ary_NtcInfoRec4); NtcInfoIdx_Cnt_T_u16++) 
        {       
            /* Clear the NTCs that are active */
            if(((PrmDiagcMgrFltResp_u32[NtcNrAryAppl7_Cnt_u16[NtcInfoIdx_Cnt_T_u16]] & FLTRESPSTSLOCKDTHISIGNCYC_CNT_U32) != 0U) &&
                    ((PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
                    ((PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].AgiCntr >= 1U) && 
                    (PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].AgiCntr <= 64U)))
            {
                /* Status 0, AC 255, DebCntr Same */
                PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].Sts = 0U;
                PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;
                PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;
                
            }
            else if(((PrmDiagcMgrFltResp_u32[NtcNrAryAppl7_Cnt_u16[NtcInfoIdx_Cnt_T_u16]] & FLTRESPSTSLOCKDTHISIGNCYC_CNT_U32) != 0U) &&
               ((PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
               ((PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].AgiCntr == 0U) || 
                (PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].AgiCntr == 255U)))
            {
                /* Do Nothing */
            }
            else
            ...
            PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].Sts = DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08;                     
            PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;    
            PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;          
        ...
        Rte_Pim_DiagcData7()->DiagcSts = DIAGCSTSININVAL_CNT_U16 | StsIvtr2Inactv_Cnt_T_u16;
        ...
        Rte_Pim_ProxySetNtcData7()->DiagcSts = DIAGCSTSININVAL_CNT_U16 | StsIvtr2Inactv_Cnt_T_u16;
    ...
    { 
        ...
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo7Ary_NtcInfoRec4); NtcInfoIdx_Cnt_T_u16++) 
        {   
            if (((PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILD_CNT_U08) != 0U) &&
                ((PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILDTHISIGNCYC_CNT_U08) != 0U))
            {
                /* Process Ramp Response */
                ProcProxyRampResp (NtcNrAryAppl7_Cnt_u16[NtcInfoIdx_Cnt_T_u16], &ProxyPerData_T_rec);           
                /* Process Diagc Sts */
                ProcDiagSts((PrmDiagcMgrFltResp_u32[NtcNrAryAppl7_Cnt_u16[NtcInfoIdx_Cnt_T_u16]]), &(ProxyPerData_T_rec.DiagcSts));             
            }
        }
        Rte_Enter_DiagcMgrProxyAppl7();
 ...
 *********************************************************************************************************************/
    ...
    {           
        ...
        RtnVal_Cnt_T_u08 = Rte_Call_SetNtcStsCore_Oper( NtcNr_Arg,
                                                        ...
                                                        Rte_Pim_DiagcData7(),
                                                        Rte_Pim_ProxySetNtcData7(),
                                                        (&PimDiagcMgrNtcInfo7Ary_NtcInfoRec4[DiagcMgrNtcMap_Cnt_rec[NtcNr_Arg].NtcInfoIdx]),
