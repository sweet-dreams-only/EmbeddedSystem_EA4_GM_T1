...
#    error "The magic number of the generated file <C:/Component/NM100A_MotVelCtrl_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
