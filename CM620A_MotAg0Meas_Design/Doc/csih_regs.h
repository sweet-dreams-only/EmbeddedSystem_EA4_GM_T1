...
{                                                          /* IOR              */
    uint16 UINT16;                                         /* 16-bit Access    */
    const __type547 BIT;                                   /* Bit Access       */
} __type1817;
typedef union
{                                                          /* IOR              */
    uint32 UINT32;                                         /* 32-bit Access    */
...
typedef struct 
{                                                          /* Module           */
    __type1807 CTL0;                                       /* CTL0             */
    uint8  dummy301[3];                                    /* Reserved         */
    __type1808 STR0;                                       /* STR0             */
    __type1809 STCR0;                                      /* STCR0            */
    uint8  dummy302[6];                                    /* Reserved         */
    __type1810 CTL1;                                       /* CTL1             */
    __type1811 CTL2;                                       /* CTL2             */
    uint8  dummy303[4074];                                 /* Reserved         */
    __type1812 MCTL1;                                      /* MCTL1            */
    __type1813 MCTL2;                                      /* MCTL2            */
    __type1814 TX0W;                                       /* TX0W             */
    __type1815 TX0H;                                       /* TX0H             */
    uint8  dummy304[2];                                    /* Reserved         */
    __type1816 RX0W;                                       /* RX0W             */
    const __type1817 RX0H;                                 /* RX0H             */
    uint8  dummy305[2];                                    /* Reserved         */
    __type1818 MRWP0;                                      /* MRWP0            */
    uint8  dummy306[36];                                   /* Reserved         */
    __type1819 MCTL0;                                      /* MCTL0            */
    uint8  dummy307[2];                                    /* Reserved         */
    __type1820 CFG0;                                       /* CFG0             */
    __type1821 CFG1;                                       /* CFG1             */
    __type1822 CFG2;                                       /* CFG2             */
    __type1823 CFG3;                                       /* CFG3             */
    __type1824 CFG4;                                       /* CFG4             */
    __type1825 CFG5;                                       /* CFG5             */
    __type1826 CFG6;                                       /* CFG6             */
    __type1827 CFG7;                                       /* CFG7             */
    uint8  dummy308[4];                                    /* Reserved         */
    __type1828 BRS0;                                       /* BRS0             */
    uint8  dummy309[2];                                    /* Reserved         */
    __type1828 BRS1;                                       /* BRS1             */
    uint8  dummy310[2];                                    /* Reserved         */
    __type1828 BRS2;                                       /* BRS2             */
    uint8  dummy311[2];                                    /* Reserved         */
    __type1828 BRS3;                                       /* BRS3             */
} __type2573;
typedef struct 
{                                                          /* Module           */
    __type1837 SELCSIHDMA;                                 /* SELCSIHDMA       */
} __type2575;

__IOREG(CSIH0, 0xFFD80000, __READ_WRITE, __type2573);                 /* CSIH0 */
__IOREG(CSIH1, 0xFFD82000, __READ_WRITE, __type2573);                 /* CSIH1 */
__IOREG(CSIH2, 0xFFD84000, __READ_WRITE, __type2573);                 /* CSIH2 */
__IOREG(CSIH3, 0xFFD86000, __READ_WRITE, __type2573);                 /* CSIH3 */
__IOREG(CSIH, 0xFFD8E000, __READ_WRITE, __type2575);                  /* CSIH */
