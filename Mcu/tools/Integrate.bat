...
:CopyVariantA
xcopy ..\autosar\R403_MCU_P1M_04_05.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Mcu_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantB
xcopy ..\autosar\R403_MCU_P1M_10_to_15_18_to_23.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Mcu_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
:end
