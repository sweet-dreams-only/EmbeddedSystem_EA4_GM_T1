...
:CopyVariantA
xcopy ..\autosar\R403_FLS_P1M_04_05.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Fls_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantB
xcopy ..\autosar\R403_FLS_P1M_10_to_15.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Fls_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
goto end
:CopyVariantC
xcopy ..\autosar\R403_FLS_P1M_18_to_23.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
xcopy ..\autosar\Fls_bswmd_rec.arxml	%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
:end
