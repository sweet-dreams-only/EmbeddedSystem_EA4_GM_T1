...
* Nxtr Confidential
*
* Module File Name: SrvFDD9.c
* Module Description: 0xFDD9 - Correlation Table 1 Segment 0 Read/Write
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDD9Rd
 * Description:  0xFDD9: Correction Table 1 Part 0 Read
 *          ID:  0xFDD9
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  258 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_FDD9ENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDD9Rd(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg1MeasMotAg1CorrnTblSegRead_Oper((uint16*)DataBuf_Uls_T_u16, 0U);
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDD9Wr
 * Description:  0xFDD9: Correction Table 1 Part 0 Write
 *          ID:  0xFDD9
 *        Type:  0x2E (Write)
 *    Sub-Func:  N/A
 *    Req. Len:  258 bytes
...
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDD9Wr(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg1MeasMotAg1CorrnTblSegUpd_Oper((uint16*)DataBuf_Uls_T_u16, 0U, &Rsp_Cnt_T_u08);
