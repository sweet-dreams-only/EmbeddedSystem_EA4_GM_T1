...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFE03Rd
 * Description:  0xFE03: Motor Ripple Cogging Command Table Part 3 Read
 *          ID:  0xFE03
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  256 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_FE03ENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFE03Rd(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_GetMotCoggCmdPrm_Oper(TmpBuf_Cnt_T_s1p14, 3U);
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFE03Wr
 * Description:  0xFE03: Motor Ripple Cogging Command Table Part 3 Write
 *          ID:  0xFE03
 *        Type:  0x2E (Write)
 *    Sub-Func:  N/A
 *    Req. Len:  256 bytes
...
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFE03Wr(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_SetMotCoggCmdPrm_Oper(TmpBuf_Cnt_T_s1p14, 3U);
