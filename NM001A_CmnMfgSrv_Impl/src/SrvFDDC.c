...
* Nxtr Confidential
*
* Module File Name: SrvFDDC.c
* Module Description: 0xFDDC - Correlation Table 0 Segment 3 Read/Write
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDDCRd
 * Description:  0xFDDC: Correction Table 1 Part 3 Read
 *          ID:  0xFDDC
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  258 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_FDDCENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDDCRd(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg1MeasMotAg1CorrnTblSegRead_Oper((uint16*)DataBuf_Uls_T_u16, 3U);
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDDCWr
 * Description:  0xFDDC: Correction Table 1 Part 3 Write
 *          ID:  0xFDDC
 *        Type:  0x2E (Write)
 *    Sub-Func:  N/A
 *    Req. Len:  258 bytes
...
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDDCWr(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg1MeasMotAg1CorrnTblSegUpd_Oper((uint16*)DataBuf_Uls_T_u16, 3U, &Rsp_Cnt_T_u08);
