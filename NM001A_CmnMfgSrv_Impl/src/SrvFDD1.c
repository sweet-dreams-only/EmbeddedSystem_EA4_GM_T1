...
* Nxtr Confidential
*
* Module File Name: SrvFDD1.c
* Module Description: 0xFDD1 - Correlation Table 0 Segment 0 Read/Write
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDD1Rd
 * Description:  0xFDD1: Correction Table 0 Part 0 Read
 *          ID:  0xFDD1
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  258 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_FDD1ENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDD1Rd(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg0MeasMotAg0CorrnTblSegRead_Oper((uint16*)DataBuf_Uls_T_u16, 0U);
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDD1Wr
 * Description:  0xFDD1: Correction Table 0 Part 0 Write
 *          ID:  0xFDD1
 *        Type:  0x2E (Write)
 *    Sub-Func:  N/A
 *    Req. Len:  258 bytes
...
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDD1Wr(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg0MeasMotAg0CorrnTblSegUpd_Oper((uint16*)DataBuf_Uls_T_u16, 0U, &Rsp_Cnt_T_u08);
