...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvF1F7Rd
 * Description:  0xF1F7: Calibration 0 Development Information Read
 *          ID:  0xF1F7
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  59 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_F1F7ENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
