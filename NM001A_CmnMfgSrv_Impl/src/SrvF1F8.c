...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvF1F8Rd
 * Description:  0xF1F8: Calibration 1 Development Information Read
 *          ID:  0xF1F8
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  59 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_F1F8ENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
