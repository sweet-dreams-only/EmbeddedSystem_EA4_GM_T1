...
* Nxtr Confidential
*
* Module File Name: SrvFDD2.c
* Module Description: 0xFDD2 - Correlation Table 0 Segment 1 Read/Write
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDD2Rd
 * Description:  0xFDD2: Correction Table 0 Part 1 Read
 *          ID:  0xFDD2
 *        Type:  0x22 (Read)
 *    Sub-Func:  N/A
 *    Req. Len:  0 bytes
 *   Resp. Len:  258 bytes
 * ------------------------------------------------------------------------------------------------------------------ */
#if (CMNMFGSRV_FDD2ENA_CNT_LGC == CMNMFGSRV_ENAD_CNT_LGC)
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDD2Rd(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg0MeasMotAg0CorrnTblSegRead_Oper((uint16*)DataBuf_Uls_T_u16, 1U);
...
/* ---------------------------------------------------------------------------------------------------------------------
 *        Name:  CmnMfgSrv_SrvFDD2Wr
 * Description:  0xFDD2: Correction Table 0 Part 1 Write
 *          ID:  0xFDD2
 *        Type:  0x2E (Write)
 *    Sub-Func:  N/A
 *    Req. Len:  258 bytes
...
FUNC(NegRespCodEnum, CmnMfgSrv_CODE) CmnMfgSrv_SrvFDD2Wr(VAR(uint8, CmnMfgSrv_VAR) DataBuf_Uls_T_u08[])
{
	...
	(void)Rte_Call_MotAg0MeasMotAg0CorrnTblSegUpd_Oper((uint16*)DataBuf_Uls_T_u16, 1U, &Rsp_Cnt_T_u08);
