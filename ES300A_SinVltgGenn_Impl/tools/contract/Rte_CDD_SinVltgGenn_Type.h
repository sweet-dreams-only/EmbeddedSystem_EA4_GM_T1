...
# define Ag3_LowerLimit (0.0)
# define Ag3_UpperLimit (0.999)

# define Ti8_LowerLimit (0)
# define Ti8_UpperLimit (71429)
...
#    error "The magic number of the generated file <C:/Component/ES300A_SinVltgGenn_Impl/tools/contract/Rte_CDD_SinVltgGenn_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
