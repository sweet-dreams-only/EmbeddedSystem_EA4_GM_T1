...
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Sandbox/NM010A_ProgMfgSrv_Impl/tools/contract/Rte_DataHandleType.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
