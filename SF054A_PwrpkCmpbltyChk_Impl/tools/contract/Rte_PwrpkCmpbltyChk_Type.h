 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_PwrpkCmpbltyChk_Type.h
...
#ifndef _RTE_PWRPKCMPBLTYCHK_TYPE_H
# define _RTE_PWRPKCMPBLTYCHK_TYPE_H
...
#    error "The magic number of the generated file <C:/component/SF054A_PwrpkCmpbltyChk_Impl/tools/contract/Rte_PwrpkCmpbltyChk_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_PWRPKCMPBLTYCHK_TYPE_H */
