...
#    error "The magic number of the generated file <C:/Component/ES400A_TunSelnMngt_Impl/tools/contract/Rte_TunSelnMngt_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
