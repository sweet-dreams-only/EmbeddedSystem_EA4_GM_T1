...
/**************************************************** Type defs ******************************************************/
#define MAXINITIDXCNT_CNT_U08           9U
#define MAXRTIDXCNT_CNT_U08             30U
#define MAXONLINECALCFGCNT_CNT_U08      18U
#define ONLINECALGROUPS_CNT_U08         3U
#define ONLINECALRAMTBL_CNT_U16         5120U
...
/* The following were created just for testing purposes */
...
typedef struct
{
    uint32 calA;
    uint32 calB;
}Rte_Calprm_CalRegn01Rt00GroupB_DEFAULT_RTE_CALPRM_GROUP_Type;
...
typedef struct
{
    uint32 calA;
    uint32 calB;
}Rte_Calprm_CalRegn01Rt00GroupC_DEFAULT_RTE_CALPRM_GROUP_Type;
...
typedef struct
{
    ...
    Rte_Calprm_CalRegn01Rt00GroupB_DEFAULT_RTE_CALPRM_GROUP_Type    CalRegn01Rt00GroupB;
...
typedef struct
{
    ...
    Rte_Calprm_CalRegn01Rt00GroupC_DEFAULT_RTE_CALPRM_GROUP_Type    CalRegn01Rt00GroupC;
} GroupCTyp;
