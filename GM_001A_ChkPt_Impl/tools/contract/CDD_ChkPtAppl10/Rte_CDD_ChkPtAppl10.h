...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_CDD_ChkPtAppl10_UpdRawSig_Oper(StHlthMonSig3 SigId_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_CDD_ChkPtAppl10_UpdStHlthStcData_Oper(StHlthMonSig2 SigId_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Call_UpdRawSig_Oper Rte_Call_CDD_ChkPtAppl10_UpdRawSig_Oper
# define Rte_Call_UpdStHlthStcData_Oper Rte_Call_CDD_ChkPtAppl10_UpdStHlthStcData_Oper
...
#   if RTE_MAGIC_NUMBER != 1475849224
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Working/GM_001A_ChkPt_Impl/tools/contract/CDD_ChkPtAppl10/Rte_CDD_ChkPtAppl10.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1475849224
