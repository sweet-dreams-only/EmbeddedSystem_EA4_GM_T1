...
#    error "The magic number of the generated file <C:/component/SF105A_MotCurrRegVltgLimr_Impl/tools/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
