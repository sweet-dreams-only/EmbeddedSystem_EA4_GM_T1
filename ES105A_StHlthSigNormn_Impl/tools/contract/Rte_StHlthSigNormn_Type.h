 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_StHlthSigNormn_Type.h
...
#ifndef _RTE_STHLTHSIGNORMN_TYPE_H
# define _RTE_STHLTHSIGNORMN_TYPE_H
...
#    error "The magic number of the generated file <C:/Component/ES105A_StHlthSigNormn_Impl/tools/contract/Rte_StHlthSigNormn_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_STHLTHSIGNORMN_TYPE_H */
