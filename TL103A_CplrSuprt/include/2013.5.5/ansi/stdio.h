...
char *tmpnam __ARGS((char *));

int _flsbuf __ARGS((int, FILE *));
int _filbuf __ARGS((FILE *));
int fclose __ARGS((FILE *));
int fflush __ARGS((FILE *));
FILE *fopen __ARGS((const char * __Restrict, const char * __Restrict));
FILE *freopen __ARGS((const char*__Restrict, const char * __Restrict, FILE * __Restrict));
FILE *fdopen __ARGS((int, const char * __Restrict));
void setbuf __ARGS((FILE * __Restrict, char * __Restrict));
int setvbuf __ARGS((FILE * __Restrict, char * __Restrict, int, size_t ));
...
int fprintf __ARGS((FILE * __Restrict, const char * __Restrict, ...));
#pragma __scanf_args
int fscanf __ARGS((FILE * __Restrict, const char * __Restrict, ...));
#pragma __printf_args
int printf __ARGS((const char * __Restrict, ...));
#pragma __scanf_args
int scanf __ARGS((const char * __Restrict, ...));
#pragma __printf_args
int snprintf __ARGS((char * __Restrict, size_t, const char * __Restrict, ...));
#pragma __printf_args
int sprintf __ARGS((char * __Restrict, const char * __Restrict, ...));
#pragma __scanf_args
int sscanf __ARGS((const char * __Restrict, const char * __Restrict, ...));
#else
int fprintf __ARGS((FILE * __Restrict, const char * __Restrict, ...));
int fscanf __ARGS((FILE * __Restrict, const char * __Restrict, ...));
int printf __ARGS((const char * __Restrict, ...));
int scanf __ARGS((const char * __Restrict, ...));
int snprintf __ARGS((char * __Restrict, size_t, const char * __Restrict, ...));	/* ISO C99 */
int sprintf __ARGS((char * __Restrict, const char * __Restrict, ...));
int sscanf __ARGS((const char * __Restrict, const char * __Restrict, ...));
#endif
int fgetc __ARGS((FILE *));
char *fgets __ARGS((char * __Restrict, int, FILE * __Restrict));
int fputc __ARGS((int, FILE *));
int fputs __ARGS((const char * __Restrict, FILE * __Restrict));
int getc __ARGS((FILE *));
int getchar __ARGS((void));
char *gets __ARGS((char *));
int putc __ARGS((int, FILE *));
int putchar __ARGS((int ));
int puts __ARGS((const char *));
int ungetc __ARGS((int, FILE *));
int getc_unlocked __ARGS((FILE *));
int getchar_unlocked __ARGS((void));
int putc_unlocked __ARGS((int, FILE *));
int putchar_unlocked __ARGS((int ));
size_t fread __ARGS((void * __Restrict, size_t, size_t, FILE * __Restrict));
size_t fwrite __ARGS((const void * __Restrict, size_t, size_t, FILE * __Restrict));

int fgetpos __ARGS((FILE * __Restrict, fpos_t * __Restrict));
int fseek __ARGS((FILE *, long int, int ));
int fsetpos __ARGS((FILE *, const fpos_t *));
long int ftell __ARGS((FILE *));
void rewind __ARGS((FILE *));

void clearerr __ARGS((FILE *));
int fileno __ARGS((FILE *));
int feof __ARGS((FILE *));
int ferror __ARGS((FILE *));
void perror __ARGS((const char *));
...
int vsscanf(const char* __Restrict, const char* __Restrict, __gh_va_list);
#else
/* don't prototype these functions in this mode rather than %include varargs */
#if !defined(__STDC__) && !defined(__cplusplus) && \
    (defined(__PROTOTYPES__) || defined(__EDG__))
#undef  __ARGS
#define __ARGS(x)	()
#endif
...
void	flockfile __ARGS((FILE *));
int	ftrylockfile __ARGS((FILE *));
void	funlockfile __ARGS((FILE *));
#if !defined(_POSIX_SOURCE) && !defined(_POSIX_C_SOURCE)
void    flockcreate __ARGS((FILE *));
void    flockdestroy __ARGS((FILE *));
#endif
int 	__ghs_flock_in_use __ARGS((void *));
...
#  define L_cuserid	9
#endif
char *ctermid	__ARGS((char *));
FILE *popen	__ARGS((const char *, const char *));
int   pclose	__ARGS((FILE*));
int   fseeko	__ARGS((FILE *, off_t, int));
off_t ftello	__ARGS((FILE *));
#endif
