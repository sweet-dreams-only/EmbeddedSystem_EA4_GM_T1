...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GmT1xxPartNr_VAR)  *******************/

/* used for all global or static SWC specific variables that are not initialized by the startup code of the compiler */
# define GmT1xxPartNr_VAR_NOINIT

/* used for global or static SWC specific variables that are initialized by the startup code of the compiler */
# define GmT1xxPartNr_VAR_INIT

/* used for global or static SWC specific variables that are initialized with zero by the startup code of the compiler */
# define GmT1xxPartNr_VAR_ZERO_INIT

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GmT1xxPartNr_CONST)  *****************/

/* used for global or static SWC specific constants */
# define GmT1xxPartNr_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GmT1xxPartNr_CODE)  ******************/

/* used for SWC specific code */
# define GmT1xxPartNr_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_GMT1XXPARTNR_APPL)  **************/

/* used for references on application variables */
# define RTE_GMT1XXPARTNR_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_GMT1XXPARTNR_APPL_DATA

/* used for references on application functions */
# define RTE_GMT1XXPARTNR_APPL_CODE

/* used for references on application constants */
# define RTE_GMT1XXPARTNR_APPL_CONST
...
#    error "The magic number of the generated file <C:/Workspace/_EA4/_Components/GM_002A_PartNr_Impl-kzdyfh/GM_002A_PartNr_Impl/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
