...
# endif /* ECO_IGNORE_LINE */
    {
        ...
        {
            const NvM_RamMngmtPtrType blockMngmtPtr = &NvM_BlockMngmtArea_at[NVM_BLOCK_FROM_DCM_ID(BlockId)];
...
NVM_LOCAL_INLINE boolean NvM_WriteProtectionChecks(const NvM_RamMngmtConstPtrType mngmtPtr)
{
    ...
    {
        NvM_SetError(NvM_DemErrWriteProtected);
    }
