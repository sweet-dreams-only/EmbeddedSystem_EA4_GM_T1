 ...
 *  Tomas Ondrovic                Oto           Vctr Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 * 5.02.01                       ESCAN00084457  removed multi block pending check and extend single block pending check,
 *                                              improved WriteAll FSM (moved skip check to another state, removed skip state)
 * 5.02.02                       -              no functionality changes, only internal improvements
 * 5.03.00                       ESCAN00081163  removed C++ comment
 ...
 * 5.04.00                       ESCAN00088233  removed non-AUTOSAR container NvMDevErrorChecks and parameter NvMCfgIncludeDem and NvMSeterror
 * 5.05.00                       ESCAN00088791  adjusted function declarations to AUTOSAR 4
...
#define NVM_SW_MINOR_VERSION       (5u)
