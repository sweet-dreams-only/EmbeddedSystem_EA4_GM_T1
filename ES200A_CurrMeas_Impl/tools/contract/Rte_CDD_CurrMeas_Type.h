...
#    error "The magic number of the generated file <C:/Component/ES200A_CurrMeas_Impl/tools/contract/Rte_CDD_CurrMeas_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
