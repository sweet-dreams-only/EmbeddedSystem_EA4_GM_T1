...
#    error "The magic number of the generated file <C:/Component/AR300A_MotCtrlMgr_Impl/tools/contract/generate/RteGen/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
