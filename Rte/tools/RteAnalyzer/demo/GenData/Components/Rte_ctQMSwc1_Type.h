 ...
 *
 *   Description:  Application types header file for SW-C <ctQMSwc1>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CTQMSWC1_TYPE_H
# define _RTE_CTQMSWC1_TYPE_H
