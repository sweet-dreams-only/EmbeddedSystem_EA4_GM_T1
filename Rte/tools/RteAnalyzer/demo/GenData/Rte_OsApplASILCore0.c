...
VAR(Array, RTE_VAR_INIT) Rte_ASILSwc0_srNotTypesafe_Element = {
...
VAR(uint16, RTE_VAR_INIT) Rte_Irv_ASILSwc1_IrvAtomic = 0U; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
FUNC(void, RTE_CODE) Rte_InitMemory_OsApplASILCore0(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
  ...
  Rte_MemCpy32(Rte_ASILSwc0_srNotTypesafe_Element, Rte_C_Array_0, sizeof(Array));

  /* initialize inter-runnable variables */
  Rte_Irv_ASILSwc1_IrvAtomic = 0U;
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_ctASILSwc0_srNotTypesafe_Element(P2CONST(Array, AUTOMATIC, RTE_CTASILSWC0_APPL_DATA) data) /* PRQA S 0850, 1505 */ /* MD_MSR_19.8, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  Rte_MemCpy32(Rte_ASILSwc0_srNotTypesafe_Element, *(data), sizeof(Array));
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_ctASILSwc1_srNotTypesafe_Element(P2VAR(Array, AUTOMATIC, RTE_CTASILSWC1_APPL_VAR) data) /* PRQA S 0850, 3673, 1505 */ /* MD_MSR_19.8, MD_Rte_Qac, MD_MSR_8.10 */
{
  Std_ReturnType ret = RTE_E_OK;

  Rte_MemCpy32(*(data), Rte_ASILSwc0_srNotTypesafe_Element, sizeof(Array));
 ...
 *********************************************************************************************************************/
TASK(ASILTaskCore0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{

  /* call runnable */
  RunnableCyclicASILSwc0();

  /* call runnable */
  RunnableCyclicASILSwc1();
