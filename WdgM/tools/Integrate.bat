...
rmdir %INTPJTDIR%\tools\SIP\DaVinciConfigurator\Generators\WdTttechGeneratorWrapper /s /q
...
mkdir %INTPJTDIR%\tools\SIP\DaVinciConfigurator\Generators\WdTttechGeneratorWrapper
...
xcopy ..\tools\IntegrationCopy\TTTech	%INTPJTDIR%\tools\SIP\DaVinciConfigurator\Generators\WdTttechGeneratorWrapper /s
