...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM348CE_VAR)  ************************/

/* used for all global or static SWC specific variables that are not initialized by the startup code of the compiler */
# define GM348CE_VAR_NOINIT

/* used for global or static SWC specific variables that are initialized by the startup code of the compiler */
# define GM348CE_VAR_INIT

/* used for global or static SWC specific variables that are initialized with zero by the startup code of the compiler */
# define GM348CE_VAR_ZERO_INIT

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM348CE_CONST)  **********************/

/* used for global or static SWC specific constants */
# define GM348CE_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM348CE_CODE)  ***********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_GM348CE_APPL)  *******************/

/* used for references on application variables */
# define RTE_GM348CE_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_GM348CE_APPL_DATA

/* used for references on application functions */
# define RTE_GM348CE_APPL_CODE

/* used for references on application constants */
# define RTE_GM348CE_APPL_CONST
...
#    error "The magic number of the generated file <C:/Workspace/_EA4/T1xx/GM_T1XX_EPS_RH850_Working/MM020A_GmMsg348BusChassisExp_Impl/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
