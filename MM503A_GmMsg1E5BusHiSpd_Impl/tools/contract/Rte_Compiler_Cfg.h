...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM1E5HS_CONST)  **********************/

/* used for global or static SWC specific constants */
# define GM1E5HS_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM1E5HS_CODE)  ***********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_GM1E5HS_APPL)  *******************/

/* used for references on application variables */
# define RTE_GM1E5HS_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_GM1E5HS_APPL_DATA

/* used for references on application functions */
# define RTE_GM1E5HS_APPL_CODE

/* used for references on application constants */
# define RTE_GM1E5HS_APPL_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:GM1E5HS_VAR)  ************************/

/* used for all global or static SWC specific variables that are not initialized by the startup code of the compiler */
# define GM1E5HS_VAR_NOINIT

/* used for global or static SWC specific variables that are initialized by the startup code of the compiler */
# define GM1E5HS_VAR_INIT

/* used for global or static SWC specific variables that are initialized with zero by the startup code of the compiler */
# define GM1E5HS_VAR_ZERO_INIT
...
#    error "The magic number of the generated file <C:/Hari/Work/SynergyProjects/EA4/MM503A_GmMsg1E5BusHiSpd_Impl/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
