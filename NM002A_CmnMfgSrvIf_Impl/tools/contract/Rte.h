...
#    error "The magic number of the generated file <C:/Workspace/_EA4/_Components/NM002A_CmnMfgSrvIf_Impl-kzdyfh/NM002A_CmnMfgSrvIf_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
