...
#   error "The magic number of the generated file <C:/Component/CF009A_GmOvrlStMgr_Impl_4.1.0/tools/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
