...
#    error "The magic number of the generated file <C:/Workspace/_EA4/_Components/NM003A_NxtrSwIds_Impl-kzdyfh/NM003A_NxtrSwIds_Impl/tools/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
