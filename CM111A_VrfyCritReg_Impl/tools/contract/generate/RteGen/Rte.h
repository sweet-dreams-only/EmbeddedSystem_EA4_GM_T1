...
#    error "The magic number of the generated file <C:/Component/CM111A_VrfyCritReg_Impl/tools/contract/generate/RteGen/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
