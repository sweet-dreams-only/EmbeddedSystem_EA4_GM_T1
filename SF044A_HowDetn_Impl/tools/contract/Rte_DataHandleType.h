...
#    error "The magic number of the generated file <C:/Component/SF044A_HowDetn_Impl_2.0.0/tools/contract/Rte_DataHandleType.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
