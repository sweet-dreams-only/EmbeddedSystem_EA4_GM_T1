...
* 12/06/16	 5       ML		   Updated to fix Anomaly EA4#8204												  EA4#8629
* 12/13/16   6       ML        Updated to fix Anomaly EA4#8928												  EA4#8931
**********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    /* REQ: SF053A #70 I */
    if(Abslt_f32_f32(VehSpd_Kph_T_f32) >= Rte_Prm_HwAgVehCentrTrimVehSpdMaxThd_Val()) /* REQ: SF053A #80 I */
    {
