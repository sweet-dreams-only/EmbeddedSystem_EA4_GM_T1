 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_HwAgVehCentrTrim_Type.h
...
#ifndef _RTE_HWAGVEHCENTRTRIM_TYPE_H
# define _RTE_HWAGVEHCENTRTRIM_TYPE_H
...
#    error "The magic number of the generated file <C:/component/SF053A_HwAgVehCentrTrim_Impl/tools/contract/Rte_HwAgVehCentrTrim_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_HWAGVEHCENTRTRIM_TYPE_H */
